...
#if(_PROJECT == _FOX_E1922W_CMI_M185BGE_L22)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_CMI_M185BGE_L22 
