...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2281CW_Gray_Demo.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RTD2281CW_GRAY_DEMO_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RTD2281CW_WISTRON_1A1DVI


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _AUO_M170ETN01_1//_AU_LVDS_21_5_WUXGA
...
//--------------------------------------------------
//////////////////////////////////////////////////////////////////////////////////////////
// Guid ne to use _NONE_OSD:                                                          //
// 1. De-Select the following folders to be built in                                    //
//    LenovoGreenFunction/LenovoGreenOsd/CFactory                                             //
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT1713p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 1F 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT1713p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
// Definitions for Osd audio setting 
//==================================================================
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
#define _OSD_LINEIN_SUPPORT                                 _ON
...
#define _CALIBRATION_R_GAIN_BIAS                                (-1)// Needs modification for EVERY single source
#define _CALIBRATION_G_GAIN_BIAS                                (-1) // Needs modification for EVERY single source
#define _CALIBRATION_B_GAIN_BIAS                                (-1)// Needs modification for EVERY single source
#define _CALIBRATION_R_OFFSET_BIAS                              (-4) // Needs modification for EVERY single source
#define _CALIBRATION_G_OFFSET_BIAS                              (-4) // Needs modification for EVERY single source
#define _CALIBRATION_B_OFFSET_BIAS                              (-4) // Needs modification for EVERY single source
...
#else
#define _EEPROM_EDID_A0_ADDRESS                                 (_EDID_PAGE * _FLASH_PAGE_SIZE)
#endif
...
// Add ?PR?USERINTERFACETIMER0INSTANTACCESS_TIMER0?LenovoGreenUSERINTERFACE
//     ?PR?USERINTERFACETIMER1INSTANTACCESS_TIMER1?LenovoGreenUSERINTERFACE
...
//==================================================================
#define _CHECKSUM                                               0x14//0x86
#define _VERSION_CODE                                           0x18
...
//==================================================================
#define _IC_SERIES                                              _R,_T,_D,_2,_2,_7,_1,_C,_W
#define _MODEL_NAME								                _bL_, _bT_, _bp_
#define _MICROCODE							                    _bL_,_bA_, _DOT

#define _FACTORY_PROJECT_NAME                                   _L,_T,_1,_7,_1,_3
#define _FACTORY_PANNEL_NAME				                    _A,_U,_O,_SPACE,_M,_1,_7,_0,_E,_T,_N,_0,_1,_DOT,_1
#define _FW_RELEASE_DATE                                        _2,_0,_1,_3,_1,_0,_3,_0
...
#define _EDID_TYPE_ARRAY                                        {_EDID_VGA,_EDID_DVI}
#define _EDID_TYPE_SIZE                                         {128,128}
...
#endif // End of #if(_PROJECT == _RTD2281CW_GRAY_DEMO_PROJECT)
