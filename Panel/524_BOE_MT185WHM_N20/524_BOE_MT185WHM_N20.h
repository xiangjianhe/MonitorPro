...
#if(_PANEL_TYPE == _FOX_BOE_MT185WHM_N20)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_MAX_FRAME_RATE                   760                 // Unit in 0.1 HZ
#define _PANEL_MIN_FRAME_RATE                   500

//--------------------------------------------------
// Set Last Line Finetune Target
//--------------------------------------------------
#define _LAST_LINE_TARGET                       410//(_PANEL_DH_TOTAL - 150)

//--------------------------------------------------
// Definitions for Panel Manufacturer
//--------------------------------------------------
#define _PANEL_MANUFACTURER                     _PANEL_BOE      // _PANEL_CMO or _PANEL_AUO or _PANEL_SAMSUNG or _PANEL_INNOLUX or _PANEL_CPT
...
#define _PANEL_DH_WIDTH                         1366                // Display Horizontal Width
#define _PANEL_DH_END                           1398                // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         1560                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     1936                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1446                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         6                   // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        768                // Display Vertical Width
#define _PANEL_DV_END                           774                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         806                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     888                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     778                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      76                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  95                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  50                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      35                  // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      30                  // Panel Power On T2 (ms)29
#define _PANEL_POWER_ON_T3                      250                 // Panel Power On T3 (ms)240

#define _PANEL_POWER_OFF_T4                     250                 // Panel Power Off T4 (ms)254
#define _PANEL_POWER_OFF_T5                     25                  // Panel Power Off T5 (ms)236
#define _PANEL_POWER_OFF_T6                     1100                // Panel Power Off T6 (ms)

//--------------------------------------------------
// Definitions for ADC Offset Adjust
//--------------------------------------------------
#define _PANEL_ADC_OFFSET_BIAS					(2) // 0~5
...
#endif // End of #if(_PANEL_TYPE == _FOX_AUO_M185XTN01_3)
