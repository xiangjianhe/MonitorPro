...
#if(_PROJECT == _FOX_E2024)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6229_FOXCONN_LEN_E2024_PCB


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_CMI_M200HJJ 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN E2024)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LEN E2014)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//--------------------------------------------------
#define _CHECKSUM                                       0x45//0x56
#define _VERSION_CODE                                   0xaf

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _E,_2,_0,_2,_4,_D
#define _FACTORY_PANNEL_NAME							_C,_M,_I,_SPACE,_M,_2,_0,_0,_H,_J,_J
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_1,_A,_R,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_4,_1,_1,_1,_0
#define _FW_VERSION                                     _L,_M, _3, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0300//0x0301 

//User OSD
#define _MODEL_NAME                                     _bE_, _2_, _0_, _2_, _4_,_bD_
#define _MICROCODE                                      _bL_,_bM_, _3_, _DOT, _0_
//Facory Command
...
//----------------------------------------------------------------------------------------------------
#define _COLOR_TEMP_DEF								_CT_6500//	_CT_7200

#define _OSD_CONTRAST_DEF_VALUE                         85    //_CONTRAST_VGA
#define _OSD_BRIGHTNESS_DEF_VALUE                       80

#define _CONTRAST_CHANG_POINT_ANALOG					95//102
...
//----------------------------------------------------
#define _PWM_B00                                        60//|00
#define _PWM_B10                                        67//|10
#define _PWM_B20                                        70//|20
#define _PWM_B30                                        78 //|30
#define _PWM_B40                                        89//|40
#define _PWM_B50                                        103 //|50
#define _PWM_B60                                        123 //|60
#define _PWM_B70                                        147//|70
#define _PWM_B80                                        157//|80
...
#endif // End of #if(_PROJECT == _FOX_E2024)
