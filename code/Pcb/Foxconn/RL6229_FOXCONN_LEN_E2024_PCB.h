...
#if(_PCB_TYPE == _RL6229_FOXCONN_LEN_E2024_PCB)
...
// NC Pin
#define _PIN_41                                 (2 & 0x07) // Page 10-0xA0[7:6]
...
// NC Pin
#define _PIN_69                                 (0 & 0x0F) // Page 10-0xA5[5:3]
...
// NC Pin
#define _PIN_70                                 (0 & 0x0F) // Page 10-0xA5[2:0]
...
// NC Pin
#define _PIN_102                                (3 & 0x0F) // Page 10-0xAA[5:3]
...
// FLASH_WP
#define _PIN_108                                (0 & 0x0F) // Page 10-0xAB[2:0]
...
// DVI_HOT_PLUG
#define _PIN_111                                (0 & 0x0F) // Page 10-0xAE[6:4]
...
// AUX_CHP
#define _PIN_121                                (0 & 0x07) // Page 10-0xB0[3:2]
...
//DVI
#define bSWIIC_D1_EDID_EEPROM_SCL               (MCU_PORT70_PIN_REG_FFCF) // Pin 124, P7.0
#define bSWIIC_D1_EDID_EEPROM_SDA               (MCU_PORT71_PIN_REG_FFD0) // Pin 123, P7.1
...
#define PCB_SW_IIC_SDA_SET()                    {\
                                                    ...
                                                    else if(GET_SW_IIC_STATUS() == _IIC_D1_EDID_EEPROM) \
                                                    {                                          \
                                                        bSWIIC_D1_EDID_EEPROM_SDA = _TRUE;         \
                                                    }                                          \
                                                }
#define PCB_SW_IIC_SDA_CLR()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_D1_EDID_EEPROM_SDA = _FALSE;         \
                                                    }                                          \
                                                }
...
#define PCB_SW_IIC_SCL_SET()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_D1_EDID_EEPROM_SCL = _TRUE;         \
                                                    }                                          \
                                                }
#define PCB_SW_IIC_SCL_CLR()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_D1_EDID_EEPROM_SCL = _FALSE;         \
                                                    }                                          \
                                                }
...
//-----------------------------------------------
sbit bFLASH_WRITE_PROTECT                    	=P3^7;   // Pin 114 P3.7
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT65_PIN_REG_FFCC)//pin 55 
...
#define bEDID_WRITE_PROTECT                     (MCU_PORT_PB7_PIN_REG_FF7F) // Pin 41, PB.7
...
#define PCB_WIRTE_DVI_EDID_READY()  {\
                                            SET_SW_IIC_STATUS(_IIC_D1_EDID_EEPROM);\
...
//-----------------------------------------------
#define bA0_CONNECT                             (MCU_PORT_PD0_PIN_REG_FF7E) // Pin 39, PD.0
#define bD1_CONNECT                             (MCU_PORTC0_PIN_REG_FFA3) // Pin126  PC.0

#define PCB_A0_PIN()                            (SET_A0_CABLE_STATUS(!bA0_CONNECT))
#define PCB_D0_PIN()                            (SET_D0_CABLE_STATUS(_FALSE))
...
//-----------------------------------------------
#define bD1_HPD                                 (MCU_PORT72_PIN_REG_FFD1) // Pin 122, P7.2 for DVI
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_PORT74_PIN_REG_FFD3) //Pin 104 P7.4
...
#endif // End of #if(_PCB_TYPE == _RL6229_FOXCONN_LEN_E2024_PCB)
