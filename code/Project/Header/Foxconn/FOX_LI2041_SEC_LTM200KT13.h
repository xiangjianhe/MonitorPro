...
#if(_PROJECT == _FOX_LI2041_SEC_LTM200KT13)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6096_FOXCONN_LEN_LT2223S_PCB//_RL6096_DEMO_1A1DVI


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_SEC_LTM200KT13 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN LI2041 Wide)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LEN LI2041 Wide)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//--------------------------------------------------
#define _CHECKSUM                                       0xb2
#define _VERSION_CODE                                   0xaf

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _L,_I,_2,_0,_4,_1,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_S,_E,_C,_SPACE,_L,_T,_M,_2,_0,_0,_K,_T,_1,_3
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_1,_D,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_7,_0,_3
#define _FW_VERSION                                     _L,_S, _2, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0200  //Ver 1.00	

//User OSD
#define _MODEL_NAME                                     _2_, _0_, _4_, _1_
#define _MICROCODE                                      _2_, GLOBAL(0x20), _0_
//Facory Command
...
#define _OSD_CONTRAST_DEF_VALUE                         60    //_CONTRAST_VGA

#define _OSD_BRIGHTNESS_WEB_VALUE                       90
#define _OSD_CONTRAST_WEB_VALUE                         60  

#define _OSD_BRIGHTNESS_VIDEO_VALUE                     100
#define _OSD_CONTRAST_VIDEO_VALUE                       65  

#define _OSD_BRIGHTNESS_SPLIT_VALUE                     100
...
#define _LBL_BRIGHTNESS_DEF_VALUE                       40

#define _CONTRAST_CHANG_POINT_ANALOG					100
#define _CONTRAST_MAX_ANALOG							114
#define _CONTRAST_MIN_ANALOG							40

#define _CONTRAST_CHANG_POINT_DIGITAL					100
#define _CONTRAST_MAX_DIGITAL							114
#define _CONTRAST_MIN_DIGITAL							40

//NovoVision mode Backlight Base Def for FOXCONN _LENOVO_ORG_OSD
#define _WEB_BRI_BASE_DEF								85
#define _VIDEO_BRI_BASE_DEF								95
#define _SPLIT_BRI_BASE_DEF								85

//----------------------------------------------------
// Brightness PWM Table
//----------------------------------------------------
#define _PWM_B00                                        101 //|00
#define _PWM_B10                                        102//|10
#define _PWM_B20                                        106 //|20
#define _PWM_B30                                        112 //|30
#define _PWM_B40                                        121//|40
#define _PWM_B50                                        133 //|50
#define _PWM_B60                                        150 //|60
#define _PWM_B70                                        169 //|70
#define _PWM_B80                                        194 //|80
#define _PWM_B90                                        222 //|90
...
#define _CT9300_LenovoPrj_GREEN                                 122
...
#define _CTVIDEO_LenovoPrj_RED									_CT9300_LenovoPrj_RED
#define _CTVIDEO_LenovoPrj_GREEN								_CT9300_LenovoPrj_GREEN
#define _CTVIDEO_LenovoPrj_BLUE									_CT9300_LenovoPrj_BLUE
...
#define _OSD_POSITION_FONT_A_H_DELAY_                           2
#else
...
#endif // End of #if(_PROJECT == _FOX_LI2041_SEC_LTM200KT13)
