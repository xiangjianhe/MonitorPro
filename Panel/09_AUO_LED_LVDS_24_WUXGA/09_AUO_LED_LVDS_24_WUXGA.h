...
#if(_PANEL_TYPE == _AUO_LED_LVDS_24_WUXGA)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_ELED_VOUT_TYPICAL                35                  // Eled Panel Vout Typical Voltage
#define _PANEL_ELED_VOUT_MAX                    40                  // Eled Panel Vout Max Value
