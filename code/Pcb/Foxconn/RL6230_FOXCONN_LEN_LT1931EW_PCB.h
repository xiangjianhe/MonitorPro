...
#if(_PCB_TYPE == _RL6230_FOXCONN_LEN_LT1931EW_PCB)
...
//--------------------------------------------------
#if(_PROJECT == _FOX_E1922S_BOE_HM185WX1_400)
#define _LVDS_DATA_DRIV_CONTROL                 _LVDS_DRIV_CONTROL_2_5   
#else
#define _LVDS_DATA_DRIV_CONTROL                 _LVDS_DRIV_CONTROL_3_0 //_LVDS_DRIV_CONTROL_2_0  
#endif
...
// POWER_SAVING_CTRL
#define _PIN_61                                 (2 & 0x07)  // 0 ~ 4 (0: P5D4i, 1: P5D4o<open-drain>, 2: P5D4o<push-pull>, 3: PWM4B<open-drain>, 4: PWM4B<push-pull>, )
...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1                                      = P3 ^ 6;  //Pin25
sbit bLED2                                      = P3 ^ 7;  //Pin26
...
#define bPOWER_KEY								(MCU_PORT63_PIN_REG_FFCA)
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((0x00 <= ucV1) && (ucV1 < 0x20))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;     \
                                                                                                       \
                                                                if((0x20 <= ucV0) && (ucV0 < 0x80))    \
                                                                    ucKeyState |= _MENU_KEY_MASK;      \
                                                                                                       \
                                                                if((0x00 <= ucV0) && (ucV0 < 0x20))    \
...
#if(_BACKLIGHT_CONTROL_INVERSE == _OFF)
