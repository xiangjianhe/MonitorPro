...
#define __RL6001_SERIES_DISPLAY__
...
{        
    ...
    ScalerSetDataPortByte(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_A1_TCON_LVDS_CTRL1, 0x13);
...
{
#if(_FRC_SUPPORT == _ON)    
    if((g_stMDomainInputData.usVFreq < _PANEL_MIN_FRAME_RATE) || 
