...
/********************************************************************************/
#if(_PANEL_TYPE == _TPV_CMI_M195FGE_L20)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DV_START                         6//Robert Wang 2013020512                  // Display Vertical Start Position
...
#define _PANEL_DH_SYNC_WIDTH                    8//Robert Wang 201302051                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2//Robert Wang 201302053                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      116                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  162                 // Maxinum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T5                     20//40              // Panel Power Off T5 (ms) CMI_spec:0<T5<50ms
#define _PANEL_POWER_OFF_T6                     1100                // Panel Power Off T6 (ms) CMI_spec:T7>1000ms

//--------------------------------------------------
// Definitions for ADC Offset Adjust
//--------------------------------------------------
///Robert Wang 20130326 update STD code.
...
#endif // End of #if(_PANEL_TYPE == _TPV_CMI_M195FGE_L20)
