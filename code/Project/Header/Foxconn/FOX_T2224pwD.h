...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6229_FOXCONN_LEN_T2224pwD_PCB//_RL6229_DEMO_1A1H1DP

#define _T2224P_WITHOUT_SPK										0
#define _T2224P_WITH_SPK										1

#define _T2224P_PROJECT_TYPE									_T2224P_WITHOUT_SPK
//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
//#define _PANEL_TYPE                                             _FOX_LG_LM215WF3_SLN1
#define _PANEL_TYPE                                             _FOX_SEC_LTM215HL01
//#define _PANEL_TYPE                                             _FOX_BOE_HR215WU1_120

#define _PANEL_POW_SEQ_FAST_MODE                                _ON    
#define _DISPLAY_PREVENT_GARBAGE_METHOD                         _GARBAGE_PREVENT_BY_BACKLIGHT
//--------------------------------------------------
//  Osd Define
//--------------------------------------------------
//////////////////////////////////////////////////////////////////////////////////////////
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN T2224pD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 11 0F) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI								"(prot(monitor)type(LCD)model(LEN T2224pD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 11 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(LEN T2224pD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 11 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"  
...
#define _ANALOG_VOLUME_MAX                                      0x0028//0x0037 // MAX: 0x0037
#define _ANALOG_VOLUME_MIN                                      0x0000
#define _ANALOG_VOLUME_CENTER                                   _ANALOG_VOLUME_MAX//0x002a//((_ANALOG_VOLUME_MAX + _ANALOG_VOLUME_MIN) / 2)

#define _DIGITAL_AUDIO_VOLUME_RESOLUTION                        _AUDIO_VOLUME_14BIT
#define _DIGITAL_VOLUME_MAX                                     0x3400//0x3FFF // _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
#define _DIGITAL_VOLUME_MIN                                     0x0000
#define _DIGITAL_VOLUME_CENTER                                  _DIGITAL_VOLUME_MAX//((_DIGITAL_VOLUME_MAX + _DIGITAL_VOLUME_MIN) / 2)
...
//--------------------------------------------------
#define _SYSTEM_EEPROM_EMULATION_START_PAGE                     12
#define _SYSTEM_EEPROM_EMULATION_END_PAGE                       13
#define _SYSTEM_EEPROM_EMULATION_DP_EDID_PAGE					14
//--------------------------------------------------
// Timing Support
//--------------------------------------------------
...
//-------------------------------------------------
#define _SOURCE_DEFAULT_SEARCH_TIME_ALL_PORT                   SEC(2.7)    
...
#define _WAIT_TIME_TO_ACTIVE_DP                                 SEC(1.2)
...
#define _EEPROM_EDID_D1_ADDRESS                                 (_SYSTEM_EEPROM_EMULATION_DP_EDID_PAGE * _FLASH_PAGE_SIZE)
...
#define _EEPROM_HDCP_KEY_ADDRESS                                (_MISC_PAGE * _FLASH_PAGE_SIZE)
#endif
...
//-------------------------------------------------
// DC OFF/ON DP HPD CHECK
//-------------------------------------------------
//DC OFF/ON DP HPD CHECK DISABLE -> ON
//DC OFF/ON DP HPD CHECK ENABLE -> OFF
#define DP_DCOFF_HPD_FORCE_HIGH                                  _ON
...
#define _DIGITAL1_TYPE                                  _HDMI_PORT
#define _DIGITAL2_TYPE                                  _DP_PORT
...
//Facory OSD
#define _FACTORY_PROJECT_NAME                           _T,_2,_2,_2,_4,_p,_D
#define _IC_SERIES                                      _R,_T,_D,_2,_4,_8,_6,_V,_R,_D
//User OSD
#define _MODEL_NAME                                     _T_, _2_, _2_, _2_, _4_, _p_,_D_


#if(_PANEL_TYPE == _FOX_LG_LM215WF3_SLN1)
//--------------------------------------------------
...
//Facory OSD
#define _FACTORY_PANNEL_NAME							_L,_G,_SPACE,_L,_M,_2,_1,_5,_W,_F,_3,_SPACE,_S,_L,_N,_1
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_1,_1,_6
#define _FW_VERSION                                     _L,_G, _3, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0300 
//User OSD
#define _MICROCODE                                      _L_,_G_, _3_, _DOT, _0_
//Facory Command
#define FacoryVersion1                                  'L' //Facory Command show Version
#define FacoryVersion2                                  'G' //Facory Command show Version
#define FacoryVersion3                                  '3' //Facory Command show Version
...
#if(_T2224P_PROJECT_TYPE == _T2224P_WITHOUT_SPK)
#define FacoryBomL4                                     '1'
#else
...
//----------------------------------------------------------------------------------------------------
#define _CONTRAST_CHANG_POINT_ANALOG					103//104//110
#define _CONTRAST_MAX_ANALOG							120
#define _CONTRAST_MIN_ANALOG							40

#define _CONTRAST_CHANG_POINT_DIGITAL					102//108
...
//==================================================================
#define _OD_NORMAL_GAIN								   0x40

//----------------------------------------------------
// Brightness PWM Table
//----------------------------------------------------
#define _PWM_B00                                        75//|00
#define _PWM_B10                                        76//|10
#define _PWM_B20                                        79//|20
#define _PWM_B30                                        86 //|30
#define _PWM_B40                                        98//|40
#define _PWM_B50                                        113 //|50
#define _PWM_B60                                        131 //|60
#define _PWM_B70                                        156 //|70
#define _PWM_B80                                        186 //|80
#define _PWM_B90                                        223 //|90
...
#elif(_PANEL_TYPE == _FOX_SEC_LTM215HL01)
...
#define _VERSION_CODE                                   0xaf
//Facory OSD
#define _FACTORY_PANNEL_NAME							_S,_E,_C,_SPACE,_L,_T,_M,_2,_1,_5,_H,_L,_0,_1
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_5,_0,_7
#define _FW_VERSION                                     _L,_S, _3, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0300 
//User OSD
#define _MICROCODE                                      _L_,_S_, _3_, _DOT, _0_
//Facory Command
#define FacoryVersion1                                  'L' //Facory Command show Version
#define FacoryVersion2                                  'S' //Facory Command show Version
#define FacoryVersion3                                  '3' //Facory Command show Version
#define FacoryVersion4                                  '.' //Facory Command show Version
#define FacoryVersion5                                  '0' //Facory Command show Version
...
#define _PWM_B00                                        75//|00
#define _PWM_B10                                        76//|10
#define _PWM_B20                                        80//|20
#define _PWM_B30                                        87 //|30
#define _PWM_B40                                        97//|40
#define _PWM_B50                                        111 //|50
#define _PWM_B60                                        130 //|60
#define _PWM_B70                                        153 //|70
#define _PWM_B80                                        181 //|80
...
#elif(_PANEL_TYPE == _FOX_BOE_HR215WU1_120)

//--------------------------------------------------
// Version Code of NVRam
//--------------------------------------------------
#define _CHECKSUM                                       0x88
#define _VERSION_CODE                                   0xaf
//Facory OSD
#define _FACTORY_PANNEL_NAME							_B,_O,_E,_SPACE,_H,_R,_2,_1,_5,_W,_U,_1,_SPACE,_1,_2,_0
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_5,_0,_7
#define _FW_VERSION                                     _L,_B, _3, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0300 
//User OSD
#define _MICROCODE                                      _L_,_B_, _3_, _DOT, _0_
//Facory Command
#define FacoryVersion1                                  'L' //Facory Command show Version
#define FacoryVersion2                                  'B' //Facory Command show Version
#define FacoryVersion3                                  '3' //Facory Command show Version
#define FacoryVersion4                                  '.' //Facory Command show Version
#define FacoryVersion5                                  '0' //Facory Command show Version
...
#define FacoryBomH2                                     '9'
#define FacoryBomH3                                     '0'
#define FacoryBomH4                                     'C'
#define FacoryBomH5                                     'G'
#define FacoryBomH6                                     '1'
#define FacoryBomH7                                     '3'
#define FacoryBomH8                                     '0'

#define FacoryBomL1                                     '0'
#define FacoryBomL2                                     '5'
#define FacoryBomL3                                     '0'
#define FacoryBomL4                                     '0'
#define FacoryBomL5                                     'R'
#define FacoryBomL6                                     '0'
...
// Definitions for Panel Contrast
//----------------------------------------------------------------------------------------------------
#define _CONTRAST_CHANG_POINT_ANALOG					102//100
#define _CONTRAST_MAX_ANALOG							116
#define _CONTRAST_MIN_ANALOG							40

#define _CONTRAST_CHANG_POINT_DIGITAL					102
#define _CONTRAST_MAX_DIGITAL							116
#define _CONTRAST_MIN_DIGITAL							40
//==================================================================
//OSD OD Gain Default Value
...
// Brightness PWM Table
//----------------------------------------------------
#define _PWM_B00                                        71//|00
#define _PWM_B10                                        72//|10
#define _PWM_B20                                        77//|20
#define _PWM_B30                                        84 //|30
#define _PWM_B40                                        93//|40
#define _PWM_B50                                        107 //|50
#define _PWM_B60                                        123 //|60
#define _PWM_B70                                        144 //|70
#define _PWM_B80                                        167 //|80
#define _PWM_B90                                        205 //|90
#define _PWM_B100                                       255 //|100
...
// Version Code of NVRam
//--------------------------------------------------
#define _CHECKSUM                                       0x78
#define _VERSION_CODE                                   0xaf
//Facory OSD
#define _FACTORY_PANNEL_NAME							_B,_O,_E,_SPACE,_H,_R,_2,_1,_5,_W,_U,_1,_SPACE,_1,_2,_0
#define _FW_RELEASE_DATE                                _2,_0,_1,_4,_0,_9,_2,_4
#define _FW_VERSION                                     _L,_B, _0, _DOT, _1
#define _DDCCI_FIRMWARE_VERSION							0x0001 
//User OSD
#define _MICROCODE                                      _L_,_B_, _0_, _DOT, _1_
//Facory Command
#define FacoryVersion1                                  'L' //Facory Command show Version
#define FacoryVersion2                                  'B' //Facory Command show Version
#define FacoryVersion3                                  '0' //Facory Command show Version
#define FacoryVersion4                                  '.' //Facory Command show Version
#define FacoryVersion5                                  '1' //Facory Command show Version
