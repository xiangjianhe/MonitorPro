...
#if(_PROJECT == _PRJ_L_E2054_A_BOE_MV195WGM_N10)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_BOE_MV195WGM_N10
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_E2054_A_6229.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(E2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
#define _MICROCODE												'L','B','0','.','1'
#define _RELEASE_DATE                                        	'2','0','1','6','0','2','1','9'
#define _IC_SERIES                                      		'R','T','D','2','1','8','1','L','R'
#define _PANNEL_NAME 											'M','V','1','9','5','W','G','M','_','N','1','0'
...
#define _OD_NORMAL_GAIN											0x40//respanse time: 6.430ms
#define _OD_EXTREME_GAIN                                        0x70// 4.823ms
...
#endif // End of #if(_PROJECT == _PRJ_L_E2054_A_BOE_MV195WGM_N10)
