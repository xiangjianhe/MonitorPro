...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2386L_WISTRON_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RTD2386L_WISTRON_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                              _RTD2386L_WISTRON_76PIN_1A1DP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _M240HTN01_LVDS_24_WUXGA 
#define _PANEL_POW_SEQ_FAST_MODE                                _ON
#define _PANEL_EMBEDDED_LED_DRIVER_SUPPORT                      _OFF
#define _DISPLAY_PREVENT_GARBAGE_METHOD                         _GARBAGE_PREVENT_BY_BACKLIGHT//_GARBAGE_PREVENT_BY_WATCH_DOG//
...
#define _FACTORY_INCLUDE                                        "FactoryInclude.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT2223dwC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 04 0F) 62 AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT2223dwC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 04 0F) 62 AC AE B2 B6 C6 C8 CA CC(0D 02 03 04 05 06 09 0A) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT2223dwC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 04 0F) 62 AC AE B2 B6 C6 C8 CA CC(0D 02 03 04 05 06 09 0A) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(LT2223dwC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 04 0F) 62 AC AE B2 B6 C6 C8 CA CC(0D 02 03 04 05 06 09 0A) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"  
...
#define _DIGITAL_VOLUME_MAX                                     0x2FFF//0x0405 //P8_A5,A6 _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
#define _DIGITAL_VOLUME_MIN                                     0x0000
#define _DIGITAL_VOLUME_CENTER                                  ((_DIGITAL_VOLUME_MAX + _DIGITAL_VOLUME_MIN) / 2)

#define _AIN_AUDIO_VOL_FIXED                                    0x0027//P6_BA,BB. max:0x3F 0x27=1:1
#define _DIN_AUDIO_VOL_FIXED                                    0x002A//P6_B8,B9 max:0x3F 0x27=1:1
#define _DAC_AUDIO_VOL_FIXED                                    0x37A0//ym20141016 . 0x3FFF=1:1//P8_A5,A6 _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF

//PWM:
#define _VOLUME_MAX                                             255
#define _VOLUME_MIN                                             0
#define _VOLUME_CENTER                                          ((_VOLUME_MAX + _VOLUME_MIN) / 2)
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      5    // 0~15, 0 ~ disable, 15 ~ 7.50%   
...
#define _WISTRON_EDID_FLASH_BANK                                7

//--------------------------------------------------
// Definitions of Flash Page Configuration
//--------------------------------------------------
#define _SYSTEM_EEPROM_EMULATION_BACKUP_PAGE                    11
#define _SYSTEM_EEPROM_EMULATION_EDID_PAGE                      12
#define _SYSTEM_EEPROM_EMULATION_START_PAGE                     13
#define _SYSTEM_EEPROM_EMULATION_END_PAGE                       14
#define _SYSTEM_EEPROM_EMULATION_HDCP_PAGE                      15//must = _MISC_PAGE!
...
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           250        // Unit in 0.1 HZ
#define _FAIL_SAVE_V_HEIGHT_UPPER_BOUND                         1100
...
#define _CALIBRATION_R_GAIN_BIAS                                (2)//(0) // Needs modification for EVERY single source
#define _CALIBRATION_G_GAIN_BIAS                                (2)//(0) // Needs modification for EVERY single source
#define _CALIBRATION_B_GAIN_BIAS                                (2)//(0) // Needs modification for EVERY single source
#define _CALIBRATION_R_OFFSET_BIAS                              (-2)//(-3) // Needs modification for EVERY single source
#define _CALIBRATION_G_OFFSET_BIAS                              (-2)//(-3) // Needs modification for EVERY single source
#define _CALIBRATION_B_OFFSET_BIAS                              (-2)//(-3) // Needs modification for EVERY single source
...
#else
#define _EEPROM_EDID_A0_ADDRESS                                 (_SYSTEM_EEPROM_EMULATION_EDID_PAGE * _FLASH_PAGE_SIZE)
#endif
...
#define _HDCP_KEY_LOCATION                                      _TABLE_LOCATION_USER
#if(_SYSTEM_EEPROM_EMULATION_SUPPORT == _OFF)
#define _EEPROM_HDCP_KEY_ADDRESS                                (_EEPROM_PAGE6_BANK0)
#else
#define _EEPROM_HDCP_KEY_ADDRESS                                (_SYSTEM_EEPROM_EMULATION_HDCP_PAGE * _FLASH_PAGE_SIZE)
#endif
...
//==================================================================
#define _CHECKSUM                                               0x16//0x15
#define _VERSION_CODE                                           0x15
...
#define _FACTORY_MODE_OWNER                                     _OWNER_WISTRON

//==================================================================
//_b0_~_b9_ only for Lenovo Green OSD
//==================================================================
#define _IC_SERIES                                              _R,_T,_D,_2,_3,_8,_6,_L
#define _MODEL_NAME												_M_, _o_, _d_, _u_,_l_,_a_,_r_,_A_,_D_,_P_
#define _MICROCODE												_L_,_T_, _M_,_2_,_2_,_0_

#define _FACTORY_PROJECT_NAME                                   _M_, _o_, _d_, _u_,_l_,_a_,_r_
#define _FW_RELEASE_DATE                                        _2,_0,_1,_4,_1,_0,_3,_0
#define _FW_VERSION                                             _L_,_T_, _M_,_2_,_2_,_0_
#define _DDCCI_FIRMWARE_VERSION							        0x0100  //Ver 1.0	

#define _PN_Data_code                                           "53.00000.000"
#define _FW_VER_Data_code                                       "LA1.0_1030"
#define _MODEL_Data_code                                        "LT1713"
#define _PANEL_NAME                                             _P,_A,_N,_E,_L

#define VERSION_STRING_CMI                                      "LM1.1"
#define VERSION_STRING_SEC                                      "LS1.1"
...
#define _ICON_BLANK1_PIXEL                                      16
#define _ICON_BLANK2_PIXEL                                      16
#define _ICON_BLANK3_PIXEL                                      10
#define _ICON_BLANK4_PIXEL                                      10
#define _ICON_BLANK5_PIXEL                                      15

#define _NAVIGATE_ICON_EXIT_COL_POSITION						8
#define _NAVIGATE_ICON_LEFT_COL_POSITION						14
#define _NAVIGATE_ICON_RIGHT_COL_POSITION						20
#define _NAVIGATE_ICON_ENTER_COL_POSITION						26
#define _NAVIGATE_ICON_POWER_COL_POSITION						32
#define _AFTER_NAVIGATE_ICON_POWER_COL_POSITION                 35 

#define _TEXT_BLANK1_PIXEL                                      18
#define _TEXT_BLANK2_PIXEL                                      23
#define _NAVIGATE_TEXT_EXIT_COL_POSITION						5
...
//EDID define
//==================================================================
#define _EDID_CHKSUM_SIZE                                       12
#define _EDID_SN_SIZE                                           20
#define _EDID_VERSION_CODE                                    0xD5 // 0xD1// 0xD9//0xD8
#define _LENOVO_SN_TYPE                                         _LENOVO_SN_LI

#define _EDID_24C02_MEMORY                                      _ENABLE
#define _EDID_FLASH_MEMORY                                      _DISABLE
#define _EDID_TYPE                                              {_EDID_VGA_256, _EDID_DP}
#define _EDID_MEMORY                                            {_MEMORY_24C02, _MEMORY_NONE}
...
#define _DIGITAL1_TYPE                                          _DP_PORT
...
#define MAX_CONTRAST_RATIO                                      133 // 1.75(unit 1/100)
...
//define Audio
//-------------------------------------------------
#define _AUDIO_ADJUST_FUNCTION_SUPPORT							_ON
...
#endif // End of #if(_PROJECT == _RTD2487HTD_WISTRON_PROJECT)
