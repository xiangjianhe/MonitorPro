...
#if(_PANEL_TYPE == _FOX_AUO_M170ETN01_1)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MAX                     2640                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1460               // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         6                   // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        1024                // Display Vertical Width
#define _PANEL_DV_END                           1030                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         1066               // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1873                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1036                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  188                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  104                 // Mininum Pixel Clock in MHz
...
#endif // End of #if(_PANEL_TYPE == _FOX_AUO_M170ETN01_1)
