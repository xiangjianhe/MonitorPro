...
#if(_PANEL_TYPE == _FOX_CMI_M195FGE_L20)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_PIXEL_CLOCK                      117                 // Typical Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T4                     550                 // Panel Power Off T4 (ms) CMI_spec:T4>100ms
