...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_QA_76Pin_1A1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6229_QA_76PIN_1A1DP)
...
// VGA_CABLE_DET
#define _76PIN_PIN_21                                 (0 & 0x0F) // Page 10-0xB8[1:0]
// 0 ~ 8 (0: PDD0i<I>, 1: PDD0o<PP>, 2: PDD0o<OD>, 3: TCON[14]<O>, 4: TEST_PIN0<O>,
//        5: TEST_PIN1<O>, 6: DUMMY<O>) 

// DP_CABLE_DET
#define _76PIN_PIN_22                                 (0 & 0x07) // Page 10-0xB9[1:0]
...
// LED2
#define _76PIN_PIN_24                                 (1 & 0x07) // Page 10-0xA0[5:4]
...
// KEY1
#define _76PIN_PIN_27                                 (3 & 0x07) // Page 10-0xAB[7:5]
...
// DP_SINK_ASS_2
#define _76PIN_PIN_29                                 (0 & 0x07) // Page 10-0xA4[7:6]
// 0 ~ 6 (0: P6D2i<I>, 1: P6D2o<PP>, 2: P6D2o<OD>, 3: ADCA2<I>,4: TEST_PIN0<O>, 
//        5: TEST_PIN1<O>, 6: DUMMY<O>)

// DP_SINK_ASS_1
#define _76PIN_PIN_30                                 (2 & 0x0F) // Page 10-0xA6[5:3]
...
// EDID_WP
#define _76PIN_PIN_59                                 (1 & 0x0F) // Page 10-0xAD[2:0]
...
// LED5
#define _76PIN_PIN_61                                 (2 & 0x0F) // Page 10-0xAE[2:0]
...
// BL_ADJ
#define _76PIN_PIN_63                                 (3 & 0x0F) // Page 10-0xB2[4:2]
...
//-----------------------------------------------
sbit bEDID_WRITE_PROTECT                        = P3 ^ 3;    // Pin 59, P3.3
...
//-----------------------------------------------
#define bDP_PIN15_CONNECT                       (MCU_PORT65_PIN_REG_FFCC) // Pin 30, P6.5
#define bDP_PIN16_CONNECT                       (MCU_PORTC4_PIN_REG_FFA4) // Pin 22, PC.4
...
//-----------------------------------------------
#define bD1_HPD                                 (MCU_PORT_PB7_PIN_REG_FF7F) // Pin 23, PB.7 for DP hot plug
...
#endif // End of #if(_PCB_TYPE == _RL6229_QA_76PIN_1A1DP)
