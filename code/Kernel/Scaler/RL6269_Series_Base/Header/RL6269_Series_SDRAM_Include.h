...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_Series_SDRAM_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _SDR_DQS_DLY                                (0x16)
#elif(_SDRAM_SIZE_CONFIG == _2M_32BIT)
#define _SDR_CAS_LATN                               (0x85)
#define _SDR_CLK_DLY1                               (0x00)
#define _SDR_CLK_DLY2                               (0x06)
#define _SDR_DQS_DLY                                (0x16)
#endif
...
#ifndef __RL6269_SERIES_SDRAM__
//****************************************************************************
// VARIABLE EXTERN
//****************************************************************************
...
#endif // End of #ifndef __RL6269_SERIES_SDRAM__
