...
#if(_PCB_TYPE == _RL6336_FOXCONN_LEN_LS2233_PCB)
...
// LED_W
#define _PIN_61                                 (2 & 0x07) // Page 10-0xBC[3:0]
...
// BL_ADJ
#define _PIN_63                                 (5 & 0x07) // Page 10-0xBE[3:0]
...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1										= P3 ^ 5;   // Pin 61 P3.5 LED_W
sbit bLED2										= P3 ^ 3;   // Pin 60 P3.3 LED_A
...
#define AD_KEY2                                 (MCU_ADC2_RESULT_FF0B) // Pin 29, ADC2
#define AD_KEY1                                 (MCU_ADC1_RESULT_FF0A) // Pin 28, ADC1
#define AD_KEY0                                 (_FALSE)
sbit bPOWER_KEY                            = P3 ^ 2; // Pin 59, P3.2
