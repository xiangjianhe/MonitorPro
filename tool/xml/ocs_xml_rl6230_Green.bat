@echo off
set PRONAME=CVT_RL6230_GREEN
set OUTFILE=.\Output\CVT_RL6230_GREEN\%PRONAME%.plg
set TOOLS_PATH=..\tool\xml
set BIN_PATH_SOURCE=.\Output\CVT_RL6230_GREEN
set BIN_PATH_DES=..\bin
set BIN_NAME=CVT_RL6230_GREEN.bin
set RAR_NAME=_UI_V20
set 
