...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_Color_Interface.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
//****************************************************************************
...
extern void ScalerColorDDither3DSetPRShift(void);
#endif
...
#if((_3D_SUPPORT == _ON) && (_PANEL_DISPLAY_TYPE == _PANEL_DISPLAY_PATTERN_RETARDER))
extern void ScalerColorUltraVividAdjust(BYTE *pUltraVividSetting1, BYTE *pUltraVividSetting2, BYTE *pUltraVividSetting3, BYTE *pUltraVividSetting4, BYTE *pUltraVividCDSSetting, BYTE *pUltraVividHSRSetting, BYTE ucBankNum);
#else
...
#if(_3D_SUPPORT == _ON)
extern void ScalerColorAdjust2DTo3DAnd3DEffect(void);
#endif
