...
#if(_PANEL_TYPE == _TPV_JV_LM230WF3_S2G2_AD_WUXGA)
//----------------------------------------------------------------------------------------------------
...
// Panel Name Define
//--------------------------------------------------
#define _PANEL_NAME                              _L,_M,_2,_3,_0,_W,_F,_3,_MINUS,_S,_2,_G,_2
//--------------------------------------------------
// 2D / 3D panel type
//--------------------------------------------------
...
#define _PANEL_DH_TOTAL                         2056                // Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  178                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  122                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      40                  // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      40                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      620                 // Panel Power On T3 (ms)

#define _PANEL_POWER_OFF_T4                     300                 // Panel Power Off T4 (ms)
#define _PANEL_POWER_OFF_T5                     10                  // Panel Power Off T5 (ms)
#define _PANEL_POWER_OFF_T6                     1150                // Panel Power Off T6 (ms)   Ada.chen 20131028_4 for T7 issue
