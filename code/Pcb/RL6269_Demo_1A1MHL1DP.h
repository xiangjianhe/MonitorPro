...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_Demo_1A1MHL1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6269_DEMO_1A1MHL1DP)
...
// MHL_DETECT
#define _PIN_1                                  (0 & 0x07) // Page 10-0xA0[2:0]
...
#define bDP_PIN16_CONNECT                       (MCU_PORTC3_PIN_REG_FFA0) // Pin 64, PC.3
#define bDP_PIN17_CONNECT                       (MCU_PORT_PB0_PIN_REG_FF8F) // Pin 50, PB.0

sbit bA0_CONNECT                                = P3 ^ 0; // Pin 62, P3.0
#define bD0_CONNECT                             (((bit)bDP_PIN15_CONNECT == _TRUE) && ((bit)bDP_PIN16_CONNECT == _TRUE))
...
#define PCB_D1_MHL_DETECT()                     (MCU_PORTC1_PIN_REG_FFA2) // Pin1, PC.1

sbit bD1_TMDS_SWITCH                            = P1 ^ 6; // Pin60, P1.6
...
#endif // End of #if(_PCB_TYPE == _RL6269_DEMO_1A1MHL1DP)
