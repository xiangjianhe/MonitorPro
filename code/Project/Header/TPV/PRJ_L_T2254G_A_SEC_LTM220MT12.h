...
#if(_PROJECT == _PRJ_L_T2254G_A_SEC_LTM220MT12)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G7430_6230_A


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_SEC_LTM220MT12//_TPV_SAMSUNG_LTM230HL08//_TPV_SEC_LTM220MT12
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT2254G_A.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT2254G)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT2254G)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT2254G)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(LT2254G)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
#define _MODEL_NAME												'T', '2', '2', '5', '4'
#define _MICROCODE												'L', 'S', '0', '.', '5'
#define _IC_SERIES                                      		'R', 'T', 'D', '2', '2', '8', '0', 'D', 'L', 'W'
#define _PANNEL_NAME 											'L', 'T', 'M', '2', '2', '0', 'M', 'T', '1', '2'
#define _RELEASE_DATE                                        	'2', '0', '1', '5', '0', '7', '0', '3'
...
#define MAX_CONTRAST_RATIO                                      113 // 1.75(unit 1/100)
...
#define _CT9300_LenovoPrj_GREEN                                 111
