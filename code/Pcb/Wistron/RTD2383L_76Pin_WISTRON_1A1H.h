...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL336_Demo_76Pin_1A1H.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RTD2383L_76PIN_WISTRON_1A1H)

#define _EXT_XTAL                               _XTAL14318K     

#define _INPUT_PORT_MAX                         _DUAL
...
//--------------------------------------------------
#define _LVDS_DRIV_CONTROL                      _LVDS_DRIV_CONTROL_2_0                  
...
// VGA_CABLE_DET
#define _PIN_24                                 (0 & 0x07) // Page 10-0xA3[2:0]
...
//        3: TEST_PIN2<O>, 4:TEST_PIN3<O>, 5: DDC3<IO>)
...
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 18*1000); \
                                                }
...
//-----------------------------------------------
sbit bFLASH_WRITE_PROTECT                       = P3 ^ 4;   //_PIN_58
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT65_PIN_REG_FFCC) //_PIN_30
...
//-----------------------------------------------
sbit bEDID_WRITE_PROTECT                        = P3 ^ 3; //   //_PIN_60  
...
//-----------------------------------------------
#define bA0_CONNECT                             (MCU_PORT_PB6_PIN_REG_FF89) // _PIN_24
sbit bD1_CONNECT                                = P3 ^ 3; //   //_PIN_61  
...
// Macro of LED On/Off
//--------------------------------------------------
//#define bLED1                                   (MCU_PORT_PB7_PIN_REG_FF7F) // _PIN_23
#define bLED2                                   (MCU_PORTC4_PIN_REG_FFA4) //_PIN_22
#define bLED1                                   (MCU_PORTC3_PIN_REG_FFA0) //_PIN_37
...
#define AD_KEY2                                 (MCU_ADC2_RESULT_FF0B) // _PIN_29
#define AD_KEY1                                 (MCU_ADC1_RESULT_FF0A) // _PIN_28
#define bPOWER_KEY                              (MCU_PORT61_PIN_REG_FFC8)//_PIN_27
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x00 <= ucV1) && (ucV1 < 0x40))    \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x95 <= ucV1) && (ucV1 < 0xA9))    \
...
//--------------------------------------------------
sbit bBACKLIGHTPOWER                            = P3 ^ 2; // _PIN_59
...
//-----------------------------------------------
#define bAudioEn                                (MCU_PORT60_PIN_REG_FFC7)//_PIN_50
...
//-----------------------------------------------
#define _AIN_AUDIO_VOL_FIXED                    0x2828//ym20130222 . max:0x3F3F
#define _DAC_AUDIO_VOL_FIXED                    0x2E2E//ym20130222 . max:0x3F3F
#define _VOLUME_MAX                             0xb0
#define _VOLUME_MIN                             0x10//0x25
...
//#define PCB_POWER_5V_DETECT()                   (_TRUE)//(ScalerLDOPC99PowerDetect(GET_POWER_STATUS()))
#define PCB_POWER_5V_DETECT()                   (ScalerLDOPC99PowerDetect(GET_POWER_STATUS()))

#endif // End of #if(_PCB_TYPE == _RL6336_DEMO_76PIN_1A1H)
