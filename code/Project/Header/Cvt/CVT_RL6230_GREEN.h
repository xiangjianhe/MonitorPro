...
//----------------------------------------------------------------------------------------------------
// ID Code      : CVT_RL6230_GREEN.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _CVT_RL6230_GREEN)
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_V20_10.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(V20-10)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(V20-10)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(V20-10)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(V20-10)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME                                             _bV_, _b2_, _b0_, _LINE, _b1_, _b0_
#define _MICROCODE                                              _bL_,_bB_, _b0_, _DOT, _b8_

#define _FACTORY_PROJECT_NAME                                   _V,_2,_0,_MINUS,_1,_0
#define _FW_RELEASE_DATE                                        _2,_0,_1,_7,_1,_1,_2,_8
#define _FW_VERSION                                             _L,_B,_0,_DOT,_8
...
#define MENU_TYPE                               				"LENOVO GEREEN" // xml menu name
...
#define _LOW_BLUE_LIGHT_STYLE_IN_COLOR_TEMP                     _ON//New Blue Light style
...
#define _ICON_BLANK2_PIXEL                                      5
#define _ICON_BLANK3_PIXEL                                      20
#define _ICON_BLANK4_PIXEL                                      16
#define _ICON_BLANK5_PIXEL                                      12
...
#endif // End of #if(_PROJECT == _CVT_RL6230_GREEN)
