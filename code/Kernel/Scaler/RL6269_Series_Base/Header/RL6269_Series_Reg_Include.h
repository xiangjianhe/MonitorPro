...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_Series_Reg_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// DCR Data Port
//--------------------------------------------------
#define _P7_D9_PT_00_DCR_ABOVE_TH1_NUM2           0x00 // Total pixel number above threshold1: bit[23:16] 
#define _P7_D9_PT_01_DCR_ABOVE_TH1_NUM1           0x01 // Total pixel number above threshold1: bit[15:8]
#define _P7_D9_PT_02_DCR_ABOVE_TH1_NUM0           0x02 // Total pixel number above threshold1: bit[7:0]
#define _P7_D9_PT_03_DCR_ABOVE_TH1_VAL3           0x03 // Total sum (R+G+B) of pixel value above threshold1: bit[31:24]
#define _P7_D9_PT_04_DCR_ABOVE_TH1_VAL2           0x04 // Total sum (R+G+B) of pixel value above threshold1: bit[23:16]
#define _P7_D9_PT_05_DCR_ABOVE_TH1_VAL1           0x05 // Total sum (R+G+B) of pixel value above threshold1: bit[15:8]
#define _P7_D9_PT_06_DCR_ABOVE_TH1_VAL0           0x06 // Total sum (R+G+B) of pixel value above threshold1: bit[7:0]
#define _P7_D9_PT_07_DCR_ABOVE_TH2_NUM2           0x07 // Total pixel number above threshold2: bit[23:16]
#define _P7_D9_PT_08_DCR_ABOVE_TH2_NUM1           0x08 // Total pixel number above threshold2: bit[15:8]
#define _P7_D9_PT_09_DCR_ABOVE_TH2_NUM0           0x09 // Total pixel number above threshold2: bit[7:0]
#define _P7_D9_PT_0A_DCR_ABOVE_TH2_VAL3           0x0A // Total sum (R+G+B) of pixel value above threshold2: bit[31:24]
#define _P7_D9_PT_0B_DCR_ABOVE_TH2_VAL2           0x0B // Total sum (R+G+B) of pixel value above threshold2: bit[23:16]
#define _P7_D9_PT_0C_DCR_ABOVE_TH2_VAL1           0x0C // Total sum (R+G+B) of pixel value above threshold2: bit[15:8]
#define _P7_D9_PT_0D_DCR_ABOVE_TH2_VAL0           0x0D // Total sum (R+G+B) of pixel value above threshold2: bit[7:0]

#define _P7_D9_PT_0E_DCR_HIGH_LV_NUM_R1           0x0E // The R Highest Level Pixel Number, RMAX_NUM[15:8]
#define _P7_D9_PT_0F_DCR_HIGH_LV_NUM_R0           0x0F // The R Highest Level Pixel Number, RMAX_NUM[7:0]
#define _P7_D9_PT_10_DCR_LOW_LV_NUM_R1            0x10 // The R Lowest Level Pixel Number, RMIN_NUM[15:8]
#define _P7_D9_PT_11_DCR_LOW_LV_NUM_R0            0x11 // The R Lowest Level Pixel Number, RMIN_NUM[7:0]
#define _P7_D9_PT_12_DCR_HIGH_LV_VAL_R            0x12 // The R Highest Level Value
#define _P7_D9_PT_13_DCR_LOW_LV_VAL_R             0x13 // The R Lower Level Value
#define _P7_D9_PT_14_DCR_HIGH_LV_NUM_G1           0x14 // The G Highest Level Pixel Number, GMAX_NUM[15:8]
#define _P7_D9_PT_15_DCR_HIGH_LV_NUM_G0           0x15 // The G Highest Level Pixel Number, GMAX_NUM[7:0]
#define _P7_D9_PT_16_DCR_LOW_LV_NUM_G1            0x16 // The G Lowest Level Pixel Number, GMIN_NUM[15:8]
#define _P7_D9_PT_17_DCR_LOW_LV_NUM_G0            0x17 // The G Lowest Level Pixel Number, GMIN_NUM[7:0]
#define _P7_D9_PT_18_DCR_HIGH_LV_VAL_G            0x18 // The G Highest Level Value
#define _P7_D9_PT_19_DCR_LOW_LV_VAL_G             0x19 // The G Lower Level Value
#define _P7_D9_PT_1A_DCR_HIGH_LV_NUM_B1           0x1A // The B Highest Level Pixel Number, BMAX_NUM[15:8]
#define _P7_D9_PT_1B_DCR_HIGH_LV_NUM_B0           0x1B // The B Highest Level Pixel Number, BMAX_NUM[7:0]
#define _P7_D9_PT_1C_DCR_LOW_LV_NUM_B1            0x1C // The B Lowest Level Pixel Number, BMIN_NUM[15:8]
#define _P7_D9_PT_1D_DCR_LOW_LV_NUM_B0            0x1D // The B Lowest Level Pixel Number, BMIN_NUM[7:0]

#define _P7_D9_PT_1E_DCR_HIGH_LV_VAL_B            0x1E // B Highest Level Value
#define _P7_D9_PT_1F_DCR_LOW_LV_VAL_B             0x1F // B Lower Level Value
...
//--------------------------------------------------
// ETCON accessing port
//--------------------------------------------------
#define _P15_A4_PT_00_TC13_LSB                     0x00
#define _P15_A4_PT_08_TC12_LSB                     0x08
#define _P15_A4_PT_10_TC11_LSB                     0x10
#define _P15_A4_PT_18_TC10_LSB                     0x18
#define _P15_A4_PT_20_TC9_LSB                      0x20
#define _P15_A4_PT_28_TC8_LSB                      0x28
#define _P15_A4_PT_30_TC7_LSB                      0x30
#define _P15_A4_PT_38_TC6_LSB                      0x38
#define _P15_A4_PT_40_TC5_LSB                      0x40
#define _P15_A4_PT_48_TC4_LSB                      0x48
#define _P15_A4_PT_50_TC3_LSB                      0x50
#define _P15_A4_PT_58_TC2_LSB                      0x58
#define _P15_A4_PT_60_TC1_LSB                      0x60
#define _P15_A4_PT_68_TC0_LSB                      0x68
#define _P15_A4_PT_A0_TC14_LSB                     0xA0
...
#define CM_38_PCM_SHARE_LINE_BUFFER         0x0038 // PCM Share Line Buffer
...
#define P0_DF_EBD_REGLATOR_A_CTRL           0x00DF // LDO Xtal Control
#define P0_E0_EBD_REGLATOR_DB_CTRL          0x00E0 // LDO Xtal Control
...
#define P1_D5_SSC_REF_SEL                   0x01D5 // DPLL SSCG reference clk select
...
#define P5_EB_SDRF_MN_MADDR_TOG_REM        0x05EB // MAIN_MADR_TOG_REM[7:0]
...
#define P6_CE_LFSR_CTRL                    0x06CE // LFSR Control Register
...
//--------------------------------------------------
#define P7_CC_SCM_BLOCK_ENABLE             0x07CC // SCM Control Register
#define P7_CD_SCM_BLOCK_SELECT             0x07CD // SCM Block Select
#define P7_CE_SCM_ACCESS_PORT_CONTROL      0x07CE // SCM Access Port Control
#define P7_CF_SCM_ACCESS_PORT_DATA         0x07CF // SCM Access Port Data 
...
#define P7_DA_DCR_CONTROL                  0x07DA // DCR Control  
#define P7_DE_DCR_THESHOLD1                0x07DE // DCR Threshold1 
#define P7_DF_DCR_THESHOLD2                0x07DF // DCR Threshold2

//--------------------------------------------------
// CABC (Page7)
//--------------------------------------------------
#define P7_DA_DCR_ADDRESS_PORT             0x07DA // DCR  Address Port
...
// Aux Digital Phy
#define PA_D0_DP_AUX_DIG_PHY_0             0x0AD0 // 
#define PA_D1_DP_AUX_DIG_PHY_1             0x0AD1 //
#define PA_D2_DP_AUX_DIG_PHY_2             0x0AD2 // 
#define PA_D3_DP_AUX_DIG_PHY_3             0x0AD3 //
#define PA_D4_DP_AUX_DIG_PHY_4             0x0AD4 // 
#define PA_D5_DP_AUX_DIG_PHY_5             0x0AD5 //
#define PA_D6_DP_AUX_DIG_PHY_6             0x0AD6 // 
#define PA_D7_DP_AUX_DIG_PHY_7             0x0AD7 //
#define PA_D8_DP_AUX_DIG_PHY_8             0x0AD8 //
#define PA_D9_DP_AUX_DIG_PHY_9             0x0AD9 // 
#define PA_DA_DP_AUX_DIG_PHY_A             0x0ADA //

#define PA_DB_DP_GDI_PW_TIMER              0x0ADB //
#define PA_DC_DP_GDI_PW_FLAG               0x0ADC //
#define PA_DD_DP_AUX_DELAY_TIMER           0x0ADD //
#define PA_DE_DP_AUX_DELAY_FIFO            0x0ADE //
#define PA_DF_DP_AUX_DEBUG                 0X0ADF //
...
#define P10_B3_PIN_SHARE_CTRL13            0x10B3 
#define P10_B4_PIN_SHARE_CTRL14            0x10B4 
#define P10_B5_PIN_SHARE_CTRL15            0x10B5 
#define P10_B6_PIN_SHARE_CTRL16            0x10B6 
#define P10_B7_PIN_SHARE_CTRL17            0x10B7 
#define P10_B8_PIN_SHARE_CTRL18            0x10B8 
#define P10_B9_PIN_SHARE_CTRL19            0x10B9 
#define P10_BA_PIN_SHARE_CTRL1A            0x10BA 
#define P10_BB_PIN_SHARE_CTRL1B            0x10BB 
#define P10_BC_PIN_SHARE_CTRL1C            0x10BC
#define P10_BD_PIN_SHARE_CTRL1D            0x10BD
#define P10_BE_PIN_SHARE_CTRL1E            0x10BE
#define P10_BF_PIN_SHARE_CTRL1F            0x10BF

#define P10_C0_PIN_SHARE_CTRL20            0x10C0
#define P10_C1_PIN_SHARE_CTRL21            0x10C1
#define P10_C2_PIN_SHARE_CTRL22            0x10C2
#define P10_C3_PIN_SHARE_CTRL23            0x10C3
#define P10_C4_PIN_SHARE_CTRL24            0x10C4
#define P10_C5_PIN_SHARE_CTRL25            0x10C5

#define P10_C6_PIN_SHARE_CTRL26            0x10C6 
#define P10_C7_PIN_SHARE_CTRL27            0x10C7 
#define P10_C8_PIN_SHARE_CTRL28            0x10C8 
#define P10_C9_PIN_SHARE_CTRL29            0x10C9 
#define P10_CA_PIN_SHARE_CTRL2A            0x10CA 
#define P10_CB_PIN_SHARE_CTRL2B            0x10CB 
#define P10_CC_PIN_SHARE_CTRL2C            0x10CC 
#define P10_CD_PIN_SHARE_CTRL2D            0x10CD 
#define P10_CE_PIN_SHARE_CTRL2E            0x10CE
#define P10_CF_PIN_SHARE_CTRL2F            0x10CF

#define P10_D0_PIN_SHARE_CTRL30            0x10D0 
#define P10_D1_PIN_SHARE_CTRL31            0x10D1 
#define P10_D2_PIN_SHARE_CTRL32            0x10D2 
#define P10_D3_PIN_SHARE_CTRL33            0x10D3 
#define P10_D4_PIN_SHARE_CTRL34            0x10D4 
#define P10_D5_PIN_SHARE_CTRL35            0x10D5 
#define P10_D6_PIN_SHARE_CTRL36            0x10D6 
#define P10_D7_PIN_SHARE_CTRL37            0x10D7 
#define P10_D8_PIN_SHARE_CTRL38            0x10D8 
#define P10_D9_PIN_SHARE_CTRL39            0x10D9 
#define P10_DA_PIN_SHARE_CTRL3A            0x10DA 
#define P10_DB_PIN_SHARE_CTRL3B            0x10DB 
#define P10_DC_PIN_SHARE_CTRL3C            0x10DC 
#define P10_DD_PIN_SHARE_CTRL3D            0x10DD 
#define P10_DE_PIN_SHARE_CTRL3E            0x10DE
#define P10_DF_PIN_SHARE_CTRL3F            0x10DF 


#define P10_E0_PIN_SHARE_CTRL40            0x10E0 
#define P10_E1_PIN_DRIVING_CTRL41          0x10E1 
#define P10_E2_PIN_DVIVING_CTRL42          0x10E2 
#define P10_E3_PIN_SLEW_RATE_CTRL43        0x10E3 
#define P10_E4_PIN_SCHMITT_TIGGER_CTRL44   0x10E4 
#define P10_E5_PIN_XTAL_SPREAD_CTRL45      0x10E5 
#define P10_E6_PIN_PINTYPE_CTRL46          0x10E6 
#define P10_E7_PIN_PULLUP_CTRL47           0x10E7 
#define P10_E8_PIN_PULLUP_CTRL48           0x10E8 
#define P10_E9_PIN_PULLUP_CTRL49           0x10E9 
#define P10_EA_PIN_PULLUP_CTRL4A           0x10EA 
#define P10_EB_PIN_PULLUP_CTRL4B           0x10EB 
#define P10_EC_PIN_PULLUP_CTRL4C           0x10EC 
#define P10_ED_PIN_UPDOWN_CTRL4D           0x10ED 
#define P10_EE_PIN_UPDOWN_CTRL4E           0x10EE 
#define P10_EF_PIN_UPDOWN_CTRL4F           0x10EF 


#define P10_F0_PIN_UPDOWN_CTRL50           0x10F0 
#define P10_F1_PIN_UPDOWN_CTRL51           0x10F1 
#define P10_F2_PIN_PULLUP_CTRL52           0x10F2
#define P10_F3_PIN_SDRAM_CTRL53            0x10F3 
#define P10_F4_PIN_SDRAM_CTRL54            0x10F4
#define P10_F5_PIN_SDRAM_CTRL55            0x10F5 
#define P10_F6_PIN_SDRAM_CTRL56            0x10F6 
#define P10_F7_PIN_SDRAM_CTRL57            0x10F7
#define P10_F8_PIN_SDRAM_CTRL58            0x10F8
#define P10_F9_PIN_INT_SCHMITT_CTRL59      0x10F9 
#define P10_FA_PIN_INT_SCHMITT_CTRL5A      0x10FA
#define P10_FB_PIN_CBUS_PIN_SELECT         0x10FB
...
/////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////// Page 12: Super Resolution//////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P12_A0_SR_SHP_CTRL                 0x12A0
#define P12_A2_SR_SHP_CTRL_1               0x12A2


/////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////// Page 13: Super Resolution//////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P13_A0_SR_CDS_CTRL                 0x13A0
#define P13_B2_SR_CDS_PK_GAIN_BLR_CM1      0x13B2


/////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////// Page 14: Super Resolution//////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
...
#define P14_C1_SR_HOR_HP_FILTER_C0         0x14C1
#define P14_C2_SR_HOR_HP_FILTER_C1C2       0x14C2

#define P14_E0_SR_VER_SOB_THD2_MSB         0x14E0


/////////////////////////////////////////////////////////////////////////////////////////
//////////////////// Page 15: Embedded Timing Controller/////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P15_A1_TCON_CTRL                   0x15A1
#define P15_A3_ADDR_PORT                   0x15A3
#define P15_A4_DATA_PORT                   0x15A4
...
/////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////// Page 17: Local Dimming /////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P17_A0_LD_HLW_ENABLE_CTRL           0x17A0 
#define P17_A1_LD_GLOBAL_CTRL               0x17A1
#define P17_A2_LD_HLW_ADDR_PORT             0x17A2
#define P17_A4_LD_BCURVE_LUT_CTRL           0x17A4
#define P17_A5_LD_BCURVE_ADDR_PORT          0x17A5
#define P17_A6_LD_BCURVE_DATA_PORT          0x17A6
#define P17_A7_LD_SCURVE_LUT_CTRL           0x17A7
#define P17_A8_LD_SCURVE_ADDR_PORT          0x17A8
#define P17_A9_LD_SCURVE_DATA_PORT          0x17A9
#define P17_AA_LD_1ST_SCURVE_TH12           0x17AA
#define P17_AB_LD_1ST_SCURVE_TH1            0x17AB
#define P17_AC_LD_1ST_SCURVE_TH2            0x17AC
#define P17_AD_LD_2ST_SCURVE_TH12           0x17AD
#define P17_AE_LD_2ST_SCURVE_TH1            0x17AE
#define P17_AF_LD_2ST_SCURVE_TH2            0x17AF
#define P17_B0_LD_3ST_SCURVE_TH12           0x17B0
#define P17_B1_LD_3ST_SCURVE_TH1            0x17B1
#define P17_B2_LD_3ST_SCURVE_TH2            0x17B2
#define P17_B3_LD_4ST_SCURVE_TH12           0x17B3
#define P17_B4_LD_4ST_SCURVE_TH1            0x17B4
#define P17_B5_LD_4ST_SCURVE_TH2            0x17B5
#define P17_B6_LD_GAIN_LUT_CTRL             0x17B6
#define P17_B7_LD_GAIN_ADDR_PORT            0x17B7
#define P17_B8_LD_GAIN_DATA_PORT            0x17B8
#define P17_B9_LD_CTS_LUT_CTRL              0x17B9
#define P17_BA_LD_CTS_ADDR_PORT             0x17BA
#define P17_BB_LD_CTS_DATA_PORT             0x17BB
#define P17_BC_LD_SOFT_CLAMP_GAIN2          0x17BC
#define P17_BD_LD_LOCAL_DCR_TH1_H           0x17BD
#define P17_BE_LD_LOCAL_DCR_TH1_L           0x17BE
#define P17_BF_LD_PIXEL_NUM_H               0x17BF
#define P17_C0_LD_PIXEL_NUM_L               0x17C0
#define P17_C1_LD_DYNAMIC_MAX_VALUE_L       0x17C1
...
///////////////////////////////////// Page 27: CBUS PHY//////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P27_A0_CBUS_EN                     0x27A0
#define P27_A1_RES_AUTOK_1                 0x27A1 
#define P27_A2_RES_AUTOK_2                 0x27A2 
#define P27_A3_RES_AUTOK_3                 0x27A3 
#define P27_A4_INPUT_CONTROL               0x27A4 
#define P27_A5_OUTPUT_CONTROL_1            0x27A5 
#define P27_A6_OUTPUT_CONTROL_2            0x27A6 
#define P27_A7_OUTPUT_CONTROL_3            0x27A7 
#define P27_A8_OUTPUT_CONTROL_4            0x27A8 

/////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////// Page 28: CBUS0 MAC/////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P28_A0_CBUS0_CTRL_00               0x28A0
#define P28_A1_CBUS0_CTRL_01               0x28A1
#define P28_A2_CBUS0_CTRL_02               0x28A2
#define P28_A3_CBUS0_CTRL_03               0x28A3
#define P28_A4_CBUS0_CTRL_04               0x28A4
#define P28_A5_CBUS0_CTRL_05               0x28A5
#define P28_A6_CBUS0_CTRL_06               0x28A6
#define P28_A7_CBUS0_CTRL_07               0x28A7
#define P28_A8_CBUS0_CTRL_08               0x28A8
#define P28_A9_CBUS0_CTRL_09               0x28A9
#define P28_AA_CBUS0_CTRL_0A               0x28AA
#define P28_AB_CBUS0_CTRL_0B               0x28AB
#define P28_AC_CBUS0_CTRL_0C               0x28AC
#define P28_AD_CBUS0_CTRL_0D               0x28AD
#define P28_AE_CBUS0_CTRL_0E               0x28AE
#define P28_AF_CBUS0_CTRL_0F               0x28AF
#define P28_B0_CBUS0_CTRL_10               0x28B0
#define P28_B1_CBUS0_CTRL_11               0x28B1
#define P28_B2_CBUS0_CTRL_12               0x28B2
#define P28_B3_CBUS0_CTRL_13               0x28B3
#define P28_B4_CBUS0_CTRL_14               0x28B4
#define P28_B5_CBUS0_CTRL_15               0x28B5
#define P28_B6_CBUS0_CTRL_16               0x28B6
#define P28_B7_CBUS0_CTRL_17               0x28B7
#define P28_B8_CBUS0_CTRL_18               0x28B8
#define P28_B9_CBUS0_CTRL_19               0x28B9
#define P28_BA_CBUS0_CTRL_1A               0x28BA
#define P28_BB_CBUS0_CTRL_1B               0x28BB
#define P28_BC_CBUS0_CTRL_1C               0x28BC
#define P28_BD_CBUS0_CTRL_1D               0x28BD
#define P28_BE_CBUS0_CTRL_1E               0x28BE
#define P28_BF_CBUS0_CTRL_1F               0x28BF
#define P28_C0_CBUS0_CTRL_20               0x28C0
#define P28_C1_CBUS0_CTRL_21               0x28C1
#define P28_C2_CBUS0_CTRL_22               0x28C2
#define P28_C3_CBUS0_CTRL_23               0x28C3
#define P28_C4_CBUS0_CTRL_24               0x28C4
#define P28_C5_CBUS0_CTRL_25               0x28C5
#define P28_C6_CBUS0_CTRL_26               0x28C6
#define P28_C7_CBUS0_CTRL_27               0x28C7
#define P28_C8_CBUS0_CTRL_28               0x28C8
#define P28_C9_CBUS0_CTRL_29               0x28C9
#define P28_CA_CBUS0_CTRL_2A               0x28CA
#define P28_CB_CBUS0_CTRL_2B               0x28CB
#define P28_CC_CBUS0_CTRL_2C               0x28CC
#define P28_CD_CBUS0_CTRL_2D               0x28CD
#define P28_CE_CBUS0_CTRL_2E               0x28CE
#define P28_CF_CBUS0_CTRL_2F               0x28CF
#define P28_D0_CBUS0_CTRL_30               0x28D0
#define P28_D1_CBUS0_CTRL_31               0x28D1
#define P28_D2_CBUS0_CTRL_32               0x28D2
#define P28_D3_CBUS0_CTRL_33               0x28D3
#define P28_D4_CBUS0_CTRL_34               0x28D4
#define P28_D5_CBUS0_CTRL_35               0x28D5
#define P28_D6_CBUS0_CTRL_36               0x28D6
#define P28_D7_CBUS0_CTRL_37               0x28D7
#define P28_D8_CBUS0_CTRL_38               0x28D8
#define P28_D9_CBUS0_CTRL_39               0x28D9
#define P28_DA_CBUS0_CTRL_3A               0x28DA
#define P28_DB_CBUS0_CTRL_3B               0x28DB
#define P28_DC_CBUS0_CTRL_3C               0x28DC
#define P28_DD_CBUS0_CTRL_3D               0x28DD
#define P28_DE_CBUS0_CTRL_3E               0x28DE
#define P28_DF_CBUS0_CTRL_3F               0x28DF
#define P28_E0_CBUS0_CTRL_40               0x28E0
#define P28_E1_CBUS0_CTRL_41               0x28E1
#define P28_E2_CBUS0_CTRL_42               0x28E2
#define P28_E3_CBUS0_CTRL_43               0x28E3
#define P28_E4_CBUS0_CTRL_44               0x28E4
#define P28_E5_CBUS0_CTRL_45               0x28E5
#define P28_E6_CBUS0_CTRL_46               0x28E6
#define P28_E7_CBUS0_CTRL_47               0x28E7
#define P28_E8_CBUS0_CTRL_48               0x28E8
#define P28_E9_CBUS0_CTRL_49               0x28E9
#define P28_EA_CBUS0_CTRL_4A               0x28EA
#define P28_EB_CBUS0_CTRL_4B               0x28EB
#define P28_EC_CBUS0_CTRL_4C               0x28EC
#define P28_ED_CBUS0_CTRL_4D               0x28ED
#define P28_EE_CBUS0_CTRL_4E               0x28EE
#define P28_EF_CBUS0_CTRL_4F               0x28EF
#define P28_F0_CBUS0_CTRL_50               0x28F0
#define P28_F1_CBUS0_CTRL_51               0x28F1
#define P28_F2_CBUS0_CTRL_52               0x28F2
#define P28_F3_CBUS0_CTRL_53               0x28F3
#define P28_F4_CBUS0_CTRL_54               0x28F4
#define P28_F5_CBUS0_CTRL_55               0x28F5
#define P28_F6_CBUS0_CTRL_56               0x28F6
#define P28_F7_CBUS0_CTRL_57               0x28F7
#define P28_F8_CBUS0_CTRL_58               0x28F8
#define P28_F9_CBUS0_CTRL_59               0x28F9
#define P28_FA_CBUS0_CTRL_5A               0x28FA
#define P28_FB_CBUS0_CTRL_5B               0x28FB
#define P28_FC_CBUS0_CTRL_5C               0x28FC
#define P28_FD_CBUS0_CTRL_5D               0x28FD

/////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////// Page 29: CBUS1 MAC/////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
#define P29_A0_CBUS1_CTRL_00               0x29A0
#define P29_A1_CBUS1_CTRL_01               0x29A1
#define P29_A2_CBUS1_CTRL_02               0x29A2
#define P29_A3_CBUS1_CTRL_03               0x29A3
#define P29_A4_CBUS1_CTRL_04               0x29A4
#define P29_A5_CBUS1_CTRL_05               0x29A5
#define P29_A6_CBUS1_CTRL_06               0x29A6
#define P29_A7_CBUS1_CTRL_07               0x29A7
#define P29_A8_CBUS1_CTRL_08               0x29A8
#define P29_A9_CBUS1_CTRL_09               0x29A9
#define P29_AA_CBUS1_CTRL_0A               0x29AA
#define P29_AB_CBUS1_CTRL_0B               0x29AB
#define P29_AC_CBUS1_CTRL_0C               0x29AC
#define P29_AD_CBUS1_CTRL_0D               0x29AD
#define P29_AE_CBUS1_CTRL_0E               0x29AE
#define P29_AF_CBUS1_CTRL_0F               0x29AF
#define P29_B0_CBUS1_CTRL_10               0x29B0
#define P29_B1_CBUS1_CTRL_11               0x29B1
#define P29_B2_CBUS1_CTRL_12               0x29B2
#define P29_B3_CBUS1_CTRL_13               0x29B3
#define P29_B4_CBUS1_CTRL_14               0x29B4
#define P29_B5_CBUS1_CTRL_15               0x29B5
#define P29_B6_CBUS1_CTRL_16               0x29B6
#define P29_B7_CBUS1_CTRL_17               0x29B7
#define P29_B8_CBUS1_CTRL_18               0x29B8
#define P29_B9_CBUS1_CTRL_19               0x29B9
#define P29_BA_CBUS1_CTRL_1A               0x29BA
#define P29_BB_CBUS1_CTRL_1B               0x29BB
#define P29_BC_CBUS1_CTRL_1C               0x29BC
#define P29_BD_CBUS1_CTRL_1D               0x29BD
#define P29_BE_CBUS1_CTRL_1E               0x29BE
#define P29_BF_CBUS1_CTRL_1F               0x29BF
#define P29_C0_CBUS1_CTRL_20               0x29C0
#define P29_C1_CBUS1_CTRL_21               0x29C1
#define P29_C2_CBUS1_CTRL_22               0x29C2
#define P29_C3_CBUS1_CTRL_23               0x29C3
#define P29_C4_CBUS1_CTRL_24               0x29C4
#define P29_C5_CBUS1_CTRL_25               0x29C5
#define P29_C6_CBUS1_CTRL_26               0x29C6
#define P29_C7_CBUS1_CTRL_27               0x29C7
#define P29_C8_CBUS1_CTRL_28               0x29C8
#define P29_C9_CBUS1_CTRL_29               0x29C9
#define P29_CA_CBUS1_CTRL_2A               0x29CA
#define P29_CB_CBUS1_CTRL_2B               0x29CB
#define P29_CC_CBUS1_CTRL_2C               0x29CC
#define P29_CD_CBUS1_CTRL_2D               0x29CD
#define P29_CE_CBUS1_CTRL_2E               0x29CE
#define P29_CF_CBUS1_CTRL_2F               0x29CF
#define P29_D0_CBUS1_CTRL_30               0x29D0
#define P29_D1_CBUS1_CTRL_31               0x29D1
#define P29_D2_CBUS1_CTRL_32               0x29D2
#define P29_D3_CBUS1_CTRL_33               0x29D3
#define P29_D4_CBUS1_CTRL_34               0x29D4
#define P29_D5_CBUS1_CTRL_35               0x29D5
#define P29_D6_CBUS1_CTRL_36               0x29D6
#define P29_D7_CBUS1_CTRL_37               0x29D7
#define P29_D8_CBUS1_CTRL_38               0x29D8
#define P29_D9_CBUS1_CTRL_39               0x29D9
#define P29_DA_CBUS1_CTRL_3A               0x29DA
#define P29_DB_CBUS1_CTRL_3B               0x29DB
#define P29_DC_CBUS1_CTRL_3C               0x29DC
#define P29_DD_CBUS1_CTRL_3D               0x29DD
#define P29_DE_CBUS1_CTRL_3E               0x29DE
#define P29_DF_CBUS1_CTRL_3F               0x29DF
#define P29_E0_CBUS1_CTRL_40               0x29E0
#define P29_E1_CBUS1_CTRL_41               0x29E1
#define P29_E2_CBUS1_CTRL_42               0x29E2
#define P29_E3_CBUS1_CTRL_43               0x29E3
#define P29_E4_CBUS1_CTRL_44               0x29E4
#define P29_E5_CBUS1_CTRL_45               0x29E5
#define P29_E6_CBUS1_CTRL_46               0x29E6
#define P29_E7_CBUS1_CTRL_47               0x29E7
#define P29_E8_CBUS1_CTRL_48               0x29E8
#define P29_E9_CBUS1_CTRL_49               0x29E9
#define P29_EA_CBUS1_CTRL_4A               0x29EA
#define P29_EB_CBUS1_CTRL_4B               0x29EB
#define P29_EC_CBUS1_CTRL_4C               0x29EC
#define P29_ED_CBUS1_CTRL_4D               0x29ED
#define P29_EE_CBUS1_CTRL_4E               0x29EE
#define P29_EF_CBUS1_CTRL_4F               0x29EF
#define P29_F0_CBUS1_CTRL_50               0x29F0
#define P29_F1_CBUS1_CTRL_51               0x29F1
#define P29_F2_CBUS1_CTRL_52               0x29F2
#define P29_F3_CBUS1_CTRL_53               0x29F3
#define P29_F4_CBUS1_CTRL_54               0x29F4
#define P29_F5_CBUS1_CTRL_55               0x29F5
#define P29_F6_CBUS1_CTRL_56               0x29F6
#define P29_F7_CBUS1_CTRL_57               0x29F7
#define P29_F8_CBUS1_CTRL_58               0x29F8
#define P29_F9_CBUS1_CTRL_59               0x29F9
#define P29_FA_CBUS1_CTRL_5A               0x29FA
#define P29_FB_CBUS1_CTRL_5B               0x29FB
#define P29_FC_CBUS1_CTRL_5C               0x29FC
#define P29_FD_CBUS1_CTRL_5D               0x29FD
...
#endif // End of #ifndef __RL6269_SERIES_REG__
