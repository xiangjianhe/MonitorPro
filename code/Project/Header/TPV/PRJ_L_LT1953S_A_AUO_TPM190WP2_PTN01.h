...
#if(_PROJECT == _PRJ_L_LT1953S_A_AUO_TPM190WP2_PTN01)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_AUO_TPM190WP2_PTN01
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT1953s_A.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT1953S)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
//#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT1953S)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
//#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT1953S)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//
//==================================================================
#define _MODEL_NAME												_bL_, _bT_, _1_, _9_, _5_, _3_,_bs_,___, _bW_,_bi_,_bd_,_be_
#define _MICROCODE												_bL_,_bT_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _L,_T,_1,_9,_5,_3,_s
#define _FW_RELEASE_DATE                                        _2,_0,_1,_5,_1,_0,_2,_2
#define _FW_VERSION                                             _L,_T, _0, _DOT, _1
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.02	

#define _PANNEL_NAME 											'T','P','M','1','9','0','W','P','2'
...
#define MAX_CONTRAST_RATIO                                      128//118 // 1.75(unit 1/100)
...
#define _CT7200_LenovoPrj_BLUE                                  117

#define _CTSRGB_LenovoPrj_RED                                   123
#define _CTSRGB_LenovoPrj_GREEN                                 120
#define _CTSRGB_LenovoPrj_BLUE                                  108
