...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6336_Series_SyncProc_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// Phase delay
//--------------------------------------------------
#define _PHASE_DELAY_TIME_VALUE                     369 // 64 * 5.76 (Unit: ns)
#define _PHASE_DELAY_HALF_PERIOD_SHIFT              ((ScalerGetBit(P0_BB_ADC_2X_SAMPLE, _BIT5) == 0x00) ? 0 : 32)
...
#ifndef __RL6336_SERIES_SYNCPROC__
//****************************************************************************
// VARIABLE EXTERN
//****************************************************************************
...
#endif // End of #ifndef __RL6336_SERIES_SYNCPROC__
