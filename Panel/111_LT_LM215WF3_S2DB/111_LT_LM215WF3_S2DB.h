...
#if(_PANEL_TYPE == _TPV_LT_LM215WF3_S2DB)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         2048                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2600                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1366                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_POWER_ON_T3                      580                 // Panel Power On T3 (ms)//Eli 20120522 modify T3-T4

#define _PANEL_POWER_OFF_T4                     280                 // Panel Power Off T4 (ms)//Eli 20120522 modify T3-T4
...
//--------------------------------------------------
#define _PANEL_ADC_OFFSET_BIAS                  (5) // 0~5
...
#endif // End of #if(_PANEL_TYPE == _TPV_LT_LM215WF3_S2DB)
