...
#if(_PROJECT == _PRJ_L_LT2252W_AD_SEC_LTM220MT09)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_SEC_LTM220MT09
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT2252W)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT2252W)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT2252W)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME												_bL_, _bT_, _2_, _2_, _5_, _2_, ___,_bW_,_bi_,_bd_,_be_
#define _MICROCODE												_bL_,_bS_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _L,_T,_2,_2,_5,_2,_SPACE,_W,_i,_d,_e
#define _FW_RELEASE_DATE                                        _2,_0,_1,_2,_0,_8,_2,_2
#define _FW_VERSION                                             _L,_S, _0, _DOT, _1
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.01	

#define _PANNEL_NAME 											'L','T','M','2','2','0','M','T','0','9'
