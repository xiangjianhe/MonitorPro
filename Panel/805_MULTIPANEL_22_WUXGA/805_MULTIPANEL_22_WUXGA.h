...
#if(_PANEL_TYPE == _MULTIPANEL_22_WUXGA)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_DH_WIDTH                         1680//(tPanelData [GET_MDOMAIN_PANEL_INDEX()][_PANEL_DH_WIDTH_INDEX])             // Display Horizontal Width
...
#define _PANEL_DV_HEIGHT                        1050//(tPanelData [GET_MDOMAIN_PANEL_INDEX()][_PANEL_DV_HEIGHT_INDEX])            // Display Vertical Width
...
#define _DCLK_SPREAD_RANGE                      UserCommonNVRamGetSystemData(_SSC)// 0~15, 0 ~ disable, 15 ~ 7.50%   
#define _PANEL_DCLK_SPREAD_RANGE                (tPanelData [GET_MDOMAIN_PANEL_INDEX()][_PANEL_LVDS_DCLK_SPREAD_INDEX])// 0~15, 0 ~ disable, 15 ~ 7.50%   
...
#if 1
    {
        400,        // _LAST_LINE_TARGET
        _PANEL_CMO, // _PANEL_MANUFACTURER
//---------------------------------------------
        32,         // _PANEL_DH_START
        1680,       // _PANEL_DH_WIDTH
        1712,       // _PANEL_DH_END
     
        1840,       // _PANEL_DH_TOTAL        
        1858,       // _PANEL_DH_TOTAL_MAX    
        1820,       // _PANEL_DH_TOTAL_MIN    
     
        6,          // _PANEL_DV_START     
        1050,       // _PANEL_DV_HEIGHT    
        1056,       // _PANEL_DV_END       
     
        1080,       // _PANEL_DV_TOTAL      
        1090,       // _PANEL_DV_TOTAL_MAX  
        1077,       // _PANEL_DV_TOTAL_MIN  
        8,          // _PANEL_DH_SYNC_WIDTH 
        2,          // _PANEL_DV_SYNC_HEIGHT
     
        120,        // _PANEL_PIXEL_CLOCK    
        154,        // _PANEL_PIXEL_CLOCK_MAX
        98,        // _PANEL_PIXEL_CLOCK_MIN
     
        30,//10,        // _PANEL_POWER_ON_T1
        10,//30,         // _PANEL_POWER_ON_T2
        250,        // _PANEL_POWER_ON_T3
       
        250,         // _PANEL_POWER_OFF_T4
        20,         // _PANEL_POWER_OFF_T5
        1100,        // _PANEL_POWER_OFF_T6

        5,//3,          //_PANEL_LVDS_DCLK_SPREAD_INDEX
    },
...
//---------------------------------------------
        ...
        1840,       // _PANEL_DH_TOTAL        
        2008,       // _PANEL_DH_TOTAL_MAX    
        1826,       // _PANEL_DH_TOTAL_MIN    
        ...
        1080,       // _PANEL_DV_TOTAL      
        1100,       // _PANEL_DV_TOTAL_MAX  
        1059,       // _PANEL_DV_TOTAL_MIN  
        8,          // _PANEL_DH_SYNC_WIDTH 
        2,          // _PANEL_DV_SYNC_HEIGHT
     
        119,        // _PANEL_PIXEL_CLOCK    
        156,        // _PANEL_PIXEL_CLOCK_MAX
        100,        // _PANEL_PIXEL_CLOCK_MIN
     
        30,//10,        // _PANEL_POWER_ON_T1
        10, //20,         // _PANEL_POWER_ON_T2
        550,        // _PANEL_POWER_ON_T3
       
        150,         // _PANEL_POWER_OFF_T4
        20,         // _PANEL_POWER_OFF_T5
        1100,        // _PANEL_POWER_OFF_T6

        6,//5,          //_PANEL_LVDS_DCLK_SPREAD_INDEX
    },
...
//for 1920x1080 test
{
	...
	2088,                               	// Display Horizontal Total Clock Number in One Display Line
	4094,                                   // Maxinum Display Horizontal Total Clock Number in One Display Line
	2088,                                   // Mininum Display Horizontal Total Clock Number in One Display Line

	16,                                     // Display Vertical Start Position
	1080,                                   // Display Vertical Height
	1096,                                   // Display Vertical End Position

	1120,                                   // Display Vertical Total Line Number in One Frame
	2047,                                   // Maxinum Display Vertical Total Line Number in One Frame
	1088,                                   // Mininum Display Vertical Total Line Number in One Frame
	32,                                     // Display H Sync Width
	4,                                      // Display V Sync Height

	144,			                        // Typical Pixel Clock in MHz
	178,                                    // Maxinum Pixel Clock in MHz
	80,                                     // Mininum Pixel Clock in MHz

	10,         							// Panel Power to Data Output delay
	30,										// Data Output to Backlight delay,
	600,                                    // Backlight to Data Outupt delay,

	300,                                    // Backlight to Data Outupt delay,
	30,                                 	// Data Output to Panel Power delay
	1000,                                   // Panel off to panel on power delay

    3,                                      //_PANEL_LVDS_DCLK_SPREAD_INDEX
	},
    ...
    5,                                      //_PANEL_LVDS_DCLK_SPREAD_INDEX
	},
#endif
};
