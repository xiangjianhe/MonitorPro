...
#if(_PROJECT == _FOX_LI1931EW_AUO_M185XTN01_3)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_AUO_M185XTN01_3 // _TPV_SEC_LTM220MT09
...
#define _CAPABILITIES_STRING_VGA 								"(port(monitor)type(LCD)model(LEN LI1931EW)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 AC AE B2 B6 C6 C8 C9 CC(01 02 03 04 05 06 09 0A) D6(01 02 03 04 05) DF FF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
#define _LOGO_TYPE                                      _IBM_THINKVISION_LENOVO//_LENOVO
...
//Facory OSD
#define _FACTORY_PROJECT_NAME                           _L,_I,_1,_9,_3,_1,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_A,_U,_O,_SPACE,_M,_1,_8,_5,_X,_T,_N,_0,_1,_DOT,_3
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_7,_0
#define _FW_RELEASE_DATE                                _2,_0,_1,_3,_0,_8,_0,_1
#define _FW_VERSION                                     _L,_A, _1, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0100  //Ver 1.00

//User OSD
#define _MODEL_NAME                                      _1_, _9_, _3_, _1_
#define _MICROCODE                                       _1_, GLOBAL(0x20), _0_
//Facory Command
...
#define FacoryBomH4                                     'P'
#define FacoryBomH5                                     'T'
#define FacoryBomH6                                     '1'
#define FacoryBomH7                                     '3'
#define FacoryBomH8                                     '0'

#define FacoryBomL1                                     '0'
#define FacoryBomL2                                     '0'
#define FacoryBomL3                                     '5'
#define FacoryBomL4                                     '0'
#define FacoryBomL5                                     '0'
#define FacoryBomL6                                     'R'
#define FacoryBomL7                                     'R'
...
#define _WEB_BRI_BASE_DEF								90
#define _VIDEO_BRI_BASE_DEF								100
#define _SPLIT_BRI_BASE_DEF								100
