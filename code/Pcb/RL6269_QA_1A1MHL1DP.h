...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_QA_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6269_QA_1A1MHL1DP)
...
// CEC
#define _PIN_1                                  (3 & 0x07) // Page 10-0xA0[2:0]
...
// MHL&HDMI Switch
#define _PIN_26                                 (2 & 0x0F) // Page 10-0xA5[2:0]
...
// EEI2WP
#define _PIN_54                                 (1 & 0x0F) // Page 10-0xB5[3:0]
...
// LED1
#define _PIN_60                                 (1 & 0x0F) // Page 10-0xB8[2:0]
...
// LED4
#define _PIN_63                                 (1 & 0x0F) // Page 10-0xBB[3:0]
...
// LED5
#define _PIN_64                                 (1 & 0x0F) // Page 10-0xBC[3:0]
...
// IR_RECEIVER
#define _PIN_90                                 (9 & 0x0F) // Page 10-0xCA[3:0]
...
// LED1
#define _PIN_98                                 (1 & 0x0F) // Page 10-0xD2[3:0]
...
// LED2
#define _PIN_100                                (1 & 0x0F) // Page 10-0xD4[3:0]
...
#define PCB_GPIO_INITIAL_SETTING()              {\
                                                    ...
                                                    PCB_LED_OFF(); \                                                    
                                                    FLASH_CLOCK_EDGE_SAMPLE(_NEGATIVE_EDGE); \
                                                }
...
//-----------------------------------------------
// Macro of Flash Clk Sample Edge
//-----------------------------------------------
#define _POSITIVE_EDGE                          0       // Flash clk positive edge sample
#define _NEGATIVE_EDGE                          1       // Flash clk negative edge sample

#define FLASH_CLOCK_EDGE_SAMPLE(x)              {\
                                                    if(x == _NEGATIVE_EDGE)\
                                                    {\
                                                        MCU_READ_INSTRUCTION_FF6C |= _BIT4;\
                                                    }\
                                                    else\
                                                    {\
                                                        MCU_READ_INSTRUCTION_FF6C &= ~_BIT4;\
...
//-----------------------------------------------
sbit bDP_PIN15_CONNECT                          = P1 ^ 0; // Pin 51, P1.0
#define bDP_PIN16_CONNECT                       (MCU_PORT65_PIN_REG_FFCC) // Pin 92, 6.5
#define bDP_PIN17_CONNECT                       (MCU_PORT_PB0_PIN_REG_FF8F) // Pin 50, PB.0
...
#define PCB_D1_MHL_DETECT()                     (MCU_PORT_PB3_PIN_REG_FF8C) // Pin47, PB3

#define bD1_TMDS_SWITCH                         (MCU_PORT_PD3_PIN_REG_FF7B)
#define _TMDS_SWITCH_CBUS                       1
#define _TMDS_SWITCH_HPD                        0

#define SET_D1_TMDS_SWITCH(x)                   (bD1_TMDS_SWITCH = x)

#define bD1_MHL_VBUS_SWITCH                     (MCU_PORT67_PIN_REG_FFCE)
#define _MHL_VBUS_ON                            1
#define _MHL_VBUS_OFF                           0

#define SET_D1_MHL_VBUS_SWITCH(x)               (bD1_MHL_VBUS_SWITCH = x)
...
// Macro of LED On/Off
//--------------------------------------------------
// Pin 98 and Pin 100 are used by QC eLED Test.
/*
#define bLED1                                   (MCU_PORT54_PIN_REG_FFC3) // Pin 98, P5.4
#define bLED2                                   (MCU_PORT56_PIN_REG_FFC5) // Pin 100, P5.6
*/

sbit bLED1                                      = P1 ^ 6; // Pin 60, P1.6
sbit bLED2                                      = P1 ^ 7; // Pin 61, P1.7
sbit bLED3                                      = P3 ^ 0; // Pin 62, P3.0
sbit bLED4                                      = P3 ^ 1; // Pin 63, P3.1
#define bLED5                                   (MCU_PORTC3_PIN_REG_FFA0) // Pin 64, PC.3
...
#define AD_KEY1                                 (MCU_ADC2_RESULT_FF0B) // Pin 48, PB.2
#define AD_KEY2                                 (MCU_ADC1_RESULT_FF0A) // Pin 49, PB.3
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_PORT52_PIN_REG_FFC1) // Pin 96, P5.2
...
#define bBACKLIGHTPOWER                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin 100, P5.6
...
#define bBACKLIGHTPOWER                         (MCU_PORT61_PIN_REG_FFC8) // Pin 88 P5.6
...
#endif // End of #if(_PCB_TYPE == _RL6269_QA_1A1MHL1DP)
