...
#if(_PANEL_TYPE == _FOX_SEC_LTM215HL01)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DV_TOTAL_MAX                     1206                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  180//176               // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  113                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      40                  // Panel Power On T1 (ms)//Eli 20120810 modify power sequence issue.
