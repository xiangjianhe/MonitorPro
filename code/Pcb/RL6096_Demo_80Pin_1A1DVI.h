...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6096_Demo_80Pin_1A1DVI.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6096_DEMO_80PIN_1A1DVI)
...
#define _PCB_SYS_EEPROM_IIC                     _HW_IIC_80PIN_PIN_32_33
...
// VGA Cable Detect
#define _80PIN_PIN_22                           (0 & 0x03) // Page 10-0xB8[1:0]
// 0 ~ 3 (0: PDD0i<I>, 1: PDD0o<PP>, 2: PDD0o<OD>, 3: Reserved)

// DVI Cable Detect
#define _80PIN_PIN_23                           (0 & 0x03) // Page 10-0xB9[1:0]
// 0 ~ 3 (0: PCD4i<I>, 1: PCD4o<PP>, 2: PCD4o<OD>, 3: Reserved)

// EDID WP
#define _80PIN_PIN_24                           (1 & 0x03) // Page 10-0xA0[7:6]
// 0 ~ 3 (0: PBD7i<I>, 1: PBD7o<OD>, 2: PBD7o<PP>, 3: TCON5<O>)

// bLED3
#define _80PIN_PIN_25                           (0 & 0x03) // Page 10-0xA0[5:4]
// 0 ~ 3 (0: PBD6i<I>, 1: PBD6o<OD>, 2: PBD6o<PP>, 3: IICSCL<OD>)

// bLED2
#define _80PIN_PIN_26                           (1 & 0x03) // Page 10-0xA0[3:2]
// 0 ~ 3 (0: PBD5i<I>, 1: PBD5o<OD>, 2: PBD5o<PP>, 3: IICSDA<OD>)

// bLED1
#define _80PIN_PIN_27                           (1 & 0x03) // Page 10-0xA7[7:6]
// 0 ~ 3 (0: PBD0i<I>, 1: PBD0o<OD>, 2: PBD0o<PP>, 3: PWM0<PP>)

// KEY1
#define _80PIN_PIN_28                           (3 & 0x03) // Page 10-0xA3[5:4]
// 0 ~ 3 (0: P6D1i<I>, 1: P6D1o<OD>, 2: P6D1o<PP>, 3: ADCA1<I>)

// KEY0
#define _80PIN_PIN_29                           (3 & 0x03) // Page 10-0xA4[7:6]
// 0 ~ 3 (0: P6D2i<I>, 1: P6D2o<OD>, 2: P6D2o<PP>, 3: ADCA2<I>)

// 5V Detect
#define _80PIN_PIN_30                           (0 & 0x03) // Page 10-0xA5[7:6]
// 0 ~ 3 (0: P6D3i<I>, 1: P6D3o<OD>, 2: P6D3o<PP>, 3: ADCA3<I>)

// SYSTEM_EEPROM_WP
#define _80PIN_PIN_31                           (1 & 0x07) // Page 10-0xA6[5:3]
// 0 ~ 7 (0: P6D5i<I>, 1: P6D5o<OD>, 2: P6D5o<PP>, 3: PWM1<OD>, 4: PWM1<PP>, 
//        5: PWM5<PP>, 6: TCON0<O>, 7: TCON5<O>)

// EESCL
#define _80PIN_PIN_32                           (6 & 0x07) // Page 10-0xAF[6:4]
// 0 ~ 5 (0: P6D6i<I>, 1: P6D6o<OD>, 2: P6D6o<PP>, 3: Reserved, 4: TCON1<O>, 
//        5: TCON4<O>, 6: IICSCL<OD>)

// EESDA
#define _80PIN_PIN_33                           (6 & 0x07) // Page 10-0xAF[3:1]
// 0 ~ 5 (0: P6D7i<I>, 1: P6D7o<OD>, 2: P6D7o<PP>, 3: Reserved, 4: TCON9<O>, 
//        5: TCON11<O>, 6: IICSDA<OD>)
// IIC function needs to be selected for both pins (32 & 33)

// DDCSCL1
#define _80PIN_PIN_34                           (6 & 0x07) // Page 10-0xA2[6:4]
// 0 ~ 5 (0: P3D0i<I>, 1: P3D0o<OD>, 2: P3D0o<PP>, 3: RXD<OD>, 4: TCON7<O>, 
//        5: TCON10<O>, 6: DDCSCL1<OD>)

// DDCSDA1
#define _80PIN_PIN_35                           (6 & 0x07) // Page-10-0xA2[3:1]
// 0 ~ 5 (0: P3D1i<I>, 1: P3D1o<OD>, 2: P3D1o<PP>, 3: TXD<OD>, 4: TCON3<O>, 
//        5: TCON5<O>, 6: DDCSDA1<OD>)
// DDC1 function needs to be selected for both pins (34 & 35)

// When Page 10-0xA2[0] = 1 && Pin 31 = 1, Disable ddc function of Pin 34, Pin 35
// and swap to Pin 29, Pin 30
#define _80PIN_PIN_34_35_DDC1_to_29_30          (0 & 0x01) // Page 10-0xA2[0]
// 0 ~ 1 (0: Disable, 1: Enable)

// NC
#define _80PIN_PIN_39                           (2 & 0x07) // Page 10-0xA6[2:0]
// 0 ~ 7 (0: PCD3i<I>, 1: PCD3o<OD>, 2: PCD3o<PP>, 3: PWM2<PP> , 4: TCON1<O>, 
//        5: TCON8<O>, 6: PWM2<OD>, 7: INT0<I>)

// Panel On
#define _80PIN_PIN_40                           (1 & 0x0F) // Page 10-0xA3[3:0]
...
#define _80PIN_PIN_41_42_43_44_45_46_47_48      (0 & 0x03) // Page 10-0xA9[7:6]
...
#define PCB_GPIO_SETTING_POWER_NORMAL()         {\
                                                    ScalerSetBit(P10_BD_PIN_PULLUP_CTRL5, ~_BIT7, _BIT7); \
                                                    ScalerSetBit(P10_BE_PIN_PULLUP_CTRL6, ~_BIT7, _BIT7); \
                                                }
...
//-----------------------------------------------
#define bFLASH_WRITE_PROTECT                    (MCU_PORT81_PIN_REG_FFD7)   // Pin 62 P8.1
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT65_PIN_REG_FFCC)  // Pin 31, P6.5
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORT_PB7_PIN_REG_FF7F)    // Pin 24, PB.7
...
//-----------------------------------------------
#define bA0_CONNECT                             (MCU_PORT_PD0_PIN_REG_FF7E) // Pin 22, PD.0
#define bD1_CONNECT                             (MCU_PORTC4_PIN_REG_FFA4) // Pin 23, PC.4
...
//-----------------------------------------------
sbit bD1_HPD                                    = P3 ^ 5; // Pin 65, P3.5 for DVI hot plug
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_PORT_PB0_PIN_REG_FF8F) // Pin 27, PB.0
#define bLED2                                   (MCU_PORT_PB5_PIN_REG_FF8A) // Pin 26, PB.5
...
//--------------------------------------------------
sbit bPANELPOWER                                = P1 ^ 0;   //  Pin 40, P1.0
...
//--------------------------------------------------
sbit bBACKLIGHTPOWER                            = P3 ^ 6; // Pin 66, P3.6
...
#endif // End of #if(_PCB_TYPE == _RL6096_DEMO_80PIN_1A1DVI)
