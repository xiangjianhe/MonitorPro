...
#if(_PANEL_TYPE == _TPV_SEC_LTM220MT09)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DV_TOTAL_MAX                     1100                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  151                 // Maxinum Pixel Clock in MHz
...
#endif // End of #if(_PANEL_TYPE == _TPV_SEC_LTM220MT09)
