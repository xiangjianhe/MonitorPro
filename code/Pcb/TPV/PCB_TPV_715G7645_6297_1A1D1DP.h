...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6297_Demo_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _PCB_TPV_715G7645_6297_1A1D1DP)
...
#else
#define _D1_TMDS_BR_SWAP                        _ON//_OFF
#define _D1_TMDS_PN_SWAP                        _ON//_OFF
#endif
...
// VGA CABLE DETECT
#define _PIN_64                                 (0 & 0x1F) // Page 10-0xA3[3:0]
...
// DDC WP  Pin
#define _PIN_100                                (2 & 0x1F) // Page 10-0xA9[2:0]
...
// BACKLIGHT ON
#define _PIN_101                                (2 & 0x0F) // Page 10-0xAB[4:3]
...
// PS EN
#define _PIN_105                                (2 & 0x0F) // Page 10-0xAA[2:0]
...
//-----------------------------------------------
#define bUSB_PS_ENABLE                          (MCU_EMPTY_PIN_ASSIGN_ADDRESS)   
...
#define PCB_GET_USB_POWER() 					(MCU_EMPTY_PIN_ASSIGN_ADDRESS)
...
//-----------------------------------------------
// Macro of DP VDD High/Low
//-----------------------------------------------
#define bDPVDD                         			(MCU_PORT80_PIN_REG_FFD6)   // Pin 105, P8.0     //ada.chen 20150429_1

#define _DP_VDD_ON                       		1      
#define _DP_VDD_OFF                      		0       

#define PCB_DP_POWER(x)                        	{\
													bDPVDD = (x);		\
                                                }
