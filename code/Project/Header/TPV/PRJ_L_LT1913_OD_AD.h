...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PRJ_L_LT1913_OD_AD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LT1913_OD_AD)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                              _PCB_TPV_715G4032_6229_AD


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM190E0A
#define _PANEL_POW_SEQ_FAST_MODE                                _OFF    //20130328 Abel Modify    
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT1913_OD_AD.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 1F 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
//20130429 Abel Spread Spectrum Modify
#define _DCLK_SPREAD_RANGE                                     8 //10    // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           770//760   // Unit in 0.1 HZ
...
//--------------------------------------------------
//20130426 Abel Digital Filter Modify
#define _DIG_FILTER_PHASE_THD                                   4//6 //effective:0~7
...
#define _FW_RELEASE_DATE                                        _2,_0,_1,_3,_0,_1,_0,_2
...
#endif // End of #if(_PROJECT == _PRJ_L_LT1913_OD_AD)
