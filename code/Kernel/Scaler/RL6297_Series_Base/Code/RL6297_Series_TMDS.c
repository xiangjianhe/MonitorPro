...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6297_Series_TMDS.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6297_SERIES_TMDS__
...
void ScalerTmdsSetPhy_EXINT0(void) using 1
{
    ...
    ScalerSetBit_EXINT0(PB_A4_CDR_2, ~(_BIT4 | _BIT3), _BIT4);
    ...
    if(GET_INPUT_PIXEL_CLK() > 1000) // High Freq.
    {
        ...
        // Enable the LE, Vth-adjust, tap0~2, Servo Loop Adaptation Loop  E7
    ...
    else if(GET_INPUT_PIXEL_CLK() > 450)
    {
        ...
        // Enable the Vth-adjust, tap0~1, Servo Loop adaptation loop  63
    ...
    if(GET_INPUT_PIXEL_CLK() > 1000)
    {
        ...
        if(ucTemp == 0xFF)
        {
            ...
            // [4:3] Enable Stage1/2 High Boost Mode
            ScalerSetBit_EXINT0(PB_A4_CDR_2, ~(_BIT4 | _BIT3), (_BIT4 | _BIT3));
...
bit ScalerTmdsCheckCDRStable(WORD usClkCount)
{
    ...
    ucVth = (ScalerGetByte(P1D_F1_COEF_2) & (_BIT3 | _BIT2 | _BIT1 | _BIT0));

    ScalerSetByte(P1D_F0_COEF_1, 0x01);
    ucTap0 = (ScalerGetByte(P1D_F1_COEF_2) & (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    ...
    // Read L1
    ScalerSetByte(P1D_F0_COEF_1, 0x40);
    ucVth = (ScalerGetByte(P1D_F1_COEF_2) & (_BIT3 | _BIT2 | _BIT1 | _BIT0)) ;

    ScalerSetByte(P1D_F0_COEF_1, 0x41);
    ucTap0 = (ScalerGetByte(P1D_F1_COEF_2) & (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    ...
    // Read L2
    ScalerSetByte(P1D_F0_COEF_1, 0x80);
    ucVth = (ScalerGetByte(P1D_F1_COEF_2) & (_BIT3 | _BIT2 | _BIT1 | _BIT0)) ;

    ScalerSetByte(P1D_F0_COEF_1, 0x81);
    ucTap0 = (ScalerGetByte(P1D_F1_COEF_2) & (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
