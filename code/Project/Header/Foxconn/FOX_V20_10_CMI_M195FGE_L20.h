...
#if(_PROJECT == _FOX_V20_10_CMI_M195FGE_L20)
...
#define _CAPABILITIES_STRING_VGA 								"(port(monitor)type(LCD)model(LEN V20-10)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 AC AE B2 B6 C6 C8 C9 CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF FF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
#define _FACTORY_PANNEL_NAME							_C,_M,_I,_SPACE,_M,_1,_9,_5,_F,_G,_E,_L,_2,_0
...
#define _MICROCODE                                      _bL_,_bM_, _b1_, _DOT, _b0_
//Facory Command
