...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6336_Series_AutoFunc.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6336_SERIES_AUTOFUNC__
...
EnumAutoResult ScalerAutoAblMeasure(void)
{
    ...
    ScalerSetBit(P0_EC_ABL_R_NOISE_VALUE, ~_BIT3, _BIT3);
    ...
    ScalerSetBit(P0_EC_ABL_R_NOISE_VALUE, ~_BIT3, 0x00);    
