...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_CMI_M195FGE_L20 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN E2013W)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LEN E2013W)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//--------------------------------------------------
#define _CHECKSUM                                       0x8a
#define _VERSION_CODE                                   0xaf

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _E,_2,_0,_1,_3,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_C,_M,_I,_SPACE,_M,_1,_9,_5,_F,_G,_E
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_1,_D,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_6,_1,_6
#define _FW_VERSION                                     _L,_M, _3, _DOT, _1
#define _DDCCI_FIRMWARE_VERSION							0x0301 

//User OSD
#define _MODEL_NAME                                     _bE_, _2_, _0_, _1_, _3_, ___,_bW_,_bi_,_bd_,_be_
#define _MICROCODE                                      _bL_,_bM_, _3_, _DOT, _1_
//Facory Command
