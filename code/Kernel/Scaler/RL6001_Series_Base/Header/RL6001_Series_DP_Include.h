...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Series_DP_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define GET_DP_PHY_CTS_FLG()                        (bit)ScalerGetBit(PB_A0_DP_CDR_00, _BIT7)
#define SET_DP_PHY_CTS_FLG()                        ScalerSetBit(PB_A0_DP_CDR_00, ~_BIT7, _BIT7)
#define CLR_DP_PHY_CTS_FLG()                        ScalerSetBit(PB_A0_DP_CDR_00, ~_BIT7, 0x00)
...
#endif // End of #ifndef __RL6001_SERIES_DP__
