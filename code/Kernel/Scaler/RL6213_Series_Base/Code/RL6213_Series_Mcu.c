...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6213_Series_Mcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6213_SERIES_MCU__
...
void ScalerMcuDdcInitial(void)
{
    ...
    ScalerSetBit(P10_A6_PIN_SHARE_CTRL06, ~_BIT0, _BIT0);

    // DDC2 set to Low Leak Mode
    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~_BIT5, _BIT5);

    // DDC3 set to Low Leak Mode
    ScalerSetBit(P10_AB_PIN_SHARE_CTRL0B, ~_BIT5, _BIT5);
