...
#ifdef _SUPPORT_PC99 
#define FC_DDCSRAMWRITE_ENABLE()    {\
                                    MCU_ADC_DDC_ENA_FF1B |= _BIT2;  \ 
                                    }
#define FC_DDCSRAMWRITE_DISABLE()   {\
                                    MCU_ADC_DDC_ENA_FF1B &= ~_BIT2;  \ 
                                    }
#endif
...
#if(_FLASH_ACCESS_FUNCTION_SUPPORT == _OFF)
//#define EDID_ERASE()            ;
#define VGAEDID_WRITE()         {\
                                }
#define DVIEDID_WRITE()         {\
                                }
#define HDMIEDID_WRITE()        {\
                                }
//-------------------------------------------------
#define VGAEDID_READ()          {\
                                }
...
#define HDMIEDID_READ()         {\
                                }
#else
//#define EDID_ERASE()	        UserCommonFlashErasePage(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,_DPEDID_PAGE);
/*
#define VGAEDID_WRITE()         {\
                                UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_VGAEDID_PAGE) * _FLASH_PAGE_SIZE+_VGAEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
                                }
*/
#define VGAEDID_WRITE()         {\
                                UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_VGAEDID_PAGE) * _FLASH_PAGE_SIZE+_VGAEDID_OFFSET, _EMBEDDED_DDCRAM_A0_SIZE, MCU_DDCRAM_A0);\
                                }
#define DVIEDID_WRITE()         {\
                                UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_DVIEDID_PAGE) * _FLASH_PAGE_SIZE+_DVIEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
                                }
#define HDMIEDID_WRITE()        {\
                                UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_HDMIEDID_PAGE) * _FLASH_PAGE_SIZE+_HDMIEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
                                }
//-------------------------------------------------
/*
#define VGAEDID_READ()          {\
                                UserCommonFlashRead(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_VGAEDID_PAGE) * _FLASH_PAGE_SIZE+_VGAEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
                                }
*/
#define VGAEDID_READ()          {\
...
#define DVIEDID_READ()          {\
                                UserCommonFlashRead(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_DVIEDID_PAGE) * _FLASH_PAGE_SIZE+_DVIEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
                                }
#define HDMIEDID_READ()         {\
                                UserCommonFlashRead(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_HDMIEDID_PAGE) * _FLASH_PAGE_SIZE+_HDMIEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
                                }
#endif
//DFM rev07 patch note 3 <<
