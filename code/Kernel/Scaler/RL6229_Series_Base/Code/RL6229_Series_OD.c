...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_OD.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6229_SERIES_OD__
...
void ScalerODControl(bit bOn)
{
    if((bOn == _ON) && (GET_OD_USE_BIT() != _OFF))
    {
        ...
        // FRC On + 3D PR Case
        if(((GET_3D_INPUT_FORMAT() != _NO_3D_FORMAT) && (GET_3D_INPUT_FORMAT() != _FRAME_PACKING)) ||
            ((GET_3D_INPUT_FORMAT() == _FRAME_PACKING) && (GET_3D_OUTPUT_SEQUENCE() != _3D_DISPLAY_2D)) ||
            ((GET_3D_INPUT_FORMAT() == _NO_3D_FORMAT) && ((GET_MEMORY_DVF_SELECT() == _3_IVF) || (GET_MEMORY_DVF_SELECT() == _2_5_IVF) || (GET_MEMORY_DVF_SELECT() == _2_IVF))))
        ...
        if((GET_3D_INPUT_FORMAT() == _NO_3D_FORMAT) && ((GET_MEMORY_DVF_SELECT() == _3_IVF) || (GET_MEMORY_DVF_SELECT() == _2_5_IVF) || (GET_MEMORY_DVF_SELECT() == _2_IVF)))
#endif
        {
...
#else // Else of #if((_FRC_SUPPORT == _ON) || (_3D_SUPPORT == _ON))
...
WORD ScalerODCalculateMemoryUseSpace(BYTE ucODbit)
{
    ...
    PDATA_WORD(0) = ((((DWORD)CEILING(_PANEL_DH_WIDTH, _OD_PIXEL_PER_COMP)) * _PANEL_DV_HEIGHT * ucODbit / _MEMORY_BIT_NUM) /
    ...
    if(GET_3D_INPUT_FORMAT() != _NO_3D_FORMAT)
    {
        if((((GET_MEMORY_DVF_SELECT() == _3_IVF) || (GET_MEMORY_DVF_SELECT() == _2_5_IVF)) &&
             ((GET_3D_INPUT_FORMAT() != _SIDE_BY_SIDE_HALF) && (GET_3D_INPUT_FORMAT() != _LINE_INTERLACE))) ||
           ((GET_3D_INPUT_FORMAT() == _FRAME_SEQUENTIAL) && (GET_3D_OUTPUT_SEQUENCE() != _3D_DISPLAY_2D)))
        {
#if(_ASPECT_ORIGINAL_MODE_SUPPORT == _ON)
            if((GET_ASPECT_ORIGIN_MODE() == _FALSE) ||
                ((GET_ASPECT_ORIGIN_MODE() == _TRUE) && (g_stMDomainOutputData.usVHeight == _PANEL_DV_HEIGHT)))
#endif
            {
                // 3D 24Hz + OD use 3 block toggle.
                // OD used size is 0 under this condition.
                PDATA_WORD(0) = 0;
            }
        }
    }
    ...
    DebugMessageFRC("OD_SIZE", PDATA_WORD(0));
...
void ScalerODIntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT0(CM_08_NEW_ADDED_STATUS1, (_BIT3| _BIT2)) == (_BIT3| _BIT2))
    {
        ...
        if((GET_MEMORY_DVF_SELECT() == _3_IVF) ||
           ...
           (GET_3D_INPUT_FORMAT() == _FRAME_SEQUENTIAL) ||
...
#if(_3D_SUPPORT == _ON)
            if((g_ucODAddrChangeCount == 3) && (GET_3D_INPUT_FORMAT() != _FRAME_SEQUENTIAL))
#elif((_FRC_SUPPORT == _ON) || (_3D_SUPPORT == _OFF))
