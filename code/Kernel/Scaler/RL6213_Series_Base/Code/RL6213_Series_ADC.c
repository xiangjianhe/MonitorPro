...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6213_Series_ADC.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6213_SERIES_ADC__
...
#warning "Not Apply the Solution in RL6213 Series!!"
#endif
...
void ScalerADCBandWidthSetting(DWORD ulAdcClock)
{
    ...
    {
        // 75MHz
        ScalerSetBit(P0_CE_ADC_CTL_RGB, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);                    
    }
    ...
    {
        // 300MHz
        ScalerSetBit(P0_CE_ADC_CTL_RGB, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));          
    }
...
{
    // With PGA
    ScalerSetBit(P0_D9_TEST_PTN_VPOS_L, ~_BIT7, _BIT7);
}
