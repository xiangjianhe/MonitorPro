...
#if(_PROJECT == _PRJ_L_LT1913_DEMO)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6096_DEMO_1A1DVI


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM190E09
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT1913pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT1913pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT1913pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   0x77
#define _CT7200_LenovoPrj_GREEN                                 0x77
#define _CT7200_LenovoPrj_BLUE                                  0x80

#define _CTSRGB_LenovoPrj_RED                                   0x7c
#define _CTSRGB_LenovoPrj_GREEN                                 0x7c
#define _CTSRGB_LenovoPrj_BLUE                                  0x80

#define _CT6500_LenovoPrj_RED                                   0x7c
#define _CT6500_LenovoPrj_GREEN                                 0x7c
#define _CT6500_LenovoPrj_BLUE                                  0x80

#define _CT9300_LenovoPrj_RED                                   0x67
#define _CT9300_LenovoPrj_GREEN                                 0x6c
