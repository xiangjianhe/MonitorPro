...
void ScalerOsdWindowPriority(EnumOsdWindowsType enumOsdWindowsType, EnumOsdWindowPriorityType enumOsdWindowPriorityType)
{
    ...
    if((enumOsdWindowsType == _OSD_WINDOW_3) || (enumOsdWindowsType == _OSD_WINDOW_4))
    {
        ucTemp = ScalerOsdFrameControlByteGet(0x002, _OSD_BYTE1);
    }
    else if((enumOsdWindowsType == _OSD_WINDOW_2) || (enumOsdWindowsType == _OSD_WINDOW_8) || (enumOsdWindowsType == _OSD_WINDOW_9))
    {
    ...
    {
        ScalerOsdFrameControlByte(0x002, _OSD_BYTE2, ((ucTemp & ~_BIT7) | (BYTE)enumOsdWindowPriorityType << 7));
    }
    else if(enumOsdWindowsType == _OSD_WINDOW_3)
    {
        ScalerOsdFrameControlByte(0x002, _OSD_BYTE1, ((ucTemp & ~_BIT0) | (BYTE)enumOsdWindowPriorityType));
    }
    else if(enumOsdWindowsType == _OSD_WINDOW_4)
    {
        ScalerOsdFrameControlByte(0x002, _OSD_BYTE1, ((ucTemp & ~_BIT1) | (BYTE)enumOsdWindowPriorityType << 1));
    }
