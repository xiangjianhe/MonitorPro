...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_Series_Mcu_Interface.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
//****************************************************************************
...
// Macros of DDC-CI
//--------------------------------------------------
#define GET_DDCCI_AUTO_SWITCH()                         ((bit)(MCU_I2C_IRQ_CTRL2_FF2A & _BIT4))
#define SET_DDCCI_AUTO_SWITCH()                         (MCU_I2C_IRQ_CTRL2_FF2A |= _BIT4)
#define CLR_DDCCI_AUTO_SWITCH()                         (MCU_I2C_IRQ_CTRL2_FF2A &= ~_BIT4)
