...
#if(_PANEL_TYPE == _FOX_CMI_M200HJJ)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         2100//2200                // Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_POWER_ON_T3                      500                 // Panel Power On T3 (ms)//Eli 20120522 modify T3-T4

#define _PANEL_POWER_OFF_T4                     150                 // Panel Power Off T4 (ms)//Eli 20120522 modify T3-T4
#define _PANEL_POWER_OFF_T5                     35//50                   // Panel Power Off T5 (ms)
...
#endif // End of #if(_PANEL_TYPE == _FOX_CMI_M215HGE_L21)
