...
/********************************************************************************/
#if(_PANEL_TYPE == _TPV_TPV_TPM190A1_MWW4)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_MIN_FRAME_RATE                   540
...
#define _PANEL_DH_TOTAL_MIN                     1540                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MIN                     918                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      88                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  134                // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  84                 // Mininum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T5                     50                  // Panel Power Off T5 (ms) CMI_spec:0<T3<50ms
