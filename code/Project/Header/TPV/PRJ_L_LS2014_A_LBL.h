...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PRJ_L_LS2014_A.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LS2014_A_LBL)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_AUO_M195RTN01_0//_CMO_LVDS_19_WXGA
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LS2014_A.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LS2014WA)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LS2014WA)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LS2014WA)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME                                             _bL_, _bS_, _b2_, _b0_, _b1_, _b4_, _8P_, _bW_, _bi_, _bd_, _be_
#define _MICROCODE                                              _bL_,_bA_, _b0_, _DOT, _b3_

#define _FACTORY_PROJECT_NAME                                   _L,_S,_2,_0,_1,_4,_W,_i,_d,_e
#define _FW_RELEASE_DATE                                        _2,_0,_1,_5,_0,_8,_2,_0
#define _FW_VERSION                                             _L,_A,_0,_DOT,_3
...
#define _LBL_BRIGHTNESS_DEF                             		25

#define _OSD_LBL_H_POS                                  		897
...
#define _CT6500_LenovoPrj_BLUE                                  125
