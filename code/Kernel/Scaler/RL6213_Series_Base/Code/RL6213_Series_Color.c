...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6213_Series_Color.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6213_SERIES_COLOR__
...
BYTE code tCOLOR_CONV_YUV2RGB_ITU601[] =
{
    ...
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x08, 0xa8,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x10, 0x06,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x18, 0x62,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x20, 0x01,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x28, 0x91,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x30, 0x03,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x38, 0x40,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x40, 0x08,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x48, 0x12,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x50, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x58, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x60, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x68, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x70, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x78, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x80, 0x02,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x88, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x90, 0x02,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x98, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0xA0, 0x02,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0xA8, 0x00,
...
BYTE code tCOLOR_CONV_YUV2RGB_ITU709[] =
{
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x00, 0x04,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x08, 0xa8,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x10, 0x07,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x18, 0x2c,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x20, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x28, 0xda,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x30, 0x02,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x38, 0x22,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x40, 0x08,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x48, 0x73,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x50, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x58, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x60, 0x00,
    5,  _AUTOINC,       CM_9D_YUV_RGB_ACCESS,         0x68, 0x00,
...
void ScalerColorSpaceConvert(EnumColorSpace enumColorFormat)
{
    if((enumColorFormat == _COLOR_SPACE_YCBCR422) || (enumColorFormat == _COLOR_SPACE_YCBCR444) || (enumColorFormat == _COLOR_SPACE_YPBPR))
    {
        ...
        // Enable YUV Clamp
        ScalerSetBit(CM_9D_YUV_RGB_ACCESS, ~(_BIT2 | _BIT1), (_BIT2 | _BIT1));
        
        // Enable YUV2RGB conversion and disable coefficient access
        ScalerSetBit(CM_9C_YUV2RGB_CTRL, ~(_BIT1 | _BIT0), _BIT0);
    }
    else if(enumColorFormat == _COLOR_SPACE_RGB)
    {
        ...
        // Disable YUV Clamp
        ScalerSetBit(CM_9D_YUV_RGB_ACCESS, ~(_BIT2 | _BIT1), 0x00);
        
        // Disable YUV2RGB conversion and disable coefficient access
        ScalerSetBit(CM_9C_YUV2RGB_CTRL, ~(_BIT1 | _BIT0), 0x00);        
    }
}
...
void ScalerColorDDitherAdjust(BYTE *pDitherTable, BYTE *pDitherSeqTable, BYTE *pDitherTempoffsetTable, BYTE *pThresholdTable, BYTE ucBankNum)
{
    ...
    ScalerSetBit(CM_6B_DITHERING_CTRL2, 0x00, (_D_DITHER_THRESHOLD_EN << 2) | _BIT0);
