...
#if(_PCB_TYPE == _RL6096_FOXCONN_LEN_LT2223S_PCB)
...
//--------------------------------------------------
#if(_PROJECT == _FOX_E2013W_CMI_M195FGE_L20)
#define _LVDS_DATA_DRIV_CONTROL                 _LVDS_DRIV_CONTROL_3_0
#elif(_PROJECT == _FOX_LI2241W_AUO_M215HTN01_1)
...
// NC Pin
#define _PIN_41                                 (1 & 0x03) // Page 10-0xA0[7:6]
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT65_PIN_REG_FFCC)
