...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_Series_PLL.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6192_SERIES_PLL__
...
//--------------------------------------------------
#define _DPLL_BOUNDRY_0                              25000
#define _DPLL_BOUNDRY_1                              33750
#define _DPLL_BOUNDRY_2                              50000
#define _DPLL_BOUNDRY_3                              67500
#define _DPLL_BOUNDRY_4                             100000
#define _DPLL_BOUNDRY_5                             135000
#define _DPLL_BOUNDRY_6                             200000
...
void ScalerPllSetDpllFreq(DWORD ulFreq)
{
    ...
    // Check DPLL power on && VCO band and div_o are the same with before setting
    if((ScalerGetBit(P1_C2_DPLL_WD, _BIT0) == 0x00) &&
        ((pData[15] & 0x03) == (ScalerGetByte(P1_D4_DPLL_RESULT) & 0x03)) && 
        ((pData[15] & 0x30) == (ScalerGetByte(P1_C0_DPLL_N) & 0x30)))
    {
