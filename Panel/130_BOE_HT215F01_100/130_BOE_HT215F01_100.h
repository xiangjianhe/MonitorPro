...
#if(_PANEL_TYPE == _TPV_BOE_HT215F01_100)
//----------------------------------------------------------------------------------------------------
...
// Panel Name Define
//--------------------------------------------------
#define _PANEL_NAME                              _H,_T,_2,_1,_5,_F,_0,_1,_MINUS,_1,_0,_0,
...
//--------------------------------------------------
#define _PANEL_NORMALLY_STATUS                _PANEL_NORMALLY_WHITE      //check
...
#define _PANEL_DH_TOTAL_MIN                     2104                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         1126                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1251                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  196                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  112                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      15                  // Panel Power On T1 (ms)//Eli 20120810 modify power sequence issue.
#define _PANEL_POWER_ON_T2                      15                  // Panel Power On T2 (ms)
