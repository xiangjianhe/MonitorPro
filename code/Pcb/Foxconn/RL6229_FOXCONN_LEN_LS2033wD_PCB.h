...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Demo_76Pin_1A1H.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6229_FOXCONN_LEN_LS2033wD_PCB)
...
// 
#define _76PIN_PIN_37                                 (0 & 0x0F) // Page 10-0xD8[3:0]
...
// Panel On 
#define _76PIN_PIN_38                                 (1 & 0x1F) // Page 10-0xD9[4:0]
...
//DVI
#define bSWIIC_D1_EDID_EEPROM_SCL               (MCU_PORT73_PIN_REG_FFD2) // Pin 70, P7.3
#define bSWIIC_D1_EDID_EEPROM_SDA               (MCU_PORT72_PIN_REG_FFD1) // Pin 71, P7.2
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT65_PIN_REG_FFCC)  // Pin 30, P6.5
...
#define bEDID_WRITE_PROTECT                     (MCU_PORT_PB7_PIN_REG_FF7F)    // Pin 23, PB.7
...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1                                      = P3 ^ 5;// Pin 61, P3.5
sbit bLED2                                      = P3 ^ 4;// Pin 60, P3.4
...
#define AD_KEY1                                 (MCU_ADC1_RESULT_FF0A)//Pin 28
#define AD_KEY2                                 (MCU_ADC2_RESULT_FF0B)//Pin 29
sbit bPOWER_KEY									= P3 ^ 3;//Pin 59 P3.3
...
#endif // End of #if(_PCB_TYPE == _RL6297_DEMO_76PIN_1A1H)
