...
#if(_PANEL_TYPE == _TPV_BOE_MV195WGM_N10)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         1920                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2100                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1400                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     920                 // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MIN                  91                  // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      5                  // Panel Power On T1 (ms)//Eli 20120810 modify power sequence issue.
#define _PANEL_POWER_ON_T2                      30                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      250                 // Panel Power On T3 (ms)//Eli 20120522 modify T3-T4

#define _PANEL_POWER_OFF_T4                     250                 // Panel Power Off T4 (ms)//Eli 20120522 modify T3-T4
#define _PANEL_POWER_OFF_T5                     20                   // Panel Power Off T5 (ms)
#define _PANEL_POWER_OFF_T6                     1150                // Panel Power Off T6 (ms)


//----------------------------------------------------------------------------------------------------
// Color Temp Default Value
//----------------------------------------------------------------------------------------------------
//20130723 Abel Move Color Temp to RLxxxPrj.h
