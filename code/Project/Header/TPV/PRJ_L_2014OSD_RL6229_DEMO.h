...
#if(_PROJECT == _PRJ_L_2014OSD_RL6229_DEMO)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6229_DEMO_1A1DVI1DP//_RL6229_DEMO_1A1DVI1H
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 04 05 06 08 0B) 16 18 1A 1E 1F 20 30 3E 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME												_D_, _E_, _M_, _O_
#define _MICROCODE												_L_,_G_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _D,_E,_M,_O
#define _FW_RELEASE_DATE                                        _2,_0,_1,_2,_1,_2,_1,_0
...
#define _NAVIGATE_ICON_LEFT_COL_POSITION						7
#define _NAVIGATE_ICON_RIGHT_COL_POSITION						11
#define _NAVIGATE_ICON_ENTER_COL_POSITION						15
#define _NAVIGATE_ICON_POWER_COL_POSITION						19
#define _AFTER_NAVIGATE_ICON_POWER_COL_POSITION                 22 

#define _TEXT_BLANK1_PIXEL                                      10
#define _TEXT_BLANK2_PIXEL                                      20
#define _NAVIGATE_TEXT_EXIT_COL_POSITION						4
#define _NAVIGATE_TEXT_ENTER_COL_POSITION						15
#define _AFTER_NAVIGATE_TEXT_ENTER_COL_POSITION                 26 
...
#endif // End of #if(_PROJECT == _PRJ_L_2014OSD_RL6229_DEMO)
