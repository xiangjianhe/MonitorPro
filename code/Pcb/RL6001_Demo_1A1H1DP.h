...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Demo_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6001_DEMO_1A1H1DP)
...
#define PCB_GPIO_SETTING_POWER_DOWN()           {\
                                                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~_BIT4, 0x00);     \
                                                    ScalerSetBit(P10_B5_PIN_DRIVING_CTRL3, ~_BIT0, _BIT0); \
                                                    ScalerSetByte(P10_BB_PIN_PULLUP_CTRL4, 0xFF); \
                                                }
...
//-----------------------------------------------
sbit bD0_HPD                                    = P3 ^ 4; // Pin 111, P3.4 for HDMI
...
#endif // End of #if(_PCB_TYPE == _RL6001_DEMO_1A1H1DP)
