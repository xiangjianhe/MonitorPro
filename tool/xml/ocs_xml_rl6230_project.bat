@echo off
set PRONAME=CVT_RL6230_PROJECT
set OUTFILE=.\Output\CVT_RL6230_PROJECT\%PRONAME%.plg
set TOOLS_PATH=..\tool\xml
set BIN_PATH_SOURCE=.\Output\CVT_RL6230_PROJECT
set BIN_PATH_DES=..\bin
set BIN_NAME=CVT_RL6230_PROJECT.bin
