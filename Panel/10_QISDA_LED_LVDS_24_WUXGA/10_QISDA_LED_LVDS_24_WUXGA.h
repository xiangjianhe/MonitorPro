...
#if(_PANEL_TYPE == _QISDA_LED_LVDS_24_WUXGA)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_ELED_STRING_NUMBER               8                   // Eled Panel String Number
#define _PANEL_ELED_STRING_CURRENT              60                  // Every Led String Current
#define _PANEL_ELED_VOUT_TYPICAL                57                  // Eled Panel Vout Typical Voltage
#define _PANEL_ELED_VOUT_MAX                    62                  // Eled Panel Vout Max Value
