...
#if(_PROJECT == _PRJ_L_T2324P_AHP_LG_LM230WF3_SLQ1)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM230WF3_SLQ1
