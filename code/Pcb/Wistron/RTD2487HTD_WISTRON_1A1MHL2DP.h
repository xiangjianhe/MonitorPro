...
#if(_PCB_TYPE == _RTD2487HTD_WISTRON_1A1MHL2DP)
...
#define _D2_INPUT_PORT_SWITCH_FROM              _SWITCH_FROM_D1
...
// ADC_Key1
#define _PIN_48                                 (2 & 0x07) // Page 10-0xAF[2:0]
// 0 ~ 6 (0: PBD2i<I>, 1: PBD2o<PP>, 2: PBD2o<OD>, 3: ADCA1(8bit)<I>, 4: TEST_PIN0<O>, 
//        5: TEST_PIN1<O>, 6: DUMMY<O>)

// ADC_Key2
#define _PIN_49                                 (2 & 0x07) // Page 10-0xB0[2:0]
...
//DP_Cable_DET
#define _PIN_119                                (0 & 0x07) // Page 10-0xDC[2:0]
...
#define bSWIIC_SYS_TOUCHKEY_SCL                 (MCU_PORT_PB2_PIN_REG_FF8D)//_PIN_48
#define bSWIIC_SYS_TOUCHKEY_SDA                 (MCU_PORT_PB1_PIN_REG_FF8E)//_PIN_49
...
#define PCB_SW_IIC_SDA_CLR()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_SYS_TOUCHKEY_SDA = _FALSE;         \
                                                    }                                          \
                                                }
...
#define PCB_SW_IIC_SCL_CLR()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_SYS_TOUCHKEY_SCL = _FALSE;         \
                                                    }                                          \
                                                }
...
#define TouchKey2Host()                         {\
                                                    SET_SW_IIC_STATUS(_IIC_SYS_TOUCHKEY);\
                                                }

#define TouchKey2Slave()                        {\
                                                    SET_SW_IIC_STATUS(_IIC_SYS_EEPROM);\
                                                }
...
sbit bDP_PIN16_CONNECT                          = P3 ^ 3; // _PIN_119 DP_Cable_DET
...
sbit bD1_CONNECT                                = P1 ^ 0; // _PIN_51 OneLink(DP) cable detect by DP_SINK_ASS_1
#define bD2_CONNECT                             ((bit)bDP_PIN16_CONNECT)
...
#define PCB_D2_PIN()                            (SET_D2_CABLE_STATUS(!bD2_CONNECT))
...
#define bD2_HPD                                 (MCU_PORT_PD7_PIN_REG_FF77) // _PIN_22
...
#define PCB_DIGITAL_SWITCH_TO_D1()              {\
                                                    PCB_SET_DP_CHA(_DP_CHA_ONELINK);                \
                                                }
...
#define _AD_KEY_SUPPORT                         _LOW_SPEED_ADC_SUPPORT 
...
//-----------------------------------------------
#define bSPK_MUTE_LED                          (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//_PIN_64
...
#define bTiny_power_ON                         (MCU_PORTC3_PIN_REG_FFA0)//_PIN_64

#define _TINY_POWER_HIGH                       1      
#define _TINY_POWER_LOW                        0     
#define PCB_SET_TINY_POWER(x)                  {\
                                                    bTiny_power_ON = x;\
                                               }

#define bTiny_power_key_LED                    (MCU_PORT63_PIN_REG_FFCA)//_PIN_90

#define _TINY_LED_ON                           1      
#define _TINY_LED_OFF                          0     
#define PCB_GET_TINY_LED()                     (bTiny_power_key_LED)
...
#define _USB_UPSTREAM_ONELINK                   0
#define _USB_UPSTREAM_P304                      1
...
// Macro of USB_CHA_SW
//-----------------------------------------------
#define bUSB_CHA_SW                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//_PIN_50   
...
#define bDP_CHA_SW                              (MCU_PORT_PB0_PIN_REG_FF8F)//_PIN_50   

#define _DP_CHA_ONELINK                         1      
#define _DP_CHA_EXTERN                          0     
#define PCB_SET_DP_CHA(x)                       {\
                                                    bDP_CHA_SW = x;\
                                                }
...
#endif // End of #if(_PCB_TYPE == _RTD2487HTD_WISTRON_1A1MHL2DP)
