...
#if(_PCB_TYPE == _RTD2487HTD_WISTRON_1A1MHL1NDP)
...
// NC
#define _PIN_26                                 (1 & 0x0F) // Page 10-0xA5[2:0]
...
// Earphone_out_DET
#define _PIN_64                                 (0 & 0x0F) // Page 10-0xBC[3:0]
...
// NC
#define _PIN_92                                 (1 & 0x0F) // Page 10-0xCC[3:0]
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_PORT67_PIN_REG_FFCE) // _PIN_94, Amber
#define bLED2                                   (MCU_PORT52_PIN_REG_FFC1) // _PIN_96, Green
...
#define AD_KEY1                                 (MCU_ADC1_RESULT_FF0A) //_PIN_48 ,
#define AD_KEY2                                 (MCU_ADC2_RESULT_FF0B) // _PIN_49, 
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((0x30 <= ucV1) && (ucV1 < 0x60))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK;     \
                                                                                                       \
                                                                if((0x70 <= ucV1) && (ucV1 < 0xB0))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
																if((0x30 <= ucV2) && (ucV2 < 0x60))	   \
                                                                    ucKeyState |= _MENU_KEY_MASK;     \
                                                                                                       \
                                                                if((0x70 <= ucV2) && (ucV2 < 0xB0))    \ 
...
#define bBACKLIGHTPOWER                         (MCU_PORT56_PIN_REG_FFC5) //_PIN_100
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
                                                        ScalerTimerActiveTimerEvent(SEC(60), _USER_TIMER_EVENT_PANEL_USED_TIMER);\
                                                        ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 10*1000); \
                                                    }\
                                                    else\
                                                    {\
                                                        ScalerTimerCancelTimerEvent(_USER_TIMER_EVENT_PANEL_USED_TIMER);\
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_PORT60_PIN_REG_FFC7) // _PIN_100, P5.6
...
//-----------------------------------------------
#define EARPHONE_DET                           (MCU_PORTC3_PIN_REG_FFA0)//_PIN_64
