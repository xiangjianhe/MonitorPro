...
#define DFM_DDC_WRITE_PORT						_DFM_A0_PORT//_DFM_D0_PORT

#define DFM_DVI1_DDC_CHANNEL				    _NO_DDC
#define DFM_DVI2_DDC_CHANNEL				    _NO_DDC
#define DFM_HDMI1_DDC_CHANNEL					_D0_DDC_CHANNEL_SEL
#define DFM_HDMI2_DDC_CHANNEL					_NO_DDC
#define DFM_DP1_DDC_CHANEL						_D1_DDC_CHANNEL_SEL
// 20120417 by jerry, (DFM rev8 patch note 1)<<
...
#define FC_GET_BRIGHTNESS()     GET_OSD_BACKLIGHT()
...
#define FC_GET_LANGUAGE()       tLANGUAGEDEFINE[GET_OSD_LANGUAGE()]
...
//--------------------------------------------------
#define DPEDID_WRITE()			{\
								UserCommonEepromWrite(_EEPROM_PAGE7_BANK0+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
								}

//--------------------------------------------------
#define DPEDID_READ()			{\
								UserCommonEepromRead(_EEPROM_PAGE7_BANK0+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
								}
#endif
//--------------------------------------------------
#if(_MHL_SUPPORT == _ON)
#define MHLEDID_ERASE()			{\
								;\
								}
//--------------------------------------------------
#define MHLEDID_WRITE()			{\
								UserCommonEepromWrite(_EEPROM_PAGE6_BANK0+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
								}
//--------------------------------------------------
#define MHL2EDID_WRITE()		{\
								UserCommonEepromWrite(_EEPROM_PAGE5_BANK0+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
								}
//--------------------------------------------------
#define MHLEDID_READ()			{\
								UserCommonEepromRead(_EEPROM_PAGE6_BANK0+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
								}
//--------------------------------------------------
#define MHL2EDID_READ()			{\
								UserCommonEepromRead(_EEPROM_PAGE5_BANK0+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
								}
#endif
//--------------------------------------------------
...
#define DPEDID_ERASE()			{\
								UserCommonFlashErasePage(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,_TPV_EDID_PAGE);\
								}
//--------------------------------------------------
#define DPEDID_WRITE()			{\
								UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_DPEDID_PAGE) * _FLASH_PAGE_SIZE+_DPEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
								}
//--------------------------------------------------

#define DPEDID_READ()			{\
								UserCommonFlashRead(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_DPEDID_PAGE) * _FLASH_PAGE_SIZE+_DPEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
								}
#endif
//--------------------------------------------------
#if(_MHL_SUPPORT == _ON)
...
#define MHLEDID_ERASE()			{\
								UserCommonFlashErasePage(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,_MHLEDID_PAGE);\
								}
//--------------------------------------------------
#define MHLEDID_WRITE()			{\
								UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_MHLEDID_PAGE) * _FLASH_PAGE_SIZE+_MHLEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
								}
#define MHL2EDID_WRITE()		{\
								UserCommonFlashWrite(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_MHLEDID_PAGE) * _FLASH_PAGE_SIZE+_MHL2EDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciRxBuf[_FC_BYTE8]);\
								}
//--------------------------------------------------
#define MHLEDID_READ()			{\
								UserCommonFlashRead(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_MHLEDID_PAGE) * _FLASH_PAGE_SIZE+_MHLEDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
								}
//--------------------------------------------------
#define MHL2EDID_READ()			{\
								UserCommonFlashRead(_SYSTEM_EEPROM_EMULATION_FLASH_BANK,(_MHLEDID_PAGE) * _FLASH_PAGE_SIZE+_MHL2EDID_OFFSET+(g_ucDdcciRxBuf[_FC_BYTE6]+g_ucDdcciRxBuf[_FC_BYTE7]), 32, &g_ucDdcciTxBuf[_FC_BYTE2]);\
								}
#endif
//--------------------------------------------------
#endif
...
#define HDCP_START()			{\
								UserCommonFlashErasePage(_EEPROM_HDCP_KEY_FLASH_BANK,_HDCP_PAGE);\
								}

#define HDCP_WRITE()			{\
								UserCommonFlashWrite(_EEPROM_HDCP_KEY_FLASH_BANK,(_HDCP_PAGE) * _FLASH_PAGE_SIZE+_HDCP_BLOCK_SIZE*g_ucDdcciRxBuf[_FC_BYTE6], _HDCP_BLOCK_SIZE, &g_ucDdcciRxBuf[_FC_BYTE7]);\
								}
#define HDCP_READ(x)			{\	
								UserCommonFlashRead(_EEPROM_HDCP_KEY_FLASH_BANK,(_HDCP_PAGE) * _FLASH_PAGE_SIZE+x, 8, pData);\									
								}
#endif
