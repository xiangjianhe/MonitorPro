...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Series_AutoFunc.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6001_SERIES_AUTOFUNC__
...
{     
    ...
    ScalerSetBit(P0_D2_ADC_SOG_CMP, ~(_BIT4 | _BIT0), 0x00);
...
void ScalerAutoInitializeCalibration(void)
{
    ...
    // Setup calibration voltage (old-mode)
    ScalerSetBit(P0_D2_ADC_SOG_CMP, ~(_BIT7 | _BIT5 | _BIT4 | _BIT0), (_BIT7 | _BIT5 | _BIT0));    
