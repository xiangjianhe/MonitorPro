...
/********************************************************************************/
#if(_PANEL_TYPE == _TPV_INL_M215HNE_L30)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_PIXEL_CLOCK_MAX                  194                 // Maxinum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T5                     20                 // Panel Power Off T5 (ms) CMI_spec:0<T3<50ms
