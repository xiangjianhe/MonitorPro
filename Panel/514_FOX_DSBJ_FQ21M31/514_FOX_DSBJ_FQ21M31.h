...
#if(_PANEL_TYPE == _FOX_DSBJ_FQ21M31)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_PIXEL_CLOCK_MIN                  117                 // Mininum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T4                     150                 // Panel Power Off T4 (ms)//Eli 20120522 modify T3-T4
