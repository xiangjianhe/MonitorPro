...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_Series_Mcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RRL6269_SERIES_MCU__
...
//--------------------------------------------------
#define _DDCRAM_DDC1_MAX_ADDRESS                            0xFB80
#define _DDCRAM_DDC2_MAX_ADDRESS                            0xFC00
#define _DDCRAM_DDC3_MAX_ADDRESS                            0xFD00
#define _DDCRAM_DDC4_MAX_ADDRESS                            0xFE00

#if(_D0_INPUT_PORT_TYPE == _D0_MHL_PORT)
#define _EMBEDDED_DDCRAM_DDC4_ADDRESS                       (((0xFF00 - _EMBEDDED_DDCRAM_D0_MHL_SIZE) > _DDCRAM_DDC4_MAX_ADDRESS) ? (_DDCRAM_DDC4_MAX_ADDRESS) : (0xFF00 - _EMBEDDED_DDCRAM_D0_MHL_SIZE))
#elif(_D1_INPUT_PORT_TYPE == _D1_MHL_PORT)
#define _EMBEDDED_DDCRAM_DDC4_ADDRESS                       (((0xFF00 - _EMBEDDED_DDCRAM_D1_MHL_SIZE) > _DDCRAM_DDC4_MAX_ADDRESS) ? (_DDCRAM_DDC4_MAX_ADDRESS) : (0xFF00 - _EMBEDDED_DDCRAM_D1_MHL_SIZE))
#else
#define _EMBEDDED_DDCRAM_DDC4_ADDRESS                       _DDCRAM_DDC4_MAX_ADDRESS
#endif

#if(_D0_DDC_CHANNEL_SEL == _DDC3)
#define _EMBEDDED_DDCRAM_DDC3_ADDRESS                       (((_EMBEDDED_DDCRAM_DDC4_ADDRESS - _EMBEDDED_DDCRAM_D0_SIZE) > _DDCRAM_DDC3_MAX_ADDRESS) ? (_DDCRAM_DDC3_MAX_ADDRESS) : (_EMBEDDED_DDCRAM_DDC4_ADDRESS - _EMBEDDED_DDCRAM_D0_SIZE))
#elif(_D1_DDC_CHANNEL_SEL == _DDC3)
#define _EMBEDDED_DDCRAM_DDC3_ADDRESS                       (((_EMBEDDED_DDCRAM_DDC4_ADDRESS - _EMBEDDED_DDCRAM_D1_SIZE) > _DDCRAM_DDC3_MAX_ADDRESS) ? (_DDCRAM_DDC3_MAX_ADDRESS) : (_EMBEDDED_DDCRAM_DDC4_ADDRESS - _EMBEDDED_DDCRAM_D1_SIZE))
#else
...
BYTE xdata MCU_DDCRAM_MHL[_EMBEDDED_DDCRAM_D0_MHL_SIZE]    _at_ _EMBEDDED_DDCRAM_DDC4_ADDRESS;
#elif(_EMBEDDED_DDCRAM_D1_MHL_SIZE != _EDID_SIZE_NONE)
BYTE xdata MCU_DDCRAM_MHL[_EMBEDDED_DDCRAM_D1_MHL_SIZE]    _at_ _EMBEDDED_DDCRAM_DDC4_ADDRESS;
#endif
...
volatile BYTE xdata MCU_WATCHDOG_CNT23_FFAB      _at_ 0xFFAB;

////////////////////////0xFFB0~0xFFBF////////////////////////

volatile BYTE xdata MCU_DDCCI_NULL1_FFB1         _at_ 0xFFB1;
volatile BYTE xdata MCU_DDCCI_NULL2_FFB2         _at_ 0xFFB2;
volatile BYTE xdata MCU_DDCCI_NULL3_FFB3         _at_ 0xFFB3;
volatile BYTE xdata MCU_DDC1_CTRL_DATA_FFB4      _at_ 0xFFB4;
volatile BYTE xdata MCU_DDC2_CTRL_DATA_FFB5      _at_ 0xFFB5;
volatile BYTE xdata MCU_MHL_INT_CTRL_FFB6        _at_ 0xFFB6;
volatile BYTE xdata MCU_MHL_INT_DEBUENCE_CTRL_FFB7 _at_ 0xFFB7;
volatile BYTE xdata MCU_EXT_INT0_CTRL_FFB8       _at_ 0xFFB8;
volatile BYTE xdata MCU_EXT_INT1_CTRL_FFB9       _at_ 0xFFB9;
volatile BYTE xdata MCU_DDC_CTRL_RAM_SIZE_FFBA   _at_ 0xFFBA;
...
void ScalerMcuDdcInitial(void)
{
    ...
    // DDCRAM partition
    MCU_DDCRAM_PART_FF21 &= ~(_BIT7 | _BIT6);
    
    MCU_DDC1_CTRL_DATA_FFB4 = (0x00 | (((DWORD)(_EMBEDDED_DDCRAM_DDC1_ADDRESS - 0xFB00) / 0x80) << 5) |
                                       (((DWORD)(_EMBEDDED_DDCRAM_DDC2_ADDRESS - 0xFB00) / 0x80) << 2));

    MCU_DDC2_CTRL_DATA_FFB5 = (0x00 | (((DWORD)(_EMBEDDED_DDCRAM_DDC3_ADDRESS - 0xFB00) / 0x80) << 5) | 
                                       (((DWORD)(_EMBEDDED_DDCRAM_DDC4_ADDRESS - 0xFB00) / 0x80) << 2));


#if((_D0_DDC_CHANNEL_SEL == _DDC2) || (_D1_DDC_CHANNEL_SEL == _DDC3))
    MCU_DDC_CTRL_RAM_SIZE_FFBA = (0x00 | ((_EMBEDDED_DDCRAM_A0_SIZE / 0x80) << 6) |
                                          (((DWORD)_EMBEDDED_DDCRAM_D0_SIZE / 0x80) << 4) |
                                          (((DWORD)_EMBEDDED_DDCRAM_D1_SIZE / 0x80) << 2) |
                                          ((DWORD) _EDID_SIZE_256 / 0x80));
#elif((_D0_DDC_CHANNEL_SEL == _DDC3) || (_D1_DDC_CHANNEL_SEL == _DDC2))
    MCU_DDC_CTRL_RAM_SIZE_FFBA = (0x00 | ((_EMBEDDED_DDCRAM_A0_SIZE / 0x80) << 6) |
                                          (((DWORD)_EMBEDDED_DDCRAM_D1_SIZE / 0x80) << 4) |
                                          (((DWORD)_EMBEDDED_DDCRAM_D0_SIZE / 0x80) << 2) |
                                          ((DWORD) _EDID_SIZE_256 / 0x80));
#endif
...
#if(((_D0_DDC_CHANNEL_SEL == _DDC2) && (_D0_CBUS_CHANNEL_SEL == _CBUS0)) || ((_D0_DDC_CHANNEL_SEL == _DDC3) && (_D0_CBUS_CHANNEL_SEL == _CBUS1)))
    ScalerSetBit(P10_FB_PIN_CBUS_PIN_SELECT, ~_BIT4, 0x00);
#elif(((_D0_DDC_CHANNEL_SEL == _DDC2) && (_D0_CBUS_CHANNEL_SEL == _CBUS1)) || ((_D0_DDC_CHANNEL_SEL == _DDC3) && (_D0_CBUS_CHANNEL_SEL == _CBUS0)))
    ScalerSetBit(P10_FB_PIN_CBUS_PIN_SELECT, ~_BIT4, _BIT4);
#endif
...
#if(((_D1_DDC_CHANNEL_SEL == _DDC2) && (_D1_CBUS_CHANNEL_SEL == _CBUS0)) || ((_D1_DDC_CHANNEL_SEL == _DDC3) && (_D1_CBUS_CHANNEL_SEL == _CBUS1)))
    ScalerSetBit(P10_FB_PIN_CBUS_PIN_SELECT, ~_BIT4, 0x00);
#elif(((_D1_DDC_CHANNEL_SEL == _DDC2) && (_D1_CBUS_CHANNEL_SEL == _CBUS1)) || ((_D1_DDC_CHANNEL_SEL == _DDC3) && (_D1_CBUS_CHANNEL_SEL == _CBUS0)))
    ScalerSetBit(P10_FB_PIN_CBUS_PIN_SELECT, ~_BIT4, _BIT4);
#endif

#endif

    // DDC2/DDC3 Input Source Type
    ScalerSetBit(P10_FB_PIN_CBUS_PIN_SELECT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ...
    ScalerSetBit(P10_B6_PIN_SHARE_CTRL16, ~_BIT6, _BIT6);

    // DDC2 set to Low Leak Mode
    ScalerSetBit(P10_DF_PIN_SHARE_CTRL3F, ~_BIT6, _BIT6);

    // DDC3 set to Low Leak Mode
    ScalerSetBit(P10_DD_PIN_SHARE_CTRL3D, ~_BIT6, _BIT6);
