...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_Series_DP_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define GET_DP_PHY_CTS_FLG()                        (bit)ScalerGetBit(PC_F9_W_RESERVE4, _BIT7)
#define SET_DP_PHY_CTS_FLG()                        ScalerSetBit(PC_F9_W_RESERVE4, ~_BIT7, _BIT7)
#define CLR_DP_PHY_CTS_FLG()                        ScalerSetBit(PC_F9_W_RESERVE4, ~_BIT7, 0x00)
...
#endif // End of #ifndef __RL6192_SERIES_DP__
