...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6297_Series_Audio.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6297_SERIES_DISPLAY__
...
{       
    ...
    ScalerSetDataPortByte(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_10_LVDS_CTRL31, 0xC1);
    ScalerSetDataPortByte(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_11_LVDS_CTRL32, 0xA9);
    ...
    ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_19_LVDS_CTRL40, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3), ((_LVDS_EA_PHASE << 7) | (_LVDS_EB_PHASE << 6) | (_LVDS_EC_PHASE << 5) | (_LVDS_ED_PHASE << 4) | (_LVDS_EE_PHASE << 3)));
    ...
    ScalerSetDataPortByte(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_A2_TCON_LVDS_CTRL2, 0x12);
    ...
    ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_A1_TCON_LVDS_CTRL1, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), 0x00);
#elif(_LVDS_VCM_CONTROL == _LVDS_VCM_NORMAL)
    ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_A1_TCON_LVDS_CTRL1, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));
#elif(_LVDS_VCM_CONTROL == _LVDS_VCM_HIGH)
    ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_A1_TCON_LVDS_CTRL1, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), (_BIT6 | _BIT2 | _BIT1));
#endif

    // Set LVDS data shpae adjustment control
#if(_LVDS_SHAPE_ADJUSTMENT == _LVDS_SHAPE_FAST_TO_SLOW) 
    ...
    ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_0D_TCON_TCON0_HE_LSB, 0x00, 0x33);
    ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_0E_TCON_TCON0_CTRL, 0x00, 0x33);
#endif
