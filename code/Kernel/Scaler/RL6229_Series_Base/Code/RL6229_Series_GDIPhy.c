...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_GDIPhy.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6229_SERIES_GDIPHY__
...
void ScalerGDIDigitalPhySwitch(BYTE ucInputPortType)
{
    ...
    {
        DebugMessageScaler("7. wuzanne test : Digital Port Switch To DP Dual HDMI", 0);
        ...
        // Dual Mode Disable and Analog Select to HDMI
        ScalerSetBit(PB_AC_CDR_A, ~(_BIT3 | _BIT4), (_BIT3 | _BIT4));	
...
#if(_DP_DUAL_MODE_SUPPORT == _ON)
    ScalerSetByte(PB_B4_POWER_0, 0x01); 
#else
...
void ScalerGDIBandgap(bit bSelect)
{
    if(bSelect == _ON)
    {
        ...
        ScalerSetBit(PB_B7_Z0_1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
        ScalerSetByte(PB_B7_Z0_1, ScalerGetByte(PB_B7_Z0_1) | ((ScalerGetByte(PB_B8_Z0_2) >> 3) & 0x0C));
        ScalerSetByte(PB_B7_Z0_1, ScalerGetByte(PB_B7_Z0_1) | ((ScalerGetByte(PB_B7_Z0_1) >> 2) & 0x03));
