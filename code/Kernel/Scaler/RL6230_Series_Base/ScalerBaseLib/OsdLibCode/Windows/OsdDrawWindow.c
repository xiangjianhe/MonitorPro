...
void ScalerOsdDrawWindow(WORD usXStart, WORD usYStart, WORD usXEnd, WORD usYEnd)
{
    ...
    ucpTemp[9]  = (((BYTE)GET_OSD_WINDOW_COLOR_SHADOW() & _BIT5) << 2) | (((BYTE)GET_OSD_WINDOW_COLOR_BORDER() & _BIT5) << 1) | ((BYTE)GET_OSD_WINDOW_COLOR() & _BIT5) | ((BYTE)GET_OSD_WINDOW_GRADIENT_SATURATED_COLOR_MODE() <<4) | ((BYTE)GET_OSD_WINDOW_GRADIENT_REVERSED_COLOR_MODE() <<3);
