...
#if(_PROJECT == _RL6001_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6001_DEMO_1A1H1DP
...
#define _AUTO_PB_GAIN_BIAS                                      (1)
#define _AUTO_PR_GAIN_BIAS                                      (1)
#define _AUTO_Y_GAIN_BIAS                                       (0)
#define _AUTO_PB_OFFSET_BIAS                                    (7)
#define _AUTO_PR_OFFSET_BIAS                                    (7)
