...
#define __RL6269_SERIES_QC_OSD__
...
BYTE code tQC_OSDCHARACTERCOMMAND_FRAME7[] =  // 3x8 = 24
{
    ...
    // row 7 : 4 font
    _1BIT_TYPE1 | CHAR_WIDTH(0x0a), CHARSELECT(0x01), COLORSELECT(0x02, 0x0b),  // FONT 1 "n"
    _1BIT_TYPE5 | CHAR_WIDTH(0x09), CHARSELECT(0x01), COLORSELECT(0x02, 0x0b),  // FONT 1  "n"
    _1BIT_TYPE6,                    CHARSELECT(0x4), BLANKCOLOR(0x12),  
...
void ScalerQCOsdSetHighLightWindow(BYTE ucWinNum, BYTE ucFColor, BYTE ucBColor, BYTE b6BorderColor, bit bEnable);
...
void ScalerQCOsdTestFrame0(void)
{
    ...
    ScalerQCOsdGridFunction(WINNO(2), 0x00, 0x1f, 0x03, 0x1f + 1, 0xcff + (0x424 / 4));
    ScalerQCOsdGridFunction(WINNO(3), 0x00, 0x1f, 0x03, 0x1f + 1, 0xcff + (0x424 / 4));
    ScalerQCOsdGridFunction(WINNO(4), 0x00, 0x1f, 0x03, 0x1f + 1, 0xcff + (0x424 / 4));
...
//-----------------------------------------
// Description  : Close some OSD test frame 5
// Input Value  : None 
// Output Value : None
//-----------------------------------------
...
{      
    ...
    ScalerQCOsdSetWin6SpecialBlending(0x00, _DISABLE);
...
void ScalerQCOsdTestFrame8(void)
{
    ...
    ScalerQCOsdSetOsdLengthWidth(0x400, 0x400, 0x01);
    ScalerQCOsdSetOsdLengthWidth(0x400, 0x400, 0x02);
...
bit ScalerQCOsdTestProc(void)
{
    ...
    if(ScalerQCCheckCRCOn(0x4C, 0x19, 0x33, _D_DOMAIN_CRC))
    {
        usData |= _BIT7;
    }
    ...
    if(ScalerQCCheckCRCOn(0x6E, 0x18, 0xE8, _D_DOMAIN_CRC))     
    {
        usData |= _BIT10;
    } 
    ...
    if(ScalerQCCheckCRCOn(0x74, 0xC4, 0xE7, _D_DOMAIN_CRC))    
    {
        usData |= _BIT10;
    } 
