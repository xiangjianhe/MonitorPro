...
//----------------------------------------------------------------------------------------------------
// ID Code      : PRJ_L_LS2224_1A1D_BOE_HT215F01_100.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LI2224_1A1D_AUO_M215HTN01_DOT_1)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G8241_6336_AD


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_AUO_M215HTN01_DOT_1
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LI2224_AD.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LI2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LI2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
#endif
#define _USER_DCR_OSD_FUNCTION							        _ON
...
//==================================================================
#define _MODEL_NAME                                             _bL_, _bI_, _2_, _2_, _2_, _4_
#define _MICROCODE                                              _bL_,_bA_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _L,_I,_2,_2,_2,_4
#define _FW_RELEASE_DATE                                        _2,_0,_1,_6,_0,_5,_1,_9
...
#define _PANNEL_NAME 											'M','2','1','5','H','T','N','0','1'
...
#define MAX_CONTRAST_TO_REG_VALUE             118
#define MIN_CONTRAST_TO_REG_VALUE              40
#define DEF_CONTRAST_TO_REG_VALUE               100
 
#define MAX_CONTRAST_TO_INTERNET_VALUE  118
#define MIN_CONTRAST_TO_INTERNET_VALUE   40
#define DEF_CONTRAST_TO_INTERNET_VALUE    100
 
#define MAX_CONTRAST_TO_VIDEO_VALUE                  118
#define MIN_CONTRAST_TO_VIDEO_VALUE                   40
#define DEF_CONTRAST_TO_VIDEO_VALUE             100
 
#define MAX_CONTRAST_TO_SPLIT_VALUE           118
#define MIN_CONTRAST_TO_SPLIT_VALUE            40
#define DEF_CONTRAST_TO_SPLIT_VALUE             100

#define _OSD_CONTRAST_DEF_VALUE                                 50
...
#define _LBL_BRIGHTNESS_DEF_VALUE                       		10//40
...
//==================================================================
#define _PWM_B00                                                88//0x58 //|00
#define _PWM_B10                                                109//0x58 //|10
#define _PWM_B20                                                141//0x5B //|20
#define _PWM_B30                                                157//0x63 //|30
#define _PWM_B40                                                180//0x6D //|40
#define _PWM_B50                                                203//0x7B //|50
#define _PWM_B60                                                214//0x8D //|60
#define _PWM_B70                                                225//0xAC //0x9A //|70
#define _PWM_B80                                                236//0xCB //0xBF //|80
#define _PWM_B90                                                247//0xE5 //0xDE //|90
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   119
#define _CT7200_LenovoPrj_GREEN                                 125
#define _CT7200_LenovoPrj_BLUE                                  127

#define _CTSRGB_LenovoPrj_RED                                   126
#define _CTSRGB_LenovoPrj_GREEN                                 128
#define _CTSRGB_LenovoPrj_BLUE                                  125
...
#endif // End of #if(_PROJECT == _PRJ_L_LS2014_A)
