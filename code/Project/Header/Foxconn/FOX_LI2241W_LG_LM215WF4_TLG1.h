...
#if(_PROJECT == _FOX_LI2241W_LG_LM215WF4_TLG1)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_LG_LM215WF4_TLG1//_TPV_CMI_M220ZGE// 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN LI2241 Wide)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LEN LI2241 Wide)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//Facory OSD
#define _FACTORY_PROJECT_NAME                           _L,_I,_2,_2,_4,_1,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_L,_G,_SPACE,_L,_M,_2,_1,_5,_W,_F,_4,_T,_L,_G,_1
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_1,_D,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_7,_0,_3
#define _FW_VERSION                                     _L,_G, _2, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0200  //Ver 1.00	

//User OSD
#define _MODEL_NAME                                     _2_, _2_, _4_, _1_
...
#define FacoryBomH4                                     'E'
#define FacoryBomH5                                     '0'
...
#define _LBL_BRIGHTNESS_DEF_VALUE                       80

#define _CONTRAST_CHANG_POINT_ANALOG					103
#define _CONTRAST_MAX_ANALOG							115
#define _CONTRAST_MIN_ANALOG							40

#define _CONTRAST_CHANG_POINT_DIGITAL					103
#define _CONTRAST_MAX_DIGITAL							115
...
//----------------------------------------------------
#define _PWM_B00                                        98 //|00
#define _PWM_B10                                        99 //|10
#define _PWM_B20                                        103 //|20
#define _PWM_B30                                        109 //|30
#define _PWM_B40                                        118 //|40
#define _PWM_B50                                        130 //|50
#define _PWM_B60                                        147 //|60
#define _PWM_B70                                        167 //|70
#define _PWM_B80                                        218 //|80
#define _PWM_B90                                        231 //|90
...
#endif // End of #if(_PROJECT == _FOX_LI2241W_LG_LM215WF4_TLG1)
