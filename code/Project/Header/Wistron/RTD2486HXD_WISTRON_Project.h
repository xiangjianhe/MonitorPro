...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2486HXD_WISTRON_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RTD2486HXD_WISTRON_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                              _RTD2486HXD_WISTRON_1A1H1DP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _MULTIPANEL_22_WUXGA 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(T2254pC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 11 0F) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(T2254pC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 11 0F) AC AE B2 B6 C6 C8 C9 CA CC(0D 02 03 04 05 06 09 0A) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(T2254pC)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 11 0F) AC AE B2 B6 C6 C8 C9 CA CC(0D 02 03 04 05 06 09 0A) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"  
...
#define _ANALOG_VOLUME_MAX                                      0x0027 // MAX: 0x0037
...
#define _DIGITAL_VOLUME_MAX                                     _DAC_AUDIO_VOL_FIXED//ym20141126 . 0x2FFF//0x0405 //P8_A5,A6 _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
...
#define _DIN_AUDIO_VOL_FIXED                                    0x0027//0x002A//P6_B8,B9 max:0x3F 0x27=1:1
#define _DAC_AUDIO_VOL_FIXED                                    0x3AA0//0x37A0//ym20141016 . 0x3FFF=1:1//P8_A5,A6 _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
...
//-------------------------------------------------
//ym20141029 . define by multi pane #define _DCLK_SPREAD_RANGE         2    // 0~15, 0 ~ disable, 15 ~ 7.50%   
...
//==================================================================
#define _IC_SERIES                                              _R,_T,_D,_2,_4,_8,_6,_H,_X,_D
#define _MODEL_NAME												_T_, _2_, _2_, _5_,_4_,_p_,_C_
#define _MICROCODE												_L_,_G_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _T,_2,_2,_5,_4,_p,_C
#define _FW_RELEASE_DATE                                        _2,_0,_1,_4,_1,_1,_2,_7
...
#define _MODEL_Data_code                                        "T2254pC"
#define _PANEL_NAME                                             _P,_A,_N,_E,_L

#define VERSION_STRING_CMI                                      "LM1.5"
#define VERSION_STRING_SEC                                      "LS1.5"
...
#define _EDID_VERSION_CODE                                      0xD9//0xD8
#define _LENOVO_SN_TYPE                                         _LENOVO_SN_LI

#define _EDID_24C02_MEMORY                                      _ENABLE
#define _EDID_FLASH_MEMORY                                      _DISABLE
#define _EDID_TYPE                                              {_EDID_VGA_256, _EDID_HDMI, _EDID_DP}
#define _EDID_MEMORY                                            {_MEMORY_24C02, _MEMORY_24C02, _MEMORY_NONE}
...
#define DEF_CONTRAST_RATIO                                      100//101 // 1.00(unit 1/100)
...
#define _CT7200_LenovoPrj_GREEN                                 0x80
...
#define _AUDIO_EXTERNAL_AMP_SUPPORT								_ON
