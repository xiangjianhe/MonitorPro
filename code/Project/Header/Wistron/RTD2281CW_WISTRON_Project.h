...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2281CW_WISTRON_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RTD2281CW_WISTRON_PROJECT)
...
#define _ENERGY_STAR_SUPPORT                                    _ON
...
//==================================================================
#define _CHECKSUM                                               0x84//0x86
#define _VERSION_CODE                                           0x88
...
#define _MODEL_NAME								                _bL_, _bT_, _b1_, _b7_, _b1_, _b3_,_bp_
#define _MICROCODE							                    _bL_,_bA_, _b1_, _DOT, _b0_
...
#endif // End of #if(_PROJECT == _RTD2281CW_WISTRON_PROJECT)
