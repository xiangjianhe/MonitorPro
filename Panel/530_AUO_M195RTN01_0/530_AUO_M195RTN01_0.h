...
#if(_PANEL_TYPE == _FOX_AUO_M195RTN01_0)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MIN                     1960                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1564                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     912                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      121                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  153                 // Maxinum Pixel Clock in MHz
...
#define _PANEL_POWER_ON_T3                      500                 // Panel Power On T3 (ms) CMI_spec:T5>200ms

#define _PANEL_POWER_OFF_T4                     200                 // Panel Power Off T4 (ms) CMI_spec:T4>100ms
...
#endif // End of #if(_PANEL_TYPE == _FOX_CMI_M195FGE_L20)
