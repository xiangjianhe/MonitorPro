...
#define __RL6269_SERIES_AUDIO__
...
void ScalerAudioDACInitial(void)
{
    ...
    ScalerSetBit(P6_CA_DEPOP_CTRL2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT5));
#else
    // Set HP output(L CH : AIN_R, R CH : AIN_L)
    ScalerSetBit(P6_CA_DEPOP_CTRL2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
#endif
...
void ScalerAudioDACInputSwitch(bit bAudioSource)
{
    ...
    else //_DIGITAL_AUDIO
    {
        ...
        ScalerSetBit(P6_CA_DEPOP_CTRL2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#else
        // Set HP output(L CH : DAC_R, R CH : DAC_L)
        ScalerSetBit(P6_CA_DEPOP_CTRL2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT6 | _BIT4));
#endif
