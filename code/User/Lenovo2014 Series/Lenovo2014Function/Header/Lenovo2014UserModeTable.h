...
//----------------------------------------------------------------------------------------------------
// ID Code      : UserModeTable.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
enum PresetModeDef
{
...
#if(_FACTORY_MODE_OWNER != _OWNER_TPV)//Ada.chen 20150817
...
#if(_FACTORY_MODE_OWNER != _OWNER_TPV)//Ada.chen 20160113
    ...
    _MODE_700x570_50HZ,             // Mode 149:
    _MODE_1280x1024_72HZ_1,			// Mode 150:
    _MODE_1280x768_60HZ_1,          // Mode 151: 20120922 Abel Add TimingTable
#if(_FACTORY_MODE_OWNER == _OWNER_FOXCONN)//lorimiao 20141115
    _MODE_1600x900_75HZ,            // Mode 152: //Eli 20121128 H9CMT178GTG1HN-30 Add timing.
#else
#if((_PANEL_DH_WIDTH == 1600)&&(_PANEL_DV_HEIGHT == 900))//jason.cheng 20141028_3 add 
    _MODE_1600x900_75HZ,            // Mode 152: //Eli 20121128 H9CMT178GTG1HN-30 Add timing.
#endif
#endif
#if(_FACTORY_MODE_OWNER == _OWNER_TPV)//Ada.chen 20160113
	_MODE_2560x1440_60HZ,			// Mode 152: 
#endif
    _MODE_1440x900_70HZ,            // Mode 153: //xiangjianhe @20171020   
    _MAX_PRESET_MODE,
};
...
StructModeTableType code tINPUTMODE_PRESET_TABLE[_MAX_PRESET_MODE] =
{
   ...
   {   //Mode 56 : 1280 x 800 x 60 Hz R
    ...
    //lorimiao 20130730 add
 	{   // Mode 149 : _MODE_700x570_50HZ (PAL)         For LENOVO required
        0 | _SYNC_HN_VN | _SYNC_HP_VN | _SYNC_HN_VP | _SYNC_HP_VP,          // Polarity Flags,
    ...
    {   // Mode 150 : 1280 x 1024 x 72 Hz _1
        0 | _SYNC_HP_VP | _SYNC_HN_VP | _SYNC_HP_VN | _SYNC_HN_VP,         	// Polarity Flags,
        1280, 1024,                                                         // InputWidth, InputHeight,
        770,720,                                                            // HFreq in kHz, VFreq in Hz,
        _HFREQ_TOLERANCE, _VFREQ_TOLERANCE,                                 // HFreqTolerance in kHz, VFreqTolerance in Hz,
    ...
    //20120922 Abel Add TimingTable
    {   // Mode 151 : 1280 x 768 x 60 Hz _1
        0 | _SYNC_HP_VP,                                                    // Polarity Flags,
        1280, 768,                                                          // InputWidth, InputHeight,
        480, 598,                                                           // HFreq in kHz, VFreq in Hz,
        _HFREQ_TOLERANCE, _VFREQ_TOLERANCE,                                 // HFreqTolerance in kHz, VFreqTolerance in Hz,
        1688, 802,                                                          // HTotal, VTotal,
        320, 26,                                                            // HStartPos, VStartPos,
    },
#if(_FACTORY_MODE_OWNER == _OWNER_FOXCONN)//lorimiao 20141115
     //Eli 20121128 H9CMT178GTG1HN-30 Add timing.
    {   // Mode 152 : 1600 x 900 x 75 Hz
        0 | _SYNC_HN_VP,                                                    // Polarity Flags,
        1600, 900,                                                          // InputWidth, InputHeight,
        706, 749,                                                           // HFreq in kHz, VFreq in Hz,
        _HFREQ_TOLERANCE, _VFREQ_TOLERANCE,                                 // HFreqTolerance in kHz, VFreqTolerance in Hz,
        2144, 942,                                                          // HTotal, VTotal,
        440, 39,                                                            // HStartPos, VStartPos,
    },
#else  
#if((_PANEL_DH_WIDTH == 1600)&&(_PANEL_DV_HEIGHT == 900))//jason.cheng 20141028_3 add
    //Eli 20121128 H9CMT178GTG1HN-30 Add timing.
    ...
    {   // Mode 115 : 1920 x 1440 x 60 Hz (Reduced Blanking)
        0 | _SYNC_HP_VN,                                                    // Polarity Flags,
        2560, 1440,                                                         // InputWidth, InputHeight,
        888, 600,                                                           // HFreq in kHz, VFreq in Hz,
        _HFREQ_TOLERANCE, _VFREQ_TOLERANCE,                                 // HFreqTolerance in kHz, VFreqTolerance in Hz,
...
#endif
    //xiangjianhe @20171020
    {   // Mode 153 : 1440 x 900 x 70 Hz
        0 | _SYNC_HN_VP,                                                    // Polarity Flags,
        1400, 900,                                                          // InputWidth, InputHeight,
        655, 700,                                                           // HFreq in kHz, VFreq in Hz,
        _HFREQ_TOLERANCE, _VFREQ_TOLERANCE,                                 // HFreqTolerance in kHz, VFreqTolerance in Hz,
        1930, 942,                                                          // HTotal, VTotal,
        440, 39,                                                            // HStartPos, VStartPos,
    },
};
...
StructSyncPulseCountCheckType code tVSYNC_PULSE_COUNT_MODE_TABLE[] =
{
    ...
    //jason.cheng 20141106_1 disable for Lenovo T430S timing issue
...
#else
#if((_PANEL_DH_WIDTH == 1600)&&(_PANEL_DV_HEIGHT == 900))//jason.cheng 20141106_1 modify for Lenovo T430S timing issue 
    {_MODE_1600x900_60HZ, _MODE_1440x900_60HZ, 5},
#else
	{_MODE_1600x900_60HZ, _MODE_1440x900_60HZ, 1},
#endif
#endif
#endif
    ...
    {_MODE_1366x768_60HZ, _MODE_1280x768_60HZ_1, 5},  //20120922 Abel Add TimingTable
#if(_FACTORY_MODE_OWNER != _OWNER_TPV)//Ada.chen 20150817
...
StructSyncPulseCountCheckType code tHSYNC_PULSE_COUNT_MODE_TABLE[] =
{
    ...
    {_MODE_1600x900_75HZ, _MODE_1440x900_75HZ, 20},       
#endif
...
#endif
    {_MODE_720x576p_50HZ,_MODE_700x570_50HZ,68},//lorimiao 20130730 add
    {_MODE_720x576p_50HZ_SOG,_MODE_700x570_50HZ,68},
    {_MODE_NOSUPPORT, _MODE_NOSUPPORT, 0},
};
