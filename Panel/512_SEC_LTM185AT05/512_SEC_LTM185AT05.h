...
#if(_PANEL_TYPE == _FOX_SEC_LTM185AT05)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         1526                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     1830                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         790                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     948                // Maxinum Display Vertical Total Clock Number in One Display Line
