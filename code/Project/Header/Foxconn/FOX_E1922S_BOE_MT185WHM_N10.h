...
#if(_PROJECT == _FOX_E1922S_BOE_MT185WHM_N10)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_BOE_MT185WHM_N10
