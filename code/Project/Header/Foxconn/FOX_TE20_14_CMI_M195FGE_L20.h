...
#if(_PROJECT == _FOX_TE20_14_CMI_M195FGE_L20)
...
#define _CAPABILITIES_STRING_VGA 								"(port(monitor)type(LCD)model(LEN TE20-14)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 AC AE B2 B6 C6 C8 C9 CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF FF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//User OSD
#define _MODEL_NAME                                     _T_, _E_, _2_, _0_, _LINE, _1_,_4_
#define _MICROCODE                                      _L_,_M_, _1_, _DOT, _0_
//Facory Command
