...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6096_QA_1A1DVI.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6096_QA_1A1DVI)
...
// DVI HPD
#define _PIN_45                                 (1 & 0x03) // Page 10-0xA1[7:6]
...
// VCLK
#define _PIN_50                                 (5 & 0x07) // Page 10-0xAB[7:5]
...
sbit bD1_CONNECT                                = P3 ^ 5; // Pin 112, P3.5 Not Connect In QA  Board
...
#endif // End of #if(_PCB_TYPE == _RL6096_QA_1A1DVI)
