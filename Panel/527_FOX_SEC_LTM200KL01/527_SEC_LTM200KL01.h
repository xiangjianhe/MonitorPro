...
#if(_PANEL_TYPE == _FOX_SEC_LTM200KL01)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_MAX_FRAME_RATE                   750                 // Unit in 0.1 HZ
...
#define _PANEL_DH_TOTAL                         2112               // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2300                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1900                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         934                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1155                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     907                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      118                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  152                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  86                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      35                  // Panel Power On T1 (ms) CMI_spec:0<T2<50ms
#define _PANEL_POWER_ON_T2                      30                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      550                 // Panel Power On T3 (ms) CMI_spec:T5>200ms

#define _PANEL_POWER_OFF_T4                     250                 // Panel Power Off T4 (ms) CMI_spec:T4>100ms
#define _PANEL_POWER_OFF_T5                     20                 // Panel Power Off T5 (ms) CMI_spec:0<T5<50ms
#define _PANEL_POWER_OFF_T6                     1100                // Panel Power Off T6 (ms) CMI_spec:T7>1000ms
...
#endif // End of #if(_PANEL_TYPE == _FOX_CMI_M200FGE_L23)
