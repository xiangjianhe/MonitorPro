...
#if(_PCB_TYPE == _PCB_TPV_715G7298_6229_AHP)
...
#define _EMBEDDED_DDCRAM_D1_SIZE                _EDID_SIZE_256//_EDID_SIZE_NONE
#define _EMBEDDED_DDCRAM_D1_LOCATION            _EDID_TABLE_LOCATION_USER//_EDID_TABLE_LOCATION_CODE//
...
#if((_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K)||(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ22K))
...
#define _AUDIO_VOLUME_PWM                       _PWM5            
...
// USB ON
#define _PIN_34                                 (2 & 0x07) // Page 10-0xB7[1:0]
...
// EDID_WP
#define _PIN_39                                 (2 & 0x0F) // Page 10-0xB8[1:0]
...
// TP_ADC
#define _PIN_50                                 (1 & 0x07) // Page 10-0xAB[7:5]
...
// Volume Adjust
#define _PIN_71                                 (5& 0x0F) // Page 10-0xA7[2:0]
...
// BL_ADJ
#define _PIN_103                                (3 & 0x0F) // Page 10-0xAC[6:4]
...
// VOL_UP
#define _PIN_109                                (0 & 0x0F) // Page 10-0xAD[6:4]
...
// VOL_DOWN
#define _PIN_110                                (0 & 0x0F) // Page 10-0xAD[2:0]
...
// PS_EN
#define _PIN_114                                (1 & 0x0F) // Page 10-0xB2[4:2]
...
// HDMI_HOT_PLUG
#define _PIN_126                                (2 & 0x0F) // Page 10-0xA1[2:0]
...
//-----------------------------------------------
#if(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K)
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 20000); \
                                                    ScalerMcuPwmAdjustFrequency(_AUDIO_VOLUME_PWM, 1000); \                                                   
                                                }
#elif(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ22K)
#define PCB_PWM_SETTING()                       {\
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT_PD1_PIN_REG_FF7D) //  Pin 37, PD.1
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                    	(MCU_PORT_PD0_PIN_REG_FF7E)    // Pin 39, PD.0
...
#define bDP_PIN16_CONNECT                       (MCU_PORT_PD7_PIN_REG_FF77) // Pin 31, PD.7
#define bDP_PIN17_CONNECT                       (MCU_PORT63_PIN_REG_FFCA) // Pin 53, P6.3

#define bA0_CONNECT                             (MCU_PORT_PD5_PIN_REG_FF79) // Pin 33, PD.5
#define bD0_CONNECT                             (MCU_PORT_PD6_PIN_REG_FF78) // Pin 32, PD.6
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_PORTC0_PIN_REG_FFA3) // Pin 126, PC.0 for HDMI
...
// Macro of LED On/Off
//--------------------------------------------------
#if ((_PROJECT == _PRJ_L_T2364p_AHP_LG_LM230WF9_SSA1) || (_PROJECT == _PRJ_L_T2364t_AHP_LG_LM230WF7_SSB1)||(_PROJECT == _PRJ_L_T23i_10_AHP_LG_LM230WF9_SSA1)||(_PROJECT == _PRJ_L_P23i_15_AHP_LG_LM230WF9_SSA1))
sbit bLED1                                      = P3 ^ 5; // Pin 113, P3.6
sbit bLED2                                      = P3 ^ 6; // Pin 112, P3.5 (Green) for HW request
#else
sbit bLED1                                      = P3 ^ 6; // Pin 113, P3.6
sbit bLED2                                      = P3 ^ 5; // Pin 112, P3.5 (Green)
#endif
...
#define bPOWER_KEY                              (MCU_PORT80_PIN_REG_FFD6 & 0x01) // Pin105, P8.0
...
// jimmy 20140905 have to update keypad setting for correct keypad
//EXIT: 0V~0.2v
//LEFT: 0V!~0.2v
//RIGHT: 1.3v~1.5v
//MENU:  1.3V~1.5v
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x00 <= ucV1) && (ucV1 < 0x09))         \
                                                                    ucKeyState |= _EXIT_KEY_MASK;           \
                                                                                                            \
                                                                if((0x00 <= ucV2) && (ucV2 < 0x09))         \
                                                                    ucKeyState |= _LEFT_KEY_MASK;           \
                                                                                                            \
                                                                if((0x68 <= ucV2) && (ucV2 < 0x76))         \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;          \
                                                                                                            \
                                                                if((0x68 <= ucV1) && (ucV1 < 0x76))         \
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((0x00 <= ucV2) && (ucV2 < 0x10))         \
                                                                    ucKeyState |= _LEFT_KEY_MASK;           \
                                                                                                            \
                                                                if((0x65 <= ucV2) && (ucV2 < 0x80))         \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;          \
                                                                                                            \
                                                                if((0x65 <= ucV1) && (ucV1 < 0x80))         \
                                                                    ucKeyState |= _MENU_KEY_MASK;           \
                                                                                                            \
                                                                if(!bPOWER_KEY)						        \
                                                                    ucKeyState |= _POWER_KEY_MASK;	        \
...
//--------------------------------------------------
// Macro of Panel Interlace Mode Selection
//--------------------------------------------------
#define bPANEL_ITLC								(MCU_PORTC2_PIN_REG_FFA1)

//ITLC is Interlace mode selection pin. (L : Normal Mode, H : Interlace Mode)
#define _PANEL_INTERLACE_MODE					1
#define _PANEL_NORMAL_MODE						0

#define PCB_PANEL_INTRLACE_MODE(x)              {\
													bPANEL_ITLC = (x);\
                                              	}
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_PORT74_PIN_REG_FFD3) // Pin 104, P.7.4
...
#define PCB_GET_BACKLIGHT_PWM()                 (MCU_PWM1H_DUT_FF4B)
...
#define bAMPONOFF                               (MCU_PORT_PD2_PIN_REG_FF7C)//Pin36 PD.2
#define _AMP_POWER_ON                           0       // Amp off state
#define _AMP_POWER_OFF                          1       // Amp on state

#define PCB_AMP_POWER(x)                        {\
                                                   bAMPONOFF = x; \
                                                }
//-----------------------------------------------
#define bAMPSTANDBY								(MCU_PORTC4_PIN_REG_FFA4) // Pin 40, PC.4	
#define _AMP_STAND_BY_ON                        0       // Amp Stand By on state
#define _AMP_STAND_BY_OFF                       1       // Amp Stand By off state

#define PCB_AMP_STAND_BY(x)                     {\
													bAMPSTANDBY = x;\
                                                }
//-----------------------------------------------
#define bAMPMUTE                                (MCU_PORT65_PIN_REG_FFCC) // Pin 55, P6.4
...
#define PCB_GET_AUDIO_VOLUME_PWM()              (MCU_PWM5H_DUT_FF51)

//-----------------------------------------------
// Macro of Usb Hub High/Low
//-----------------------------------------------
//USB±µ¤W¬°Hi
#define PCB_USB_DETECT()                        (MCU_PORTC3_PIN_REG_FFA0)
...
#define PCB_USB_POWER(x)                        {\
                                                    MCU_PORT_PD4_PIN_REG_FF7A = x;  \
                                                }

#define PCB_GET_USB_POWER()                     (MCU_PORT_PD4_PIN_REG_FF7A)
...
#endif // End of #if(_PCB_TYPE == _PCB_TPV_715G7298_6229_AHP)
