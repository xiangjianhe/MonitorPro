...
#if(_PROJECT == _PRJ_L_E2224_AD_SAMSUNG_LTM215HP01)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G7799_6229_AD


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_SAMSUNG_LTM215HP01
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_E2224_AD_6229.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(E2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(E2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      8//6    // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
//==================================================================
#define _MODEL_NAME												'E','2','2','2','4'
#define _MICROCODE												'L','S','0','.','1'
#define _RELEASE_DATE                                        	'2','0','1','5','1','0','1','8'
#define _IC_SERIES                                      		'R','T','D','2','2','8','1','L','R'
#define _PANNEL_NAME 											'L','T','M','2','1','5','H','P','0','1'
...
//==================================================================
#define _OD_NORMAL_GAIN											0x56//Gain0x56 -7.72ms
...
#define _BACKLIGHT_PWM_FREQ_SELECT                            _PWMFREQIVF//  _PWMFREQ22K
