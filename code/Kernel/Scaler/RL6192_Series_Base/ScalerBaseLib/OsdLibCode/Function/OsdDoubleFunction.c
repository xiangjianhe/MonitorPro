...
void ScalerOsdDoubleFunction(EnumOsdDoubleWidthType enumOsdDoubleWidthType, EnumOsdDoubleHeightType enumOsdDoubleHeightType)
{
    ...
    ucTemp = (ScalerOsdFrameControlByteGet(0x003, _OSD_BYTE1) & ~(_BIT1 | _BIT0)) | ((BYTE)enumOsdDoubleWidthType << 1 | (BYTE)enumOsdDoubleHeightType);
