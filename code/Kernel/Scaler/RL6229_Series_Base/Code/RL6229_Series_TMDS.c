...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_TMDS.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6229_SERIES_TMDS__
...
#if(_3D_SUPPORT == _ON)
BYTE ScalerTmdsHdmiGet3DFormat(void);
#endif
...
#if(_3D_SUPPORT == _ON)
    // Set HDMI 3D info into RSV2
    ScalerSetDataPortByte(P2_C9_HDMI_ADDR_PORT, _P2_CA_PT_A4_HDMI_PTRSV2, _HDMI_3D_FORMAT);        
#endif
...
void ScalerTmdsInterruptInitial(void)
{
    ...
    ScalerSetBit(PB_B4_POWER_0, ~_BIT0, _BIT0);
...
void ScalerTmdsSetDFEInitial_EXINT0(void) using 1
{
    ...
    // [7] Negative Symbol-Rate Clock
    // [6] Enable Timer Control DFE Loop
    // [5:4] No Reduce Gain
    // [3] Disable Running Length Detection
    // [2] bypass Blank out Case-3 Symbol
    ScalerSetBit_EXINT0(P1D_A0_L0_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6));
    ScalerSetBit_EXINT0(P1D_B0_L1_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6));
    ScalerSetBit_EXINT0(P1D_C0_L2_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6));

    if(GET_INPUT_PIXEL_CLK() > 1100)
    {
    ...
    else if(GET_INPUT_PIXEL_CLK() > 800)
    {
        ScalerSetByte_EXINT0(P1D_A2_L0_LIMIT_INIT, 0x3A); 
        ScalerSetByte_EXINT0(P1D_B2_L1_LIMIT_INIT, 0x3A); 
        ScalerSetByte_EXINT0(P1D_C2_L2_LIMIT_INIT, 0x3A); 
    }
...
void ScalerTmdsSetPhy_EXINT0(void) using 1
{
    ...
    // [4:2] Enable Stage1 High Boost Mode, Disable Stage2/3 High Boost Mode
    ScalerSetBit_EXINT0(PB_A4_CDR_2, ~(_BIT4 | _BIT3 | _BIT2), _BIT4);

    // [5] Enable High DC Gain
    ...
    else if((GET_INPUT_PIXEL_CLK() >= 1800) && (GET_INPUT_PIXEL_CLK() < 3400)) // 1800 ~ 3400MHz
    {
    ...
    // [0] Disable Servo Loop Adaptation
    ScalerSetBit_EXINT0(PB_A4_CDR_2, ~_BIT0, 0x00);
    ...
    // Enable adaptation 
    if(GET_INPUT_PIXEL_CLK() > 1100) // High Freq.
    {
    ...
    if(GET_INPUT_PIXEL_CLK() > 1100)
    {
        ...
        if(ucTemp == 0xFF)
        {
            ...
            // [4:2] Enable Stage1/2/3 High Boost Mode
            ScalerSetBit_EXINT0(PB_A4_CDR_2, ~(_BIT4 | _BIT3 | _BIT2), (_BIT4 | _BIT3 | _BIT2));
    ...
    { 
        ...
        ScalerSetByte_EXINT0(P1D_A5_L0_INIT_3, 0x0C); 
        ScalerSetByte_EXINT0(P1D_A6_L0_INIT_4, 0x00);                     
        ScalerSetByte_EXINT0(P1D_A9_L0_INIT_7, 0x04);  
    
        // Load Intial DFE Code (LE, Vth, Tap2, Tap1, Tap0)
        ScalerSetByte_EXINT0(P1D_AA_L0_INIT_8, 0xC3);
        ScalerSetByte_EXINT0(P1D_AA_L0_INIT_8, 0x00);
    ...
    { 
        ...
        ScalerSetByte_EXINT0(P1D_B5_L1_INIT_3, 0x0C); 
        ScalerSetByte_EXINT0(P1D_B6_L1_INIT_4, 0x00);                     
        ScalerSetByte_EXINT0(P1D_B9_L1_INIT_7, 0x04);     
    
        // Load Intial DFE Code (LE, Vth, Tap2, Tap1, Tap0)
        ScalerSetByte_EXINT0(P1D_BA_L1_INIT_8, 0xC3);
        ScalerSetByte_EXINT0(P1D_BA_L1_INIT_8, 0x00);
    ...
    { 
        ...
        ScalerSetByte_EXINT0(P1D_C5_L2_INIT_3, 0x0C); 
        ScalerSetByte_EXINT0(P1D_C6_L2_INIT_4, 0x00);                     
        ScalerSetByte_EXINT0(P1D_C9_L2_INIT_7, 0x04);     
    
        // Load Intial DFE Code (LE, Vth, Tap2, Tap1, Tap0)
        ScalerSetByte_EXINT0(P1D_CA_L2_INIT_8, 0xC3);
        ScalerSetByte_EXINT0(P1D_CA_L2_INIT_8, 0x00);
    ...
    if((ucLoop[0] | ucLoop[1] | ucLoop[2]) != 0x00)
    {
        // Disable Reduce DFE Gain
        ScalerSetBit_EXINT0(P1D_A0_L0_DFE_EN_1, ~(_BIT5 | _BIT4), 0x00);
        ScalerSetBit_EXINT0(P1D_B0_L1_DFE_EN_1, ~(_BIT5 | _BIT4), 0x00);
        ScalerSetBit_EXINT0(P1D_C0_L2_DFE_EN_1, ~(_BIT5 | _BIT4), 0x00);
        ...
        // Enable Adaptation
        ScalerSetByte_EXINT0(P1D_A1_L0_DFE_EN_2, ucLoop[0]);
        ScalerSetByte_EXINT0(P1D_B1_L1_DFE_EN_2, ucLoop[1]);
        ScalerSetByte_EXINT0(P1D_C1_L2_DFE_EN_2, ucLoop[2]);   
...
{  
    if(bWait == _WAIT)
    {
        ...
        {
            SET_HDMI_3D_INFO_RECEIVED();
        }
        else
        {
            CLR_HDMI_3D_INFO_RECEIVED();
        }
#endif
...
#if(_3D_SUPPORT == _ON)
//--------------------------------------------------
// Description  : GET HDMI 3D Format
// Input Value  : None
// Output Value : HDMI 3D Format
//--------------------------------------------------
BYTE ScalerTmdsHdmiGet3DFormat(void)
{
    if(ScalerGetBit(P1B_A0_HDMI_VIDEO_FORMAT, (_BIT7 | _BIT6 | _BIT5)) == _BIT6)
    {    
        switch(((ScalerGetByte(P1B_A3_HDMI_3D_FORMAT1)) & 0xF0)) // 3D structure
        {
            case 0x00:

                return _FRAME_PACKING;        

            case 0x60:

                return _TOP_AND_BOTTOM;        

            case 0x80:

                return _SIDE_BY_SIDE_HALF;
