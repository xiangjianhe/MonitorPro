...
#if(_PCB_TYPE == _PCB_TPV_715G7799_6336_AD)
...
// NC(EE_WP)
#define _PIN_23                                 (2 & 0x07) // Page 10-0xA2[2:0]
...
//--------------------------------------------------
//NC(«O¯d)
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin 68, PC.1
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin 22, PC.4

//Panel IIC
#define bSWIIC_SYS_PANEL_SCL                   (MCU_PORT66_PIN_REG_FFCD) // Pin 31, P6.6
#define bSWIIC_SYS_PANEL_SDA                   (MCU_PORT67_PIN_REG_FFCE) // Pin 32, P6.7
...
//-----------------------------------------------
//NC 
#define bEEPROM_WRITE_PROTECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin 23, PB.7
...
#define bD1_CONNECT                             (MCU_PORT_PB0_PIN_REG_FF8F)//// Pin 21, PB.0(MCU_PORTC4_PIN_REG_FFA4) // Pin 22, PC.4
...
#if((_PROJECT == _PRJ_L_E2224_AD_INL_M215HNE_L30) || (_PROJECT == _PRJ_L_E2224_AD_SAMSUNG_LTM215HP01)||(_PROJECT == _PRJ_L_T2220_1A1D_INL_M215HNE_L30))
