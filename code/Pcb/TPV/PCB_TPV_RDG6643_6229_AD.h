...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PCB_TPV_RDG6643_6229_AD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _PCB_TPV_RDG6643_6229_AD)
...
#if(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K)//ada.chen 20131130_1 add
...
// CABLE_DET
#define _PIN_53                                 (3 & 0x07) // Page 10-0xA5[7:6]
...
// DET_DVI5V
#define _PIN_112                                (0 & 0x0F) // Page 10-0xAE[2:0]
...
// DET_VGA5V
#define _PIN_113                                (0 & 0x0F) // Page 10-0xB0[7:5]
...
// NC Pin
#define _PIN_122                                (2 & 0x07) // Page 10-0xB0[1:0]
...
// Panel VCOM
#define bPANELI2CSCL                            (MCU_PORT_PB6_PIN_REG_FF89) // Pin 42
#define bPANELI2CSDA                            (MCU_PORT_PB5_PIN_REG_FF8A) // Pin 43
...
//-----------------------------------------------
/*
#define bA0_CONNECT                             (MCU_PORT60_PIN_REG_FFC7) 
...
//-----------------------------------------------
#define bD1_HPD                                 (MCU_PORT_PB2_PIN_REG_FF8D)       //pin46
...
#if 1//Robert Wang 20131112 for six key

#if 0//Robert Wang 20131212
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x77 <= ucV1) && (ucV1 < 0x88))    \
                                                                    ucKeyState |= _MENU_KEY_MASK;      \
                                                                                                       \
                                                                if((0x77 <= ucV2) && (ucV2 < 0x88))     \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;      \
                                                                                                       \
                                                                if(0x00 == IO_PowerKey)                \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x66 <= ucV1) && (ucV1 < 0x75))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x66 <= ucV2) && (ucV2 < 0x75))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK;     \
                                                                                                        \
                                                                if((0xB2 <= ucV1) && (ucV1 < 0xBF))    \
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if(0x00 == IO_PowerKey)                \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x47 <= ucV1) && (ucV1 < 0x75))    \            
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x47 <= ucV2) && (ucV2 < 0x75))    \             
                                                                    ucKeyState |= _LEFT_KEY_MASK;     \
                                                                                                        \
                                                                if((0xB2 <= ucV1) && (ucV1 < 0xBF))    \
                                                                    ucKeyState |= _SOURCE_KEY_MASK;      \
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if(0x00 == IO_PowerKey)                \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x45 <= ucV1) && (ucV1 < 0x70))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x45 <= ucV2) && (ucV2 < 0x70))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK;     \
                                                            }
#endif
...
#endif // End of #if(_PCB_TYPE == _PCB_TPV_RDG6643_6229_AD)
