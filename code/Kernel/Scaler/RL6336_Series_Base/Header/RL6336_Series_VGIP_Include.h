...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6336_Series_VGIP_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define SET_HS_DELAY_LATCH_EDGE()                   {\
                                                        ScalerSetBit(CM_12_VGIP_DELAY_CTRL, ~_BIT3, _BIT3);\
...
#define SAVE_HS_DELAY_SETTING(pucBackup)            {\
                                                        ...
                                                        pucBackup[3] = ScalerGetBit(P1_CA_SSCG_0, _BIT7);\
...
#define LOAD_HS_DELAY_SETTING(pucBackup)            {\
                                                        ...
                                                        ScalerSetBit(P1_CA_SSCG_0, ~_BIT7, (pucBackup[3] & _BIT7));\
...
#endif // End of #ifndef __RL6336_SERIES_VGIP__
