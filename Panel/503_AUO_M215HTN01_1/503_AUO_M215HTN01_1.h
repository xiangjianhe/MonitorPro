...
#if(_PANEL_TYPE == _FOX_AUO_M215HTN01_1)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         2072//2100                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2200                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     2068                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1818                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      143                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  188                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  113                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      35//10                  // Panel Power On T1 (ms)//Eli 20120810 modify power sequence issue.
#define _PANEL_POWER_ON_T2                      25                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      550                 // Panel Power On T3 (ms)//Eli 20120522 modify T3-T4
...
#endif // End of #if(_PANEL_TYPE == _FOX_AUO_M215HTN01_1)
