...
#define _FACTORY_ITEM_1_START                       (_FACTORY_PAGE_1_START)
#define _FACTORY_ITEM_1_END                         (_FACTORY_ITEM_1_START + 3)
...
#define _FACTORY_ITEM_5_END                         (_FACTORY_ITEM_5_START + 3)
...
#define _FACTORY_R_NUMBER_COL                       11
#define _FACTORY_G_NUMBER_COL                       17
#define _FACTORY_B_NUMBER_COL                       23
...
#define _FACTORY_OSD_PAGE_NUMBER_COL                9
#define _FACTORY_SSC_NUMBER_COL                     9
#define _FACTORY_LVDS_NUMBER_COL                    9
#define _FACTORY_PATTERN_NUMBER_COL                 9

#define _FACTORY_HOT_PLUG_OPTION_VALUE__COL         13
...
//extern BYTE code _FACTORY_PAGE_SELECT_ITEM_TABLE[][2];
//****************************************************************************
// FUNCTION EXTERN of FactoryMode.c
//****************************************************************************
extern BYTE xdata g_ucFactoryPage;
extern BYTE xdata g_ucBgColorR;
extern BYTE xdata g_ucBgColorG;
extern BYTE xdata g_ucBgColorB;
extern BYTE xdata g_ucAutoColotTypeFontPointer;

//----------------------------------------------------------------------------------------
// Extern functions from FactoryMode.c
//----------------------------------------------------------------------------------------
#ifndef __FACTORY_MODE__
...
extern void RTDFactoryOsdLoadHardwareVLCFont(BYTE *pArray, WORD usOffset, WORD usFontTableStart, bit bOsdRotate);
extern void RTDFactoryOsdFuncClearOsdFont(BYTE ucRow, BYTE ucCol, BYTE ucWidth , BYTE ucHeight, BYTE ucChar);
extern void RTDFactoryOsdFuncPutStringProp(BYTE ucRow, BYTE ucCol, BYTE ucFptsSelect, BYTE *pFontTable, BYTE *pArray, BYTE ucLanguage);
extern void RTDFactoryOsdFuncDrawWindow(BYTE *pArray, WORD usXStart, WORD usYStart, WORD usXEnd, WORD usYEnd, BYTE ucColor);
extern void RTDFactoryOsdFuncEnableOsd(void);
extern void RTDFactoryOsdFuncShowNumber(BYTE ucRow, BYTE ucCol, DWORD usValue, BYTE ucPar ,BYTE ucFontPoint);
extern void RTDFactoryOsdFuncSelectItem(BYTE ucOsdState);
extern void RTDFactoryOsdFuncChangeColor1Bit(BYTE ucRow, BYTE ucCol, BYTE ucWidth , BYTE ucHeight, BYTE ucColor);
extern void RTDFactoryOsdDispNumber(BYTE ucOsdState,WORD ucValue);
