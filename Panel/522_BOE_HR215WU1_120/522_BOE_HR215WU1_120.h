...
#if(_PANEL_TYPE == _FOX_BOE_HR215WU1_120)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MAX                     2400                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     2120                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      149                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  187                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  115                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      25                  // Panel Power On T1 (ms)//Eli 20120810 modify power sequence issue.
...
#endif // End of #if(_PANEL_TYPE == _FOX_LG_LM215WF4_TLG1)
