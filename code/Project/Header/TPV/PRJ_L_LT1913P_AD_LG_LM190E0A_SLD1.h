...
#if(_PROJECT == _PRJ_L_LT1913P_AD_LG_LM190E0A_SLD1)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                              _PCB_TPV_715G8182_6229_AD


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM190E0A_SLD1
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT1913P_AD_6229.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT1913P)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT1913P)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME												_bL_,_bT_, _1_, _9_, _1_, _3_, _bP_
#define _MICROCODE												_bL_,_bG_, _0_, _DOT, _2_

#define _FACTORY_PROJECT_NAME                                   _L,_T,_1,_9,_1,_3,_P
#define _FW_RELEASE_DATE                                        _2,_0,_1,_6,_0,_7,_1,_1
#define _FW_VERSION                                             _L,_G, _0, _DOT, _2
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.02	

#define _PANNEL_NAME 											'L','M','1','9','0','E','0','A'
...
//==================================================================
#define _OD_NORMAL_GAIN											0x43

//==================================================================
// Brightness PWM Table
//==================================================================
#define _PWM_B00                                                70 //|00
#define _PWM_B10                                                89//78 //|10
#define _PWM_B20                                                108//85 //|20
#define _PWM_B30                                                127//120 //|30
#define _PWM_B40                                                146//130 //|40
#define _PWM_B50                                                165//145 //|50
#define _PWM_B60                                                184//160 //|60
#define _PWM_B70                                                204//175 //|70
#define _PWM_B80                                                224//205 //|80
#define _PWM_B90                                                240//229 //|90
...
#define _BACKLIGHT_PWM_FREQ_SELECT                            _PWMFREQ22K //_PWMFREQ22K _PWMFREQIVF
...
#endif // End of #if(_PROJECT == _PRJ_L_GrayOSD_RL6229_DEMO)
