...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6297_QA_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6297_QA_1A1H1DP)
...
#define _INPUT_PORT_SEARCH_PRI_5                _VI_INPUT_PORT
...
// NC Pin
#define _PIN_72                                 (0 & 0x0F) // Page 10-0xE1[3:0]
...
//-----------------------------------------------
#define bDP_PIN15_CONNECT                       (MCU_PORT63_PIN_REG_FFCA) // Pin 53, P6.3
#define bDP_PIN16_CONNECT                       (MCU_PORT76_PIN_REG_FFD5) // Pin 102, P7.6
#define bDP_PIN17_CONNECT                       (MCU_PORT61_PIN_REG_FFC8) // Pin 51, P6.1
...
#define bD1_CONNECT                             (MCU_PORT75_PIN_REG_FFD4) // Pin 103, P7.5
...
#endif // End of #if(_PCB_TYPE == _RL6297_QA_1A1H1DP)
