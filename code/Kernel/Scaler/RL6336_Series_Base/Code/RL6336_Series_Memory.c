...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6336_Series_Memory.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6336_SERIES_MEMORY__
...
{   
    ...
    // Disable Coefficient Access (6336_DOUBLE_CHECK)
...
void ScalerMemorySetFIFOFreq(EnumScalerFIFOFreq enFIFOFreq)
{
    switch(enFIFOFreq)
    {
        ...
        case _SCALER_FIFO_FREQ_MPLL: // 6336 do not have MPLL
            break;
...
{        
    ...
    {        
        if(GET_V_SCALE_DOWN() == _TRUE)    // Vertical Scaling Down (3-line)
        {
