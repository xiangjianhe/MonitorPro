...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Demo_1A1DVI1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6229_DEMO_1A1DVI1DP)
...
// DVI_HOT_PLUG
#define _PIN_111                                (2 & 0x0F) // Page 10-0xAE[6:4]
...
//-----------------------------------------------
sbit bD0_HPD                                    = P3 ^ 5; // Pin 112, P3.5 for DP
#define _D0_HOT_PLUG_HIGH                       1       // D1 Switch High state
#define _D0_HOT_PLUG_LOW                        0       // D1 Switch Low state
...
#define _D1_HOT_PLUG_HIGH                       1       // D0 Switch High state
#define _D1_HOT_PLUG_LOW                        0       // D0 Switch Low state
...
#endif // End of #if(_PCB_TYPE == _RL6229_DEMO_1A1DVI1DP)
