...
#if(_PROJECT == _RTD2487HTD_WISTRON_NDP_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RTD2487HTD_WISTRON_1A1MHL1NDP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _CMI_M215HGE_LVDS_21_5_WUXGA
...
#define _CODEC_CX2070X_SUPPORT                                  _OFF
...
//--------------------------------------------------                                      
#define _640_X_350_V_HEIGHT                                     350
...
#define _AIN_AUDIO_VOL_FIXED                                    0x28//. max:0x3F
#define _DAC_AUDIO_VOL_FIXED                                    0x28//. max:0x3F P6_B8,B9

#define _VOLUME_MAX                                             176
#define _VOLUME_MIN                                             0
#define _VOLUME_DEFAULT_PWM                                     160
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      2    // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
#define _SOURCE_DEFAULT_SEARCH_TIME_TMDS                        ((PCB_D0_MHL_DETECT() == _TMDS_MHL_MODE)?SEC(5):SEC(2))
...
#define _MHL_PP_MODE_SUPPORT                                    _OFF
#define _MHL_UCP_SUPPORT                                        _OFF//Thomas 20130710 MHL CTS 
#define _MHL_AUD_CHANNEL                                        _MHL_AUD_2CH
#define _MHL_ADOPTER_ID                                         0x027E
#define _MHL_DEVICE_ID                                          0x60A9
...
//----------------------------------------------------------------------------------------------------
// Definitions for OSD Audio Type setting
//----------------------------------------------------------------------------------------------------
#define _AUDIO_IN_MAINMENU                                      0
#define _AUDIO_OUT_MAINMENU                                     1
#define _AUDIO_NO_MENU                                          2

#define _OSD_AUDIO_TYPE                                         _AUDIO_IN_MAINMENU

//----------------------------------------------------------------------------------------------------
// Definitions for OSD LINEIN setting
//----------------------------------------------------------------------------------------------------
#define _OSD_LINEIN_SUPPORT                                 _OFF


//==================================================================
//_b0_~_b9_ only for Lenovo Green OSD
//==================================================================
#define _IC_SERIES                                              _R,_T,_D,_2,_2,_7,_1,_C,_L
#define _MODEL_NAME								                _bL_, _bT_, _bp_
#define _MICROCODE							                    _bL_,_bA_, _DOT

#define _FACTORY_PROJECT_NAME                                   _L,_T,_1,_7,_1,_3
#define _FACTORY_PANNEL_NAME				                    _C,_M,_I,_SPACE,_M,_2,_3,_6,_H,_G,_E
#define _FW_RELEASE_DATE                                        _2,_0,_1,_3,_1,_2,_1,_8
...
#define _EDID_VERSION_CODE                                      0xD8//0xF8
#define _EDID_TYPE_ARRAY                                        {_EDID_VGA,_EDID_HDMI}
#define _EDID_TYPE_SIZE                                         {256,256}                        

#define _EDID_CHKSUM_SIZE                                       10

#if(_PANEL_TYPE == _CMI_M236HGE_LVDS_23_5_WUXGA)
#define _PANEL_NAME                                             _C,_M,_I,_SPACE,_M,_2,_3,_6,_H,_G,_E
#else
#define _PANEL_NAME                                             _P,_A,_N,_E,_L
#endif

//==================================================================
//  For Lenovo User Define
//==================================================================
...
#define _Brand_SET_LENOVO_LI                                    0
#define _Brand_SET_LENOVO_LC                                    1
#define _Brand_SET                                              _Brand_SET_LENOVO_LI

#if(_Brand_SET == _Brand_SET_LENOVO_LI)
#define _LANGUAGE_DEFAULT                                       _ENGLISH
#define _EDID_SN_SIZE                                           20

#elif(_Brand_SET == _Brand_SET_LENOVO_LC)
#define _LANGUAGE_DEFAULT                                       _CHINESE_S
#define _EDID_SN_SIZE                                           15
#endif
...
#define DEF_CONTRAST_RATIO                                      99//101 // 1.00(unit 1/100)
#define MIN_CONTRAST_RATIO                                      40  // 0.5(unit 1/100)
#define _OSD_CONTRAST_DEF_VALUE                                 85  //_CONTRAST_VGA
#define _OSD_BRIGHTNESS_DEF_VALUE              	                80
#define _OSD_AUDIO_DEF_VALUE              	                    50
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   (95)
#define _CT7200_LenovoPrj_GREEN                                 (96)
#define _CT7200_LenovoPrj_BLUE                                  (100)

#define _CTSRGB_LenovoPrj_RED                                   (96)
#define _CTSRGB_LenovoPrj_GREEN                                 (96)
#define _CTSRGB_LenovoPrj_BLUE                                  (100)

#define _CT6500_LenovoPrj_RED                                   (100)
#define _CT6500_LenovoPrj_GREEN                                 (100)
#define _CT6500_LenovoPrj_BLUE                                  (100)

#define _CT9300_LenovoPrj_RED                                   (85)
#define _CT9300_LenovoPrj_GREEN                                 (89)
#define _CT9300_LenovoPrj_BLUE                                  (100)

#define _CTUSER_LenovoPrj_RED                                   (100)
#define _CTUSER_LenovoPrj_GREEN                                 (100)
#define _CTUSER_LenovoPrj_BLUE                                  (100)
...
#endif // End of #if(_PROJECT == _RTD2487HTD_WISTRON_2DP_PROJECT)
