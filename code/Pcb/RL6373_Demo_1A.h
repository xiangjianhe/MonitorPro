...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6373_DEMO_1A.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6373_DEMO_1A)
...
// EDID_WP
#define _PIN_19                                      (1 & 0x07) // Page 10-0xA2[2:0]
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORT56_PIN_REG_FFC5) //TQFP Pin 19, P5.0
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_PORT56_PIN_REG_FFC5)  // None
#define bLED2                                   (MCU_PORT56_PIN_REG_FFC5)  // None
...
#define PCB_LED_OFF()                           {\
                                                    ScalerSLPLedLevelMode(_LED_OFF); \
                                                }
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if(ucV3 == 0x01)                        \
                                                                    ucKeyState |= _POWER_KEY_MASK;      \
                                                                                                        \
                                                                if((0x06 <= ucV2) && (ucV2 < 0x0A))     \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;       \
                                                                                                        \
                                                                if((0x0B <= ucV2) && (ucV2 < 0x0F))     \
                                                                    ucKeyState |= _LEFT_KEY_MASK;       \
                                                                                                        \
                                                                if((0x12 <= ucV2) && (ucV2 < 0x16))     \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                        \
                                                                if((0x18 <= ucV2) && (ucV2 < 0x1C))     \
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_PORT62_PIN_REG_FFC9)   // TQFP Pin28, P6.2
...
#define bBACKLIGHTPOWER                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)    //none
...
#endif // End of #if(_PCB_TYPE == _RL6373_DEMO_1A)
