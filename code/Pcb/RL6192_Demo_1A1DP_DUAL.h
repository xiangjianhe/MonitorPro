...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_Demo_1A1DP_DUAL.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6192_DEMO_1A1DP_DUAL)
...
// IIS SD3
#define _PIN_71                                 (3 & 0x07) // Page 10-0xA7[2:0]
...
// LED2
#define _PIN_109                                (2 & 0x07) // Page 10-0xAD[6:4]
...
#define PCB_D1_DP_DUAL_HDMI_SETTING()           { \
                                                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00); \
                                                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT4); \
                                                }

#define PCB_D1_DP_DUAL_DP_SETTING()             { \
                                                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT4); \
                                                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)); \
                                                }
...
#endif // End of #if(_PCB_TYPE == _RL6192_DEMO_1A1DP_DUAL)
