...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2483AD_WISTRON_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PROJECT == _RTD2483AD_WISTRON_PROJECT)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RTD2483AD_WISTRON_1A1H


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _M240HTN01_LVDS_24_WUXGA//_AU_LVDS_24_WUXGA
...
//    LENOVO2011Function/LENOVO2011Osd/LENOVOFactory                                             //
...
#define _ANALOG_VOLUME_MAX                                      0x0028 // MAX: 0x0037
#define _ANALOG_VOLUME_MIN                                      0x0000
#define _ANALOG_VOLUME_CENTER                                   ((_ANALOG_VOLUME_MAX + _ANALOG_VOLUME_MIN) / 2)

#define _DIGITAL_VOLUME_MAX                                     0x0030 // _AUDIO_VOLUME_8BIT MAX:0x00FF
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      5//6    // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
/*//Eli 20121216 update STD code. 
 ...
 && ((_SYSTEM_EEPROM_EMULATION_END_PAGE >= _OGC_FLASH_PAGE) && (_SYSTEM_EEPROM_EMULATION_START_PAGE < _OGC_FLASH_PAGE + 3)))
...
#define _AUTO_PBPR_GAIN_BIAS                                    (6)
#define _AUTO_PBPR_OFFSET_BIAS                                  (-5)
...
// TMDS CTS Options  
//--------------------------------------------------
#define _TMDS_HDCP_FEATURE                                      _HDCP_FEATURE_BY_INPUT //CTS Check
#define _TMDS_Z0_POWER_SAVING_OPTION                            _ONLY_CLK_CHANNEL_CONNECTED_FOR_PS  //CTS Check
...
#define _INSTANT_TIMER_EVENT_1                                  10
//Eli 20121129 H9CMT178GTG1HN-7 DCR issue.
#define _BACKLIGHT_OFF_TIMER                                    1500 // 3 Min = 18000 * _INSTANT_TIMER_EVENT_1 
#else
