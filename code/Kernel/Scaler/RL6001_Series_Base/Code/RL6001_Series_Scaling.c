...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Series_Scaling.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6001_SERIES_SCALING__
...
void ScalerScalingGetFIFOScalingSize(StructSDRAMDataInfo* pstData)
{
    ...
    DebugMessageScaler("usMemoryRemainBW", usMemoryRemainBW);
    DebugMessageScaler("usMemoryRemainSpace", usMemoryRemainSpace);
    ...
    DebugMessageScaler("usHSDSpace", usHSDSpace);
    DebugMessageScaler("usHSDBW", usHSDBW);
