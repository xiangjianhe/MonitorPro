...
#if(_PANEL_TYPE == _TPV_LNT_LM195WX1_S2A1)
//----------------------------------------------------------------------------------------------------
...
#define _D_DITHER_TEMP                          _DISABLE//_ENABLE                // Definitions of D-Temporal Dithering
...
#define _PANEL_DV_TOTAL_MAX                     1020                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  132                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  87                  // Mininum Pixel Clock in MHz
...
#endif // End of #if(_PANEL_TYPE == _TPV_LNT_LM195WX1_S2A1)
