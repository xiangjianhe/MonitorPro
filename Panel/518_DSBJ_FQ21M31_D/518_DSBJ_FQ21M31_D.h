...
#if(_PANEL_TYPE == _FOX_DSBJ_FQ21M31_D)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MAX                     2150                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1984                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1170                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1084                // Mininum Display Vertical Total Clock Number in One Display Line
...
#endif // End of #if(_PANEL_TYPE == _FOX_DSBJ_FQ21M31)
