...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Demo_76Pin_1A1DVI.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _PCB_TPV_715G7826_6229_A)
...
#define _D1_INPUT_PORT_TYPE                     _D1_NO_PORT//_D1_DVI_PORT
#define _D1_DDC_CHANNEL_SEL                     _NO_DDC//_DDC3
...
#if((_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ22K)||(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K))  //ada.chen 20140610 modify backlight PWM freq= 22k
...
// V5A     NC
#define _76PIN_PIN_29                                 (1 & 0x07) // Page 10-0xD0[2:0]
// 0 ~ 6 (0: P6D2i<I>, 1: P6D2o<PP>, 2: P6D2o<OD>, 3: ADCA2<I>, 4: TEST_PIN0<O>, 5: TEST_PIN1<O>, 6: DUMMY<O>)

// DET  VGA
#define _76PIN_PIN_30                                 (0 & 0x0F) // Page 10-0xD3[3:0]
...
// POWER_KEY#
#define _76PIN_PIN_59                                 (0 & 0x0F) // Page 10-0xF0[3:0]
...
// DVI HPD    NC
#define _76PIN_PIN_61                                 (1 & 0x0F) // Page 10-0xF2[3:0]
...
#define PCB_GPIO_INITIAL_SETTING()              {\
													ScalerSetBit(P10_B4_PIN_DRIVING_CTRL2, ~(_BIT4), (_BIT4));\
...
#if(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ22K)    //ada.chen 20140610 modify backlight PWM freq= 22k
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 22000); \
                                                }
#elif(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K) //jason.cheng 20140808_1 add
#define PCB_PWM_SETTING()                       {\
...
// Macro of IIC
//--------------------------------------------------
sbit bSWIIC_SYS_EEPROM_SCL                       = P3^4;  //pin P3.4
#define bSWIIC_SYS_EEPROM_SDA     				(MCU_PORTC4_PIN_REG_FFA4)//Pin 22 Pc.4

sbit bDDC1IICSCL                                = P3^0;                   // Pin 33
sbit bDDC1IICSDA                                = P3^1;                   // Pin 34
//#define bDDC3IICSCL                             (MCU_PORT73_PIN_REG_FFD2) // Pin 70
//#define bDDC3IICSDA                             (MCU_PORT72_PIN_REG_FFD1) // Pin 71

// Panel VCOM
#define bPANELI2CSCL                            (MCU_PORT66_PIN_REG_FFCD) // Pin 31
#define bPANELI2CSDA                            (MCU_PORT67_PIN_REG_FFCE) // Pin 32
#if(_PANEL_VCOM_ADJUST_FUNCTION == _ON)

#define PCB_PANEL_VCOM(x)						{\
                                                    bPANELI2CSCL = x;                \
                                                    bPANELI2CSDA = x;                \
                                                }
#else
...
#define PCB_SW_IIC_SDA_SET()                    {\
													...
													else if(GET_SW_IIC_STATUS() == _IIC_FOR_MISC)   \
													{										   \
														bPANELI2CSDA = _TRUE;		   		   \
													}										   \
                                                }
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORTC3_PIN_REG_FFA0)//(MCU_PORT65_PIN_REG_FFCC)    // Pin 37, Pc.3
...
//-----------------------------------------------
#define bA0_CONNECT                             (MCU_PORT65_PIN_REG_FFCC) // Pin 30, P6.5
...
// Macro of LED On/Off
//--------------------------------------------------
#if((_PROJECT == _PRJ_L_E2054_A_LNT_LM195WX1_S2A1) || (_PROJECT == _PRJ_L_E2054_A_LNT_LM195WX1_S1C1)|| (_PROJECT == _PRJ_L_E2054_A_BOE_MV195WGM_N10))

#define bLED1                                   (MCU_PORT_PB5_PIN_REG_FF8A) // Pin 25, PB.5
#define bLED2                                   (MCU_PORT_PB6_PIN_REG_FF89) // Pin 24, PB.6

#elif((_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S2A1) || (_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S1C1)|| (_PROJECT == _PRJ_L_LI2054_A_BOE_MV195WGM_N10) || (_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S2A1_ABL) || (_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S1C1_ABL) || (_PROJECT == _PRJ_L_LI2054_A_BOE_MV195WGM_N10_ABL))

#define bLED1                                   (MCU_PORT_PB6_PIN_REG_FF89) // Pin 24, PB.6
#define bLED2                                   (MCU_PORT_PB5_PIN_REG_FF8A) // Pin 25, PB.5
...
sbit IO_PowerKey                                =P3 ^ 3;                        // Pin 59

#define PCB_ADKEY0()                            (_FALSE)
#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
#define PCB_ADKEY3()                            (_FALSE)
/*     //for E2054 SIT samples   //richer.chen
#if(_PROJECT == _PRJ_L_E2054_A_LNT_LM195WX1_S2A1)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
																if((0x45 <= ucV1) && (ucV1 < 0x60))    \
																	ucKeyState |= _EXIT_KEY_MASK;	   \
																									   \
																if((0x61 <= ucV1) && (ucV1 < 0x80))    \
																	ucKeyState |= _RIGHT_KEY_MASK;	   \
																									   \
																if(0x00 == IO_PowerKey) 			   \
																	ucKeyState |= _POWER_KEY_MASK;	   \
																									   \
																if((0x45 <= ucV2) && (ucV2 < 0x60))    \
																	ucKeyState |= _MENU_KEY_MASK;	   \
																									   \
																if((0x61 <= ucV2) && (ucV2 < 0x80))    \
																	ucKeyState |= _LEFT_KEY_MASK;	   \
																									   \
																if((0x2B <= ucV2) && (ucV2 < 0x44))    \
																	ucKeyState |= _MENU_LEFT_KEY_MASK; \
                                                            }
*/
#if((_PROJECT == _PRJ_L_E2054_A_LNT_LM195WX1_S2A1)||(_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S2A1_ABL)||(_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S2A1)\
		||(_PROJECT == _PRJ_L_E2054_A_LNT_LM195WX1_S1C1) || (_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S1C1_ABL) || (_PROJECT == _PRJ_L_LI2054_A_LNT_LM195WX1_S1C1)\
		||(_PROJECT == _PRJ_L_E2054_A_BOE_MV195WGM_N10) || (_PROJECT == _PRJ_L_LI2054_A_BOE_MV195WGM_N10) || (_PROJECT == _PRJ_L_LI2054_A_BOE_MV195WGM_N10_ABL))
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
																if((0x4D <= ucV1) && (ucV1 < 0x62))    \
																	ucKeyState |= _EXIT_KEY_MASK;	   \
																									   \
																if((0x64 <= ucV1) && (ucV1 < 0x7A))    \
																	ucKeyState |=  _LEFT_KEY_MASK;		\
																									   \
																if(0x00 == IO_PowerKey) 			   \
																	ucKeyState |= _POWER_KEY_MASK;	   \
																									   \
																if((0x4D <= ucV2) && (ucV2 < 0x62))    \
																	ucKeyState |= _RIGHT_KEY_MASK;	   \
																									   \
																if((0x64 <= ucV2) && (ucV2 < 0x7A))    \
																	ucKeyState |=  _MENU_KEY_MASK ;	   \
																									   \
                                                            }
...
#define PCB_GET_BACKLIGHT_POWER_STATUS()        bBACKLIGHTPOWER //Eli Add.

#define PCB_BACKLIGHT_POWER_PIN(x)              {\
                                                    bBACKLIGHTPOWER = x; \
                                                }
#if(_PANEL_VCOM_ADJUST_FUNCTION == _ON)//ada.chen 20150710
...
#elif(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K)
#define PCB_BACKLIGHT_POWER(x)                  {\
													if(x == _LIGHT_CONTROL_ON)\
													{\
														ScalerTimerActiveTimerEvent(SEC(60), _USER_TIMER_EVENT_PANEL_USED_TIMER);\
...
#endif // End of #if(_PCB_TYPE == _PCB_TPV_715G7799_6229_AD)
