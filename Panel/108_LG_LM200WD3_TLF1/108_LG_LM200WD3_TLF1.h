...
#if(_PANEL_TYPE == _TPV_LG_LM200WD3_TLF1)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MIN                     1712                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         1000                // Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  136                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  86                  // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      10                  // Panel Power On T1 (ms)//Eli 20120810 modify power sequence issue.
#define _PANEL_POWER_ON_T2                      10                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      530                 // Panel Power On T3 (ms)//Eli 20120522 modify T3-T4

#define _PANEL_POWER_OFF_T4                     220                 // Panel Power Off T4 (ms)//Eli 20120522 modify T3-T4
#define _PANEL_POWER_OFF_T5                     5                   // Panel Power Off T5 (ms)
#define _PANEL_POWER_OFF_T6                     1010                // Panel Power Off T6 (ms)

//----------------------------------------------------------------------------------------------------
// Default Contrast Finetune Value
//----------------------------------------------------------------------------------------------------
#define _DEFAULT_CONTRAST_FINETUNE_VALUE_VGA        78
#define _DEFAULT_CONTRAST_FINETUNE_VALUE_DVI        78
...
#endif // End of #if(_PANEL_TYPE == _TPV_LG_LM200WD3_TLF1)
