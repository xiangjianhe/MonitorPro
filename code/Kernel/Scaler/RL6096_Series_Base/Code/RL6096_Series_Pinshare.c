...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6096_Series_Pinshare.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6096_SERIES_PINSHARE__
...
void ScalerPinshareInitial(void)
{
    ...
    ScalerSetByte(P10_AD_PIN_SHARE_CTRL0D, ((BYTE)_PIN_109 << 4) | (_PIN_110)); // Page 10-AD Pin110~114 Mirror,109,110
...
// Check if pin 123-124 are assigned to DDC2
    ...
    ScalerSetBit(P10_B9_PIN_SHARE_CTRL16, ~(_BIT1 | _BIT0), (_PIN_40)); // Page 10-B9 Pin 40
...
void ScalerPinshareAdjustConfig(EnumConfigPin enumConfigPin, EnumPinConfigTyte enumConfigTyte)
{
    switch(enumConfigPin)
    {
        ...
        case _CONFIG_128PIN_PIN_41:
        case _CONFIG_80PIN_PIN_24:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT7 | _BIT6), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT7 | _BIT6), _BIT6);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT7 | _BIT6), _BIT7);
                    break;
        ...
        case _CONFIG_128PIN_PIN_42:
        case _CONFIG_80PIN_PIN_25:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT5 | _BIT4), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT5 | _BIT4), _BIT4);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT5 | _BIT4), _BIT5);
                    break;
        ...
        case _CONFIG_128PIN_PIN_43:
        case _CONFIG_80PIN_PIN_26:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT3 | _BIT2), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT3 | _BIT2), _BIT2);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A0_PIN_SHARE_CTRL00, ~(_BIT3 | _BIT2), _BIT3);
                    break;
        ...
        case _CONFIG_128PIN_PIN_44:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A8_PIN_SHARE_CTRL08, ~(_BIT7 | _BIT6 | _BIT5), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A8_PIN_SHARE_CTRL08, ~(_BIT7 | _BIT6 | _BIT5), _BIT5);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A8_PIN_SHARE_CTRL08, ~(_BIT7 | _BIT6 | _BIT5), _BIT6);
                    break;
         ...
         case _CONFIG_128PIN_PIN_45:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A1_PIN_SHARE_CTRL01, ~(_BIT7 | _BIT6), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A1_PIN_SHARE_CTRL01, ~(_BIT7 | _BIT6), _BIT6);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A1_PIN_SHARE_CTRL01, ~(_BIT7 | _BIT6), _BIT7);
                    break;

                case _PWM3_OD:
                    ScalerSetBit(P10_A1_PIN_SHARE_CTRL01, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
                    break;
        ...
        case _CONFIG_128PIN_PIN_46:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A3_PIN_SHARE_CTRL03, ~(_BIT7 | _BIT6), 0x00);
                    break;
        ...
        case _CONFIG_128PIN_PIN_47:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A6_PIN_SHARE_CTRL06, ~(_BIT7 | _BIT6), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A6_PIN_SHARE_CTRL06, ~(_BIT7 | _BIT6), _BIT6);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A6_PIN_SHARE_CTRL06, ~(_BIT7 | _BIT6), _BIT7);
                    break;

                case _PWM4_OD:
                    ScalerSetBit(P10_A6_PIN_SHARE_CTRL06, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
                    break;
        ...
        case _CONFIG_128PIN_PIN_48:
        case _CONFIG_80PIN_PIN_27:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT7 | _BIT6), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT7 | _BIT6), _BIT6);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT7 | _BIT6), _BIT7);
                    break;

                case _PWM0_PP:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
                    break;
        ...
        case _CONFIG_128PIN_PIN_56:
        case _CONFIG_80PIN_PIN_32:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AF_PIN_SHARE_CTRL0F, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_AF_PIN_SHARE_CTRL0F, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), _BIT4);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AF_PIN_SHARE_CTRL0F, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), _BIT5);
                    break;
        ...
        case _CONFIG_128PIN_PIN_57:
        case _CONFIG_80PIN_PIN_33:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AF_PIN_SHARE_CTRL0F, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_AF_PIN_SHARE_CTRL0F, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1), _BIT1);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AF_PIN_SHARE_CTRL0F, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1), _BIT2);
                    break;
        ...
        case _CONFIG_128PIN_PIN_64:
        case _CONFIG_80PIN_PIN_40:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A3_PIN_SHARE_CTRL03, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A3_PIN_SHARE_CTRL03, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A3_PIN_SHARE_CTRL03, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;

                case _PWM0_PP:
                    ScalerSetBit(P10_A3_PIN_SHARE_CTRL03, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0),( _BIT2 | _BIT1 | _BIT0));
                    break;

                case _PWM0_OD:
                    ScalerSetBit(P10_A3_PIN_SHARE_CTRL03, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0),(_BIT3 | _BIT0));
                    break;
        ...
        case _CONFIG_128PIN_PIN_65:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~(_BIT7 | _BIT6 | _BIT5), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~(_BIT7 | _BIT6 | _BIT5), _BIT5);
                    break;

                case _PWM1_PP:
                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~(_BIT7 | _BIT6 | _BIT5), _BIT6);
                    break;

                case _PWM1_OD:
                    ScalerSetBit(P10_B1_PIN_SHARE_CTRL11, ~(_BIT7 | _BIT6 | _BIT5), (_BIT7 | _BIT6 | _BIT5));
                    break;
        ...
        case _CONFIG_128PIN_PIN_66:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A4_PIN_SHARE_CTRL04, ~(_BIT5 | _BIT4 | _BIT3), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A4_PIN_SHARE_CTRL04, ~(_BIT5 | _BIT4 | _BIT3), _BIT3);
                    break;
        ...
        case _CONFIG_128PIN_PIN_68:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT5 | _BIT4 | _BIT3), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT5 | _BIT4 | _BIT3), _BIT3);
                    break;
        ...
        case _CONFIG_128PIN_PIN_71:
            ...
            switch(enumConfigTyte)
            {
                ...
                case _PWM1_PP:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));
                    break;
        ...
        case _CONFIG_128PIN_PIN_102:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~(_BIT5 | _BIT4 | _BIT3), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~(_BIT5 | _BIT4 | _BIT3), _BIT3);
                    break;

                case _PWM0_PP:
                    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~(_BIT5 | _BIT4 | _BIT3), (_BIT4 | _BIT3));
                    break;

                case _PWM0_OD:
                    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~(_BIT5 | _BIT4 | _BIT3), (_BIT5 | _BIT4 | _BIT3));
                    break;
        ...
        case _CONFIG_128PIN_PIN_103:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AC_PIN_SHARE_CTRL0C, ~(_BIT6 | _BIT5 | _BIT4), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AC_PIN_SHARE_CTRL0C, ~(_BIT6 | _BIT5 | _BIT4), _BIT4);
                    break;

                case _PWM1_PP:
                    ScalerSetBit(P10_AC_PIN_SHARE_CTRL0C, ~(_BIT6 | _BIT5 | _BIT4), (_BIT5 | _BIT4));
                    break;
        ...
        case _CONFIG_128PIN_PIN_104:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AC_PIN_SHARE_CTRL0C, ~(_BIT3 | _BIT2 | _BIT1), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AC_PIN_SHARE_CTRL0C, ~(_BIT3 | _BIT2 | _BIT1), _BIT1);
                    break;

                case _PWM2_PP:
                    ScalerSetBit(P10_AC_PIN_SHARE_CTRL0C, ~(_BIT3 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
                    break;
        ...
        case _CONFIG_128PIN_PIN_105:
            ...
            switch(enumConfigTyte)
            {
                ...
                case _PWM0_PP:
                    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
                    break;

                case _PWM0_OD:
                    ScalerSetBit(P10_AA_PIN_SHARE_CTRL0A, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
                    break;
        ...
        case _CONFIG_128PIN_PIN_108:
        case _CONFIG_80PIN_PIN_62:
        ...
        case _CONFIG_128PIN_PIN_109:
        case _CONFIG_80PIN_PIN_63:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AD_PIN_SHARE_CTRL0D, ~(_BIT6 | _BIT5 | _BIT4), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AD_PIN_SHARE_CTRL0D, ~(_BIT6 | _BIT5 | _BIT4), _BIT4);
                    break;
        ...
        case _CONFIG_128PIN_PIN_110:
        case _CONFIG_80PIN_PIN_64:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AD_PIN_SHARE_CTRL0D, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_AD_PIN_SHARE_CTRL0D, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AD_PIN_SHARE_CTRL0D, ~(_BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;
        ...
        case _CONFIG_128PIN_PIN_111:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AE_PIN_SHARE_CTRL0E, ~(_BIT6 | _BIT5 | _BIT4), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_AE_PIN_SHARE_CTRL0E, ~(_BIT6 | _BIT5 | _BIT4), _BIT4);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AE_PIN_SHARE_CTRL0E, ~(_BIT6 | _BIT5 | _BIT4), _BIT5);
                    break;
        ...
        case _CONFIG_128PIN_PIN_112:
        case _CONFIG_80PIN_PIN_65:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_AE_PIN_SHARE_CTRL0E, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_AE_PIN_SHARE_CTRL0E, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_AE_PIN_SHARE_CTRL0E, ~(_BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;
        ...
        case _CONFIG_128PIN_PIN_113:
        case _CONFIG_80PIN_PIN_66:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT7 | _BIT6 | _BIT5), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT7 | _BIT6 | _BIT5), _BIT5);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT7 | _BIT6 | _BIT5), _BIT6);
                    break;

                case _PWM3_PP:
                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT7 | _BIT6 | _BIT5), _BIT7);
                    break;

                case _PWM3_OD:
                    ScalerSetBit(P10_B0_PIN_SHARE_CTRL10, ~(_BIT7 | _BIT6 | _BIT5), (_BIT7 | _BIT5));
                    break;
        ...
        case _CONFIG_128PIN_PIN_114:
        case _CONFIG_80PIN_PIN_67:

            switch(enumConfigTyte)
            {
                case _GPI:
                    ScalerSetBit(P10_B2_PIN_SHARE_CTRL12, ~(_BIT4 | _BIT3 | _BIT2), 0x00);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_B2_PIN_SHARE_CTRL12, ~(_BIT4 | _BIT3 | _BIT2), _BIT2);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_B2_PIN_SHARE_CTRL12, ~(_BIT4 | _BIT3 | _BIT2), _BIT3);
                    break;

                case _PWM4_PP:
                    ScalerSetBit(P10_B2_PIN_SHARE_CTRL12, ~(_BIT4 | _BIT3 | _BIT2), (_BIT4 | _BIT3));
                    break;
         ...
         case _CONFIG_128PIN_PIN_126:
            ...
            switch(enumConfigTyte)
            {
                ...
                case _PWM1_PP:
                    ScalerSetBit(P10_A1_PIN_SHARE_CTRL01, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
                    break;

                case _PWM1_OD:
                    ScalerSetBit(P10_A1_PIN_SHARE_CTRL01, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));
                    break;
