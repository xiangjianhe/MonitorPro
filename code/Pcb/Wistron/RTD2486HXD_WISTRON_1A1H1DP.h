...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2486HXD_WISTRON_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RTD2486HXD_WISTRON_1A1H1DP)
...
//--------------------------------------------------
#define _LVDS_DATA_DRIV_CONTROL                 _LVDS_DRIV_CONTROL_2_0                  
#define _LVDS_CLK_DRIV_CONTROL                  _LVDS_DRIV_CONTROL_2_0                   
...
// 0 ~ 8 (0: PDD0i<I>, 1: PDD0o<PP>, 2: PDD0o<OD>, 3: TCON[14]<O>, 4: TEST_PIN0<O>, 5: TEST_PIN1<O>, 6: DUMMY<O>)
...
// NC Pin
#define _PIN_63                                 (1 & 0x0F) // Page 10-0xA6[2:0]
...
// VOLUME
#define _PIN_101                                (3 & 0x0F) // Page 10-0xAB[4:3]
...
// GREEN
#define _PIN_110                                (1 & 0x0F) // Page 10-0xAD[2:0]
...
// 0 ~ 3 (0: P7D1i<I>, 1: P7D1o<PP>, 2: P7D1o<OD>, 3: AUX_CH_N0, 4: TEST_PIN2<O>, 5: TEST_PIN3<O>, 6: DUMMY<O>, 7:DDCSDA2) 

// DDCSCL2
#define _PIN_124                                (7 & 0x07) // Page 10-0xB1[1:0]
// 0 ~ 3 (0: P7D0i<I>, 1: P7D0o<PP>, 2: P7D0o<PP>, 3: AUX_CH_P0, 4: TEST_PIN2<O>, 5: TEST_PIN3<O>, 6: DUMMY<O>, 7:DDCSCL2) 
...
// Macro of IIC
//--------------------------------------------------
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_PORT66_PIN_REG_FFCD) //_PIN_56
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_PORT67_PIN_REG_FFCE) //_PIN_57

sbit bSWIIC_EDID_EEPROM_SCL_VGA                 = P3^0;//_PIN_58
sbit bSWIIC_EDID_EEPROM_SDA_VGA                 = P3^1;//_PIN_59

#define bSWIIC_EDID_EEPROM_SCL_HDMI             (MCU_PORT70_PIN_REG_FFCF)//_PIN_124 
#define bSWIIC_EDID_EEPROM_SDA_HDMI             (MCU_PORT71_PIN_REG_FFD0)//_PIN_123
...
#define HDMI2Host()                             {\
                                                    ...
                                                    SET_SW_IIC_STATUS(_IIC_FOR_DDC2);\
                                                }
...
//-----------------------------------------------
sbit bFLASH_WRITE_PROTECT                       = P3^6;//_PIN_113
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT65_PIN_REG_FFCC) //_PIN_55
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                    	(MCU_PORT_PD0_PIN_REG_FF7E)    //_PIN_39
...
//-----------------------------------------------
#define bDP_PIN15_CONNECT                       (MCU_PORT64_PIN_REG_FFCB) // _PIN_54, P6.4
#define bDP_PIN16_CONNECT                       (MCU_PORT_PD6_PIN_REG_FF78) // _PIN_32
#define bDP_PIN17_CONNECT                       (MCU_PORT63_PIN_REG_FFCA) // _PIN_53, P6.3

#define bA0_CONNECT                             (MCU_PORT_PD7_PIN_REG_FF77) // _PIN_31, PD.7
#define bD0_CONNECT                             (MCU_PORT_PD5_PIN_REG_FF79) // _PIN_33, PD.5
...
//-----------------------------------------------
sbit bD0_HPD                                    = P3 ^ 5; // _PIN_112, P3.5 for HDMI
...
sbit bD1_HPD                                    = P3 ^ 4; //_PIN_111, P3.4 for DP
...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1                                      = P3 ^ 3; // _PIN_110 P3.3
sbit bLED2                                      = P3 ^ 2; // _PIN_109, P3.2
...
#define AD_KEY1                                 (MCU_ADC1_RESULT_FF0A)//_PIN_51
#define AD_KEY2                                 (MCU_ADC2_RESULT_FF0B)//_PIN_52
//#define bPOWER                                  (MCU_PORT_PD3_PIN_REG_FF7B)//_PIN_35
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0 <= ucV1) && (ucV1 < 0x40))       \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x70 <= ucV1) && (ucV1 < 0xA0))    \
                                                                    ucKeyState |= _MENU_KEY_MASK;      \
                                                                                                       \
                                                                if((0 <= ucV2) && (ucV2 < 0x40))       \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x40 <= ucV2) && (ucV2 < 0x70))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x75 <= ucV2) && (ucV2 < 0xA0))    \
...
//--------------------------------------------------
sbit bPANELPOWER                                = P1 ^ 0; // _PIN_64, P1.0
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_PORT81_PIN_REG_FFD7) //_PIN_108,  
...
//-----------------------------------------------
#define PCB_AUDIO_DETECT()                      (MCU_PORT60_PIN_REG_FFC7)//_PIN_50

#define bAUDIO_POWER                            (MCU_PORT80_PIN_REG_FFD6)//_PIN_105
...
//-----------------------------------------------
#define bMUTE                                   (MCU_PORT74_PIN_REG_FFD3)//_PIN_104
...
//-----------------------------------------------
#define PCB_USB_DETECT()                        (MCU_PORTC4_PIN_REG_FFA4)//_PIN_40


#define bUSB_POWER                              (MCU_PORT_PD1_PIN_REG_FF7D)//_PIN_37
...
#endif // End of #if(_PCB_TYPE == _RL6297_DEMO_1A1H1DP)
