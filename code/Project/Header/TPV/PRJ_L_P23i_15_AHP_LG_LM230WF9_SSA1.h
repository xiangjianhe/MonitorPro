...
#if(_PROJECT == _PRJ_L_P23i_15_AHP_LG_LM230WF9_SSA1)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G7298_6229_AHP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM230WF9_SSA1
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT2324P_AHP.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(T2364p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(T2364p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(T2364p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _LG_INTERLACE_MODE_SELECTION							_ON
...
#define _DIGITAL_VOLUME_MAX                                     0x00B4//0x00D2 // _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
...
#define _SOURCE_DEFAULT_SEARCH_TIME_VGA                         ((GET_CABLE_DETECT(g_ucSearchIndex) == _TRUE) ? SEC(2) : SEC(0.5))
#define _SOURCE_DEFAULT_SEARCH_TIME_TMDS                        ((GET_CABLE_DETECT(g_ucSearchIndex) == _TRUE) ? SEC(2) : SEC(0.5))
#define _SOURCE_DEFAULT_SEARCH_TIME_DP                          ((GET_CABLE_DETECT(g_ucSearchIndex) == _TRUE) ? SEC(2) : SEC(0.5))
...
//==================================================================
#define _CHECKSUM                                               0x33
#define _VERSION_CODE                                           0x44
...
//==================================================================
#define _MODEL_NAME												'P','2','3','i','-','1','0'
#define _MICROCODE												'L','G','0','.','1'
#define _RELEASE_DATE                                        	'2','0','1','6','0','9','0','9'
#define _IC_SERIES                                      		'R','T','D','2','4','8','6','V','R','D'
#define _PANNEL_NAME 											'L','M','2','3','0','W','F','9'
...
#define _LOGO_TYPE                                              _LENOVO_THINKVISION_EPA
...
#define _DFM_DC_RESET_7200_FUNCTION                  			_OFF

#define MAX_CONTRAST_RATIO                                      125 // 1.75(unit 1/100)
#define DEF_CONTRAST_RATIO                                      100 // 1.00(unit 1/100)
...
#define _LOW_BLUE_LIGHT_FUNCTION                        		_ON//_OFF
#define _LBL_HOTKEY_FUNCTION                                    _OFF

#define _LOW_BLUE_LIGHT_BACKLIGHT                       		25
#define _LOW_BLUE_LIGHT_CONTRAST                        		80
...
#define _OD_NORMAL_GAIN                                         0x42// 6.38ms
#define _OD_EXTREME_GAIN                                        0x72// 4.98ms
...
#define _CT7200_LenovoPrj_GREEN                                 113
#define _CT7200_LenovoPrj_BLUE                                  123

#define _CTSRGB_LenovoPrj_RED                                   118
#define _CTSRGB_LenovoPrj_GREEN                                 114
#define _CTSRGB_LenovoPrj_BLUE                                  120

#define _CT6500_LenovoPrj_RED                                   118
#define _CT6500_LenovoPrj_GREEN                                 114
#define _CT6500_LenovoPrj_BLUE                                  120

#define _CT9300_LenovoPrj_RED                                   103
#define _CT9300_LenovoPrj_GREEN                                 107
...
#define _CTLOWBLUELIGHT_BLUE                                    105         
...
#define _ICON_BLANK1_PIXEL                                      19
#define _ICON_BLANK2_PIXEL                                      10
#define _ICON_BLANK3_PIXEL                                      17
#define _ICON_BLANK4_PIXEL                                      12
#define _ICON_BLANK5_PIXEL                                      11

#define _NAVIGATE_ICON_EXIT_COL_POSITION						4
#define _NAVIGATE_ICON_LEFT_COL_POSITION						10
#define _NAVIGATE_ICON_RIGHT_COL_POSITION						15
#define _NAVIGATE_ICON_ENTER_COL_POSITION						21
#define _NAVIGATE_ICON_POWER_COL_POSITION						28
#define _AFTER_NAVIGATE_ICON_POWER_COL_POSITION                 35 

#define _TEXT_BLANK1_PIXEL                                      10
#define _TEXT_BLANK2_PIXEL                                      12
#define _NAVIGATE_TEXT_EXIT_COL_POSITION						2
#define _NAVIGATE_TEXT_ENTER_COL_POSITION						21
...
#endif // End of #if(_PROJECT == _PRJ_L_P23i_15_AHP_LG_LM230WF9_SSA1)
