...
#if(_PROJECT == _FOX_LS2233_PAN_LM215DT1A)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_PAN_LM215DT1A
