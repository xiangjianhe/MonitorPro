...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6336_QA_64Pin_1A.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6336_QA_64PIN_1A)
...
#define _PCB_SYS_EEPROM_IIC                     _HW_IIC_64PIN_PIN_25_26
...
// SYSTEM_EEPROM_WP
#define _64PIN_PIN_17                                 (1 & 0x07) // Page 10-0xA2[2:0]
...
// PANEL_SW
#define _64PIN_PIN_32                                 (1 & 0x0F) // Page 10-0xAF[3:0]
...
// Macro of IIC
//--------------------------------------------------
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_PORT66_PIN_REG_FFCD) // Pin 25, P6.6
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_PORT67_PIN_REG_FFCE) // Pin 26, P6.7
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT_PB7_PIN_REG_FF7F) // Pin 17, PB.7
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORT_PB0_PIN_REG_FF8F) // Pin 16, PB.0
...
//-----------------------------------------------
#define bA0_CONNECT                             (MCU_PORT65_PIN_REG_FFCC) // Pin 24, P6.5
...
sbit bLED3                                      = P3 ^ 2;                   // Pin 54, P3.2
sbit bLED4                                      = P3 ^ 3;                   // Pin 55, P3.3
sbit bLED5                                      = P3 ^ 5;                   // Pin 56, P3.5
...
#endif // End of #if(_PCB_TYPE == _RL6336_QA_64PIN_1A)
