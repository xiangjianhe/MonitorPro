...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LT2013P_DEMO)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6001_DEMO_1A1DVI1DP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_CMI_M190CGE_20
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"  
...
#define _DIGITAL_VOLUME_MAX                                     0x00FF // _AUDIO_VOLUME_8BIT MAX:0x00FF
...
// Memory Config
//--------------------------------------------------
#define _SDRAM_SIZE_CONFIG                                      _1M_32BIT    
...
#define _OD_YC_LEST_DIFF_VALUE                                  2 // Range: 0~63
#define _OD_LOW_BIT_NR_THD                                      _NR_THD_4
#define _OD_LOW_BIT_NR_THD_VGA                                  _NR_THD_6
...
#define _CALIBRATION_R_GAIN_BIAS                                (28)// Needs modification for EVERY single source
#define _CALIBRATION_G_GAIN_BIAS                                (28)// Needs modification for EVERY single source
#define _CALIBRATION_B_GAIN_BIAS                                (28)// Needs modification for EVERY single source
...
#define _DIGITAL1_TYPE                                          _DVI_PORT//_DP_PORT
...
#define _CT9300_LenovoPrj_RED                                   106
#define _CT9300_LenovoPrj_GREEN                                 117
...
#endif // End of #if(_PROJECT == _PRJ_L_LT2013P_DEMO)
