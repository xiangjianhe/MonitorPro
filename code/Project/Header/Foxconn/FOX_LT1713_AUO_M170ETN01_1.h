...
#if(_PROJECT == _FOX_LT1713_AUO_M170ETN01_1)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_AUO_M170ETN01_1 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN LT1713)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LEN LT1713)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//for M170ETN01 Version
#define _M170ETN01_00									0
#define _M170ETN01_0A									1

#define _PANEL_M170ETN01_VER							_M170ETN01_00
...
#if(_PANEL_M170ETN01_VER == _M170ETN01_00)
#define _FACTORY_PANNEL_NAME							_A,_U,_O,_SPACE,_M,_1,_7,_0,_E,_T,_N,_0,_1,_MINUS,_0,_0
#else
#define _FACTORY_PANNEL_NAME							_A,_U,_O,_SPACE,_M,_1,_7,_0,_E,_T,_N,_0,_1,_MINUS,_0,_A
#endif
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_1,_D,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_3,_1,_1,_1,_4
#define _FW_VERSION                                     _L,_A, _1, _DOT, _2
#define _DDCCI_FIRMWARE_VERSION							0x0102  //Ver 1.00	

//User OSD
#define _MODEL_NAME                                     _bL_, _bT_,_b1_, _b7_, _b1_, _b3_
#define _MICROCODE                                      _bL_,_bA_, _b1_, _DOT, _b2_
//Facory Command
...
#define FacoryVersion5                                  '2' //Facory Command show Version
...
//----------------------------------------------------
#if(_PANEL_M170ETN01_VER == _M170ETN01_00)
#define _PWM_B00                                        76 //|00
#define _PWM_B10                                        77 //|10
#define _PWM_B20                                        80 //|20
#define _PWM_B30                                        87 //|30
#define _PWM_B40                                        97 //|40
#define _PWM_B50                                        112 //|50
#define _PWM_B60                                        130 //|60
#define _PWM_B70                                        154 //|70
#define _PWM_B80                                        165 //|80
#define _PWM_B90                                        213 //|90
#define _PWM_B100                                       255 //|100

#else

#define _PWM_B00                                        61 //|00
#define _PWM_B10                                        62 //|10
#define _PWM_B20                                        66 //|20
#define _PWM_B30                                        73 //|30
#define _PWM_B40                                        83 //|40
#define _PWM_B50                                        99 //|50
#define _PWM_B60                                        119 //|60
#define _PWM_B70                                        144 //|70
#define _PWM_B80                                        145 //|80
#define _PWM_B90                                        211 //|90
#define _PWM_B100                                       255 //|100
#endif
...
#endif // End of #if(_PROJECT == _FOX_LT1713_AUO_M170ETN01_1)
