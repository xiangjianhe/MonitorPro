...
#if(_PROJECT == _FOX_LS2033wD)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6229_FOXCONN_LEN_LS2033wD_PCB


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_SEC_LTM200KL01 
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN LS2033wD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LEN LS2033wD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
#define _CAPABILITIES_STRING_HDMI                               ""
#define _CAPABILITIES_STRING_DP                                 ""
...
//--------------------------------------------------
#define _OSD_LBL_H_POS                                  910
#define _OSD_LBL_V_POS                                  0
//--------------------------------------------------
...
//--------------------------------------------------
#define _CHECKSUM                                       0x99
#define _VERSION_CODE                                   0xaf

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _L,_S,_2,_0,_3,_3,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_S,_E,_C,_SPACE,_L,_T,_M,_2,_0,_0,_K,_L,_0,_1
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_1,_L,_R
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_9,_0,_6
#define _FW_VERSION                                     _L,_S, _3, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0300//	0x0301 

//User OSD
#define _MODEL_NAME                                     _bL_, _bS_,_b2_, _b0_, _b3_, _b3_, ___,_bW_,_bi_,_bd_,_be_
#define _MICROCODE                                      _bL_,_bS_, _b3_, _DOT, _b0_
//Facory Command
...
//----------------------------------------------------
#define _PWM_B00                                        78//69//96//|00
#define _PWM_B10                                        79//70//97//|10
#define _PWM_B20                                        84//73//101//|20
#define _PWM_B30                                        88//80//107 //|30
#define _PWM_B40                                        99//90//116//|40
#define _PWM_B50                                        113//105//129 //|50
#define _PWM_B60                                        131//124//145 //|60
#define _PWM_B70                                        155//148//166 //|70
#define _PWM_B80                                        160//167//208 //|80
#define _PWM_B90                                        216//212//218 //|90
...
#define _CT9300_LenovoPrj_GREEN                                 112
...
#define _CTLOWBLUELIGHT_GREEN                                   112
