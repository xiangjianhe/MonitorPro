...
#if(_PANEL_TYPE == _FOX_AUO_M185XTN01_3)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MIN                     1432                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1313                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     788                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  94                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  56                 // Mininum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T4                     150                 // Panel Power Off T4 (ms)254
