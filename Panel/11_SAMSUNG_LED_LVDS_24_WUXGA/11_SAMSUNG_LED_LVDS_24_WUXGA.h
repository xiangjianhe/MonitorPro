...
#if(_PANEL_TYPE == _SAMSUNG_LED_LVDS_24_WUXGA)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_ELED_STRING_CURRENT              110                 // Every Led String Current
#define _PANEL_ELED_VOUT_TYPICAL                55                  // Eled Panel Vout Typical Voltage
#define _PANEL_ELED_VOUT_MAX                    60                  // Eled Panel Vout Max Value
