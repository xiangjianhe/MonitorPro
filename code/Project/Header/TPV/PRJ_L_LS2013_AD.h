...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PRJ_L_LS2013_AD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LS2013_AD)
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LS2013_AD.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT1913p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT1913p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT1913p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      1//Robert Wang 20130130 for _TPV_CMI_M195FGE_L20 // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
//==================================================================
#define _MODEL_NAME                                             _bL_, _bS_, _b2_, _b0_, _b1_, _b3_, _8P_, _bW_, _bi_, _bd_, _be_
#define _MICROCODE                                              _bL_,_bM_, _b0_, _DOT, _b7_

#define _FACTORY_PROJECT_NAME                                   _L,_S,_2,_0,_1,_3,_W
#define _FW_RELEASE_DATE                                        _2,_0,_1,_3,_0,_3,_1,_4
#define _FW_VERSION                                             _L,_M,_0,_DOT,_7
#define _DDCCI_FIRMWARE_VERSION							        0x0007  //Ver 0.07	

#define _PANNEL_NAME 											'M','2','1','5','F','G','E'
...
#endif // End of #if(_PROJECT == _PRJ_L_LS2013_AD)
