...
#define COLORTEMP_RGAIN()		{\	
								...
								SET_COLOR_TEMP_TYPE_BACKUP(_CT_USER);\
...
#define COLORTEMP_sRGB()		{\
								...
								SET_COLOR_TEMP_TYPE_BACKUP(_CT_SRGB);\
								}
#else
...
#define COLORTEMP_6500()  		{\
								...
								SET_COLOR_TEMP_TYPE_BACKUP(_CT_6500);\
								}
#else
...
#define COLORTEMP_7200()  		{\
								...
								SET_COLOR_TEMP_TYPE_BACKUP(_CT_7200);\
								}
#else
...
#define COLORTEMP_9300()  		{\
								...
								SET_COLOR_TEMP_TYPE_BACKUP(_CT_9300);\
								}
#else
