...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2281CW_WISTRON_1A1DVI.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RTD2281CW_WISTRON_1A1DVI)
...
// bLED1
#define _PIN_42                                 (1 & 0x03) // Page 10-0xA0[5:4]
...
//Power Key
#define _PIN_51                                 (0 & 0x03) // Page 10-0xA3[5:4]
...
// FLASH_WP
#define _PIN_110                                (2 & 0x07) // Page 10-0xAD[2:0]
...
// BL_EN
#define _PIN_113                                (2 & 0x07) // Page 10-0xB0[7:5]
...
#define bSWIIC_EDID_EEPROM_SCL_DVI              (MCU_PORT70_PIN_REG_FFCF)
#define bSWIIC_EDID_EEPROM_SDA_DVI              (MCU_PORT71_PIN_REG_FFD0)

#define bSWIIC_EDID_EEPROM_SCL_HDMI             (MCU_PORT73_PIN_REG_FFD2)
#define bSWIIC_EDID_EEPROM_SDA_HDMI             (MCU_PORT72_PIN_REG_FFD1)
...
//-----------------------------------------------
sbit bFLASH_WRITE_PROTECT                       =   P3^3; //PIN110 P3.3
//ym20130911 . ?? #define bFLASH_WRITE_PROTECT                    (MCU_PORT81_PIN_REG_FFD7)
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_PORTC4_PIN_REG_FFA4)// Pin 40, PC.4
...
#define bD1_CONNECT                             (MCU_PORT_PD6_PIN_REG_FF78)//Pin32 ,PD.6
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_PORT_PB6_PIN_REG_FF89)       // pin_42
#define bLED2                                   (MCU_PORT_PB5_PIN_REG_FF8A)       // pin_43
...
#define bPOWER_KEY                              (MCU_PORT61_PIN_REG_FFC8)
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x00 <= ucV3) && (ucV3 < 0x55))          \
                                                                    ucKeyState |= _MENU_KEY_MASK;\
                                                                                                        \
                                                                if((0x70 <= ucV3) && (ucV3 < 0x8a))        \
                                                                    ucKeyState |= _LEFT_KEY_MASK;       \
                                                                                                        \
                                                                if((0x00 <= ucV2) && (ucV2 < 0x55))          \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;\
                                                                                                        \
                                                                if((0x55 <= ucV2) && (ucV2 < 0x70))       \
                                                                    ucKeyState |= _EXIT_KEY_MASK ;     \
                                                                                                    \
                                                                if((0x70 <= ucV2) && (ucV2 < 0x8a))        \
...
//--------------------------------------------------
sbit bPANELPOWER                                = P1^0;    // Pin64 ,P1.0
...
#define bAudioEn                                (MCU_PORTC3_PIN_REG_FFA0)//Pin37 PC.3
...
sbit bAudioMute                               = P3 ^ 3; //Pin60 P3.3
#define PCB_AMP_MUTE(x)                         {\
												bAudioMute=x;\
                                                }

#define _VOLUME_MAX                             255
#define _VOLUME_MIN                             60
...
#endif // End of #if(_PCB_TYPE == _RTD2281CW_WISTRON_1A1DVI)
