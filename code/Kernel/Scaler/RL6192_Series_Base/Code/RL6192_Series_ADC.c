...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_Series_ADC.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6192_SERIES_ADC__
...
#warning "Not Apply the Solution in RL6192 Series!!"
#endif
...
void ScalerADCBiasCurrentSetting(void)
{
    ...
    // Bias Current of ADC_SF Setting 00 (15u)
    ScalerSetBit(P0_CA_ADC_I_BAIS3, ~(_BIT7 | _BIT6), 0x00);
...
void ScalerADCPGAbyPassSetting(void)
{
    // 6192 have no PGA by pass option
}
