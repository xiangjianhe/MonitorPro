...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6269_Series_DP.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6269_SERIES_DP__
...
void ScalerDpAuxIntInitial(void)
{
    ...
    ScalerSetByte(PB_F0_AUX_1, 0xF0);

    // Aux 50ohm auto K, Aux Vth-->50mV, Disable Enlarge Rx Termination R
    ScalerSetByte(PB_F1_AUX_2, 0x29);
    ScalerSetBit(PB_F5_HW_AUTO_PS, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ...
    // Set Aux D2 = ~D1 for Aux Single Ended Mode
    ScalerSetBit(PA_D9_DP_AUX_DIG_PHY_9, ~_BIT7,  _BIT7);
...
void ScalerDpPhyInitial(void)
{
    ...
    // [3] Enable DC Gain Increase for First LEQ 
    // [2] TP1 Signal to Lock FLD After LEQ
    ScalerSetBit(PB_A4_CDR_2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT3 | _BIT2), (_BIT6 | _BIT3 | _BIT2));
    ...
    // [2:1] Enable Stage1 High Boost Mode, Disable Stage2 High Boost Mode
    ScalerSetBit(PB_AC_CDR_A, ~(_BIT2 | _BIT1), _BIT2);
