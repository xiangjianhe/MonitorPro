...
#if(_PROJECT == _FOX_LI2215sD_CMI_M215HGE_L23)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6230_FOXCONN_LEN_LI2215sD_PCB

//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_CMI_M215HGE_L23
...
#define _CAPABILITIES_STRING_VGA 								"(port(monitor)type(LCD)model(LEN LI2215sD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 AC AE B2 B6 C6 C8 C9 CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF FF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
#define _LOGO_TYPE                                      _LENOVO_2015
#define _LANGUAGE_TYPE                                  _8_LAN
#define _LANGUAGE_DEFAULT                               _ENGLISH//_CHINESE_S	//liubo
...
//--------------------------------------------------
#define _CHECKSUM                                       0x2b//0x2a
#define _VERSION_CODE                                   0xaf

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _L,_I,_2,_2,_1,_5,_s,_D
#define _FACTORY_PANNEL_NAME							_C,_M,_I,_SPACE,_M,_2,_1,_5,_H,_G,_E,_L,_2,_3
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_8,_0,_D,_L,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_6,_0,_3,_2,_1
#define _FW_VERSION                                     _L,_M, _3, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0300  //Ver 1.00	

//User OSD
#define _MODEL_NAME                                     _2_, _2_, _1_,_5_
#define _MICROCODE                                      _3_, GLOBAL(0x20), _0_
//Facory Command
...
#define FacoryBomH4                                     'M'							 
#define FacoryBomH5                                     'D'
...
#endif // End of #if(_PROJECT == _FOX_LI2215sD_CMI_M215HGE_L23)
