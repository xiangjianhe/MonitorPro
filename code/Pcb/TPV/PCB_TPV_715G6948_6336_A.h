...
//----------------------------------------------------------------------------------------------------
// ID Code      : PCB_TPV_715G6948_6336_A.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _PCB_TPV_715G6948_6336_A)
...
// PANEL_ENABLE//Robert Wang 20140521
#if((_PROJECT == _PRJ_L_LT1953S_A_TPV_TPM190A1_MWW4) || ( _PROJECT == _PRJ_L_LT1953S_A_AUO_TPM190WP2_PTN01))
...
// Macro of LED On/Off
//--------------------------------------------------
#if((_PROJECT == _PRJ_L_LT1953S_A_TPV_TPM190A1_MWW4) || (_PROJECT == _PRJ_L_F2014_A_LG_LM195WD1_TLA1) || (_PROJECT == _PRJ_L_F2014_A_AUO_M195RTN01_0) || (_PROJECT == _PRJ_L_F2014_A_INL_M195FGE_L20)|| ( _PROJECT == _PRJ_L_LT1953S_A_AUO_TPM190WP2_PTN01))
...
#elif((_PROJECT == _PRJ_L_LT1953S_A_TPV_TPM190A1_MWW4)|| ( _PROJECT == _PRJ_L_LT1953S_A_AUO_TPM190WP2_PTN01))
...
#endif // End of #if(_PCB_TYPE == _PCB_TPV_715G6948_6336_A)
