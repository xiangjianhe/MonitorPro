...
#if(_PANEL_TYPE == _TPV_SEC_LTM220MT12)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_MAX_FRAME_RATE                   775//860                 // Unit in 0.1 HZ
#define _PANEL_MIN_FRAME_RATE                   498//500
...
#define _PANEL_DH_TOTAL                         1840                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2008                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1826                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         6                   // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        1050                // Display Vertical Width
#define _PANEL_DV_END                           1056                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         1080                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1220//1100                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1059                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      119                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  160//151                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  100//106                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      30                  // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      20                  // Panel Power On T2 (ms)29
#define _PANEL_POWER_ON_T3                      550                 // Panel Power On T3 (ms)240

#define _PANEL_POWER_OFF_T4                     120                 // Panel Power Off T4 (ms)254
#define _PANEL_POWER_OFF_T5                     20                  // Panel Power Off T5 (ms)236
...
#endif // End of #if(_PANEL_TYPE == _TPV_SEC_LTM220MT12)
