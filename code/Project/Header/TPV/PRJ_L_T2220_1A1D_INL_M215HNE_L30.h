...
#if(_PROJECT == _PRJ_L_T2220_1A1D_INL_M215HNE_L30)
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_T2220_AD.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(T2220)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(T2220)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME												_bT_, _2_, _2_, _2_, _0_
#define _MICROCODE												_bL_,_bI_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _T,_2,_2,_2,_0
#define _FW_RELEASE_DATE                                        _2,_0,_1,_6,_0,_5,_1,_3
#define _FW_VERSION                                             _L,_I,_0,_DOT,_1
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.02
#define _IC_SERIES                                      		_R,_T,_D,_2,_2,_8,_1,_C,_L

#define _PANNEL_NAME 											'M','2','1','5','H','N','E'
