...
#if(_PROJECT == _RTD2281CL_WISTRON_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RTD2281CL_WISTRON_1A1DVI


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _CMI_M236HGE_LVDS_23_5_WUXGA
#define _PANEL_POW_SEQ_FAST_MODE                                _OFF

//--------------------------------------------------
//  Panel Switch Slew Rate Control Define
//--------------------------------------------------
#define _PANEL_SWITCH_PAD_SUPPORT                               _ON

#define _PANEL_SWITCH_CURRENT                                    (5)    // 0~7 (small ~ large)
...
#define _FLASH_ACCESS_FUNCTION_SUPPORT                          _SYSTEM_EEPROM_EMULATION_SUPPORT
...
#define _CALIBRATION_G_GAIN_BIAS                                (2) // Needs modification for EVERY single source
#define _CALIBRATION_B_GAIN_BIAS                                (4) // Needs modification for EVERY single source
#define _CALIBRATION_R_OFFSET_BIAS                              (-3) // Needs modification for EVERY single source
#define _CALIBRATION_G_OFFSET_BIAS                              (-2) // Needs modification for EVERY single source
#define _CALIBRATION_B_OFFSET_BIAS                              (-2) // Needs modification for EVERY single source
...
#endif // End of #if(_PROJECT == _RTD2281CL_WISTRON_PROJECT)
