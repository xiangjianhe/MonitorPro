...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1                                      = P3 ^ 3; // Orange Pin55 P3.3
#define bLED2                                   (MCU_PORT53_PIN_REG_FFC2) //Green Pin56 P5.3
...
//--------------------------------------------------
sbit bBACKLIGHTPOWER                            = P3 ^ 6; // Pin 25, P3.6
