...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_OSD_Lib_Interface.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//****************************************************************************
#define _OSD_SRAM_SIZE                                          6848

#define _OSD_POSITION_OFFSET_H                                  0x11
#define _OSD_POSITION_OFFSET_V                                  0x03
#define _OSD_OFFSET_DRAW_WINDOW                                 10
...
//--------------------------------------------------
#define SCALEROSD_FONT_ROTATE_SETTING_GET()                     (MCU_TRIPLE_BYTES_OP_FF03)
#define SCALEROSD_FONT_ROTATE_SETTING_SET(x)                    {\
                                                                    MCU_TRIPLE_BYTES_OP_FF03 = (x); \
                                                                }

#define SCALEROSD_FONT_ROTATE_1_2_BITS_SHIFT_SET(x)             {\
                                                                    MCU_SHIFT_BITS_NUM_FF04 = (x); \
                                                                }

#define SCALEROSD_FONT_ROTATE_3_L_BITS_SHIFT_SET(x)             {\
                                                                    MCU_BYTE_ADDRESS_FF05 = (x); \
                                                                }

#define SCALEROSD_FONT_ROTATE_INPUT_SET(x)                      {\
                                                                    MCU_INPUT_TRIPLE_BYTES_FF06 = (x); \
                                                                }

#define SCALEROSD_FONT_ROTATE_ONPUT_GET()                       (MCU_RESULT_TRIPLE_BYTES_FF07)
...
//--------------------------------------------------            
// MACRO for Osd Window Srart Offset               
//--------------------------------------------------            
#define GET_OSD_WINDOW_START_OFFSET()                           (ucWindowStartOffset)
#define SET_OSD_WINDOW_START_OFFSET(x)                          (ucWindowStartOffset = x)
...
#define GET_OSD_MAPA_COL_MAX()                                  (ucColAMax)
#define SET_OSD_MAPA_COL_MAX(x)                                 (ucColAMax = x)

#define GET_OSD_MAPB_COL_MAX()                                  (ucColBMax)
#define SET_OSD_MAPB_COL_MAX(x)                                 (ucColBMax = x)
...
#define _OSD_DECODE_COMPRESSED                                  (0x00)
#define _OSD_DECODE_NON_COMPRESSED                              (_BIT1)
...
#define GET_OSD_POSITION_OFFSET_H()                             (ucPositionOffsetH)
#define SET_OSD_POSITION_OFFSET_H(x)                            (ucPositionOffsetH = x)

#define GET_OSD_POSITION_OFFSET_V()                             (ucPositionOffsetV)
#define SET_OSD_POSITION_OFFSET_V(x)                            (ucPositionOffsetV = x)
...
typedef enum
{
    _OSD_BLINKING_EFFECT_DISABLE,
    _OSD_BLINKING_EFFECT_ENABLE   = _BIT6,
    _OSD_BLANK_FONT_TYPE_ALIGN    = _BIT0,
    _OSD_BLANK_FONT_TYPE_3D_MARK  = _BIT1,
} EnumOsdBlinkingType;
...
// ScalerOsdSramAddressCount.c
//--------------------------------------------------
extern BYTE ucColAMax;
extern BYTE ucColBMax;

//--------------------------------------------------
// ScalerOsdDrawWindow.c
//--------------------------------------------------
extern BYTE ucWindowStartOffset;
...
// ScalerOsdPosition.c
//--------------------------------------------------
extern BYTE ucPositionOffsetH;
extern BYTE ucPositionOffsetV;
...
extern void ScalerOsdBurstWriteDataPort(BYTE *pAddress, WORD usWriteLength, BYTE ucBankNum, BYTE ucTableType, bit bTableLocation);
extern void ScalerOsdWriteByte(BYTE ucIndicate, WORD usAddr, BYTE ucData);
...
extern void ScalerOsdFrameControlAllByte(WORD usAddr, BYTE ucDoubleBuffer, BYTE ucByte0, BYTE ucByte1, BYTE ucByte2);
...
extern void ScalerOsdWindowChessboard(bit bEnable, EnumOsdWindowsType enumOsdWindowsType, BYTE ChessBoardColor1, BYTE ChessBoardColor2);
extern void ScalerOsdWindowHighlightFunction(bit bEnable, EnumOsdWindowsType enumOsdWindowsType, BYTE ucForegroundColor, BYTE BackgroundColor, BYTE CharactorBorderColor);
...
extern void ScalerOsdWindow3DShiftValue(EnumOsdWindowsType enumOsdWindowsType, BYTE ucShiftValue);
extern void ScalerOsdRotationWindowSize(EnumOsdMapType enumOsdMapType, WORD usLength, WORD Width);
extern void ScalerOsdDrawGridLine(void);
extern void ScalerOsdDrawGridLinePanelPitch(WORD ucPitchHorizontal, WORD ucPitchVertical);
...
extern void ScalerOsdSramBaseAddressSet(EnumOsdMapType enumOsdMapType, WORD ucRowCommandStart, WORD ucCharactorCommandStart, WORD ucFontStart);
...
extern void ScalerOsdHardwareCompression(BYTE *pArray, WORD usVLCTableSize, BYTE ucBankNum, WORD usOffset, WORD usFontTableStart, EnumOsdRotateType enumOsdRotateType, bit bTableLocation);
extern void ScalerOsdHardwareVLC(BYTE *pArray, WORD usVLCTableSize, BYTE ucBankNum, WORD usOffset, WORD usFontTableStart, EnumOsdRotateType enumOsdRotateType);
extern void ScalerOsd2BitFontOffset(BYTE ucOffset);
extern void ScalerOsdSramDataValue(BYTE ucRow, BYTE ucCol, BYTE ucLength, BYTE ucValue, EnumOsdWriteType enumOsdWriteType);
extern void ScalerOsdBlankFont(BYTE ucRow, BYTE ucCol, BYTE ucLength, BYTE ucHeight, BYTE ucPixelLength, BYTE ucBackgroundColor, EnumOsdBlinkingType enumOsdBlinkingType);
...
extern void ScalerOsdSetTransparency_TIMER(BYTE ucTransparency);
...
extern bit  ScalerOsdGetHorizontalDelayStep(void);
extern void ScalerOsdHorizontalDelayStep(EnumOsdHorizontalDelayStepType enumOsdHorizontalDelayStepType);
extern void ScalerOsd3DOsdEnable(bit b3DOsdEnable);
extern void ScalerOsd3DOutputMode(bit b3DModeEnable, bit b3DOutputMode);
