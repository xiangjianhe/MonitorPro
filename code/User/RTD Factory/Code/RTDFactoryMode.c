...
//****************************************************************************
BYTE xdata g_ucFactoryPage = 0;
BYTE xdata g_ucBgColorR = 0;
BYTE xdata g_ucBgColorG = 0;
BYTE xdata g_ucBgColorB = 0;
BYTE xdata g_ucAutoColotTypeFontPointer = 0;
//****************************************************************************
...
void RTDFactoryMenuOperation(void)
{
    if((GET_OSD_STATE() >=_MENU_FACTORY_AUTOCOLOR) && (GET_OSD_STATE() < _MENU_FACTORY_OSD_END) && (GET_KEYMESSAGE() < _KEY_AMOUNT))
    {
...
*/
    ...
    for(ucRowCount = 0; ucRowCount < _CT_COLORTEMP_AMOUNT; ucRowCount++)
    {
        ...
        RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_R_NUMBER_COL), g_stColorProcData.ucColorTempR, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_R + ucRowCount * 3);
        RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_G_NUMBER_COL), g_stColorProcData.ucColorTempG, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_G + ucRowCount * 3);
        RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_B_NUMBER_COL), g_stColorProcData.ucColorTempB, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_B + ucRowCount * 3);
    }
    RTDNVRamLoadColorSetting(GET_COLOR_TEMP_TYPE());

#if(_VGA_SUPPORT == _ON)
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_R_NUMBER_COL), g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL], (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_GAIN_R);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_G_NUMBER_COL), g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL], (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_GAIN_G);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_B_NUMBER_COL), g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL], (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_GAIN_B);

    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_R_NUMBER_COL), g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL], (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_OFFSET_R);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_G_NUMBER_COL), g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL], (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_OFFSET_G);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_B_NUMBER_COL), g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL], (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_OFFSET_B);
#else
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_R_NUMBER_COL), 128, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_GAIN_R);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_G_NUMBER_COL), 128, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_GAIN_G);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_B_NUMBER_COL), 128, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_GAIN_B);

    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_R_NUMBER_COL), 128, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_OFFSET_R);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_G_NUMBER_COL), 128, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_OFFSET_G);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_B_NUMBER_COL), 128, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_ADC_OFFSET_B);
#endif
...
//Hot Plug Option
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_HOT_PLUG_DP_DC_OFF_HIGH_ROW), COL(_FACTORY_HOT_PLUG_OPTION_VALUE__COL), _PFONT_FACTORY_HOT_PLUG_DP_DC_OFF_HIGH, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[UserCommonNVRamGetSystemData(_DP_HOT_PLUG_DC_OFF_HIGH)], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_HOT_PLUG_HDMI_SUPPORT_ROW), COL(_FACTORY_HOT_PLUG_OPTION_VALUE__COL), _PFONT_FACTORY_HOT_PLUG_HDMI_SUPPORT, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[UserCommonNVRamGetSystemData(_HDMI_HOT_PLUG_SUPPORT)], _ENGLISH);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_HOT_PLUG_HDMI_SUPPORT_TIME_ROW), COL(_FACTORY_HOT_PLUG_OPTION_VALUE__COL), UserCommonNVRamGetSystemData(_HDMI_HOT_PLUG_SUPPORT_TIME), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_HOT_PLUG_HDMI_TIME); 
...
void RTDFactoryAutoColorEnter(void)
{
    ...
    if(SysSourceGetSourceType() == _SOURCE_VGA)
    {
        ...
        {
            pData[0] = _AUTO_CALIBRATE_RGB;
        }
        else
        {
            pData[0] = _AUTO_TUNE_RGB;            
        }

        if(ScalerAutoDoWhiteBalance(pData[0]) == _AUTO_SUCCESS)       
        {
...
void RTDFactoryColortemp1REnter(void)
{
    g_usBackupValue = g_stColorProcData.ucColorTempR;
...
void RTDFactoryColortemp1GEnter(void)
{
    g_usBackupValue = g_stColorProcData.ucColorTempG;
...
void RTDFactoryColortemp1BEnter(void)
{
    g_usBackupValue = g_stColorProcData.ucColorTempB;
...
{
#if(_VGA_SUPPORT == _ON)
    g_usBackupValue = g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL];
...
{
#if(_VGA_SUPPORT == _ON)
    g_usBackupValue = g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL];
...
{
#if(_VGA_SUPPORT == _ON)
    g_usBackupValue = g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL];
...
{
#if(_VGA_SUPPORT == _ON)
    g_usBackupValue = g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL];
...
{
#if(_VGA_SUPPORT == _ON)
    g_usBackupValue = g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL];
...
{
#if(_VGA_SUPPORT == _ON)
    g_usBackupValue = g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL];
...
void RTDFactoryColortemp1RAdjustEnter(void)
{
    if(g_usBackupValue != g_stColorProcData.ucColorTempR)
    {
...
void RTDFactoryColortemp1RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT1_RED_ADJ, g_stColorProcData.ucColorTempR);
}
...
void RTDFactoryColortemp1RAdjustExit(void)
{
    if(g_usBackupValue != g_stColorProcData.ucColorTempR)
    {
        g_stColorProcData.ucColorTempR = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_CT1_RED_ADJ, g_stColorProcData.ucColorTempR);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT1_RED);
}
...
void RTDFactoryColortemp1GAdjustEnter(void)
{
    if(g_usBackupValue != g_stColorProcData.ucColorTempG)
    {
        RTDNVRamSaveColorSetting(GET_COLOR_TEMP_TYPE());
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT1_GREEN);
...
void RTDFactoryColortemp1GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT1_GREEN_ADJ, g_stColorProcData.ucColorTempG);
}
...
void RTDFactoryColortemp1GAdjustExit(void)
{
    if(g_usBackupValue != g_stColorProcData.ucColorTempG)
    {
        g_stColorProcData.ucColorTempG = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_CT1_GREEN_ADJ, g_stColorProcData.ucColorTempG);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT1_GREEN);
}
...
void RTDFactoryColortemp1BAdjustEnter(void)
{
    if(g_usBackupValue != g_stColorProcData.ucColorTempB)
    {
        RTDNVRamSaveColorSetting(GET_COLOR_TEMP_TYPE());
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT1_BLUE);
...
void RTDFactoryColortemp1BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT1_BLUE_ADJ, g_stColorProcData.ucColorTempB);
}
...
void RTDFactoryColortemp1BAdjustExit(void)
{
    if(g_usBackupValue != g_stColorProcData.ucColorTempB)
    {
        g_stColorProcData.ucColorTempB = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_CT1_BLUE_ADJ, g_stColorProcData.ucColorTempB);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT1_BLUE);
}
...
void RTDFactoryColortemp2RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT2_RED_ADJ, g_stColorProcData.ucColorTempR);
}
...
void RTDFactoryColortemp2GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT2_GREEN_ADJ, g_stColorProcData.ucColorTempG);
}
...
void RTDFactoryColortemp2BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT2_BLUE_ADJ, g_stColorProcData.ucColorTempB);
}
...
void RTDFactoryColortemp3RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT3_RED_ADJ, g_stColorProcData.ucColorTempR);
}
...
void RTDFactoryColortemp3GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT3_GREEN_ADJ, g_stColorProcData.ucColorTempG);
}
...
void RTDFactoryColortemp3BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT3_BLUE_ADJ, g_stColorProcData.ucColorTempB);
}
...
void RTDFactoryColortemp4RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT4_RED_ADJ, g_stColorProcData.ucColorTempR);
}
...
void RTDFactoryColortemp4GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT4_GREEN_ADJ, g_stColorProcData.ucColorTempG);
}
...
void RTDFactoryColortemp4BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT4_BLUE_ADJ, g_stColorProcData.ucColorTempB);
}
...
void RTDFactoryColortemp5RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT5_RED_ADJ, g_stColorProcData.ucColorTempR);
}
...
void RTDFactoryColortemp5GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT5_GREEN_ADJ, g_stColorProcData.ucColorTempG);
}
...
void RTDFactoryColortemp5BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT5_BLUE_ADJ, g_stColorProcData.ucColorTempB);
}
...
void RTDFactoryColortemp6RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT6_RED_ADJ, g_stColorProcData.ucColorTempR);
}
...
void RTDFactoryColortemp6GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT6_GREEN_ADJ, g_stColorProcData.ucColorTempG);
}
...
void RTDFactoryColortemp6BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT6_BLUE_ADJ, g_stColorProcData.ucColorTempB);
}
...
{
#if(_VGA_SUPPORT == _ON)
    if(g_usBackupValue != g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL])
    {
        UserCommonNVRamSaveADCSetting(_COLOR_SPACE_RGB);
    }
...
{
#if(_VGA_SUPPORT == _ON)    
    RTDFactoryOsdDispNumber(_MENU_FACTORY_GAIN_RED_ADJ, g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL]);
#endif
}
...
void RTDFactoryAdcGainRAdjustExit(void)
{
    ...
    if(g_usBackupValue != g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL])
    {
        g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL] = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_GAIN_RED_ADJ, g_stAdcData.ucAdcGainMSB[_AUTO_RED_CHANNEL]);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_GAIN_RED);
#endif
...
{
#if(_VGA_SUPPORT == _ON)
    if(g_usBackupValue != g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL])
    {
        UserCommonNVRamSaveADCSetting(_COLOR_SPACE_RGB);
    }
...
{
#if(_VGA_SUPPORT == _ON)    
    RTDFactoryOsdDispNumber(_MENU_FACTORY_GAIN_GREEN_ADJ, g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL]);
#endif
}
...
void RTDFactoryAdcGainGAdjustExit(void)
{
    ...
    if(g_usBackupValue != g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL])
    {
        g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL] = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_GAIN_GREEN_ADJ, g_stAdcData.ucAdcGainMSB[_AUTO_GREEN_CHANNEL]);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_GAIN_GREEN);
#endif
...
{
#if(_VGA_SUPPORT == _ON)
    if(g_usBackupValue != g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL])
    {
        UserCommonNVRamSaveADCSetting(_COLOR_SPACE_RGB);
    }
...
{
#if(_VGA_SUPPORT == _ON)
    RTDFactoryOsdDispNumber(_MENU_FACTORY_GAIN_BLUE_ADJ, g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL]);
#endif
}
...
void RTDFactoryAdcGainBAdjustExit(void)
{
    ...
    if(g_usBackupValue != g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL])
    {
        g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL] = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_GAIN_BLUE_ADJ, g_stAdcData.ucAdcGainMSB[_AUTO_BLUE_CHANNEL]);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_GAIN_BLUE);
#endif
...
{
#if(_VGA_SUPPORT == _ON)
    if(g_usBackupValue != g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL])
    {
        UserCommonNVRamSaveADCSetting(_COLOR_SPACE_RGB);
    }
...
{
#if(_VGA_SUPPORT == _ON)    
    RTDFactoryOsdDispNumber(_MENU_FACTORY_OFFSET_RED_ADJ, g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL]);
#endif
}
...
void RTDFactoryAdcOffsetRAdjustExit(void)
{
    ...
    if(g_usBackupValue != g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL])
    {
        g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL] = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_OFFSET_RED_ADJ, g_stAdcData.ucAdcOffsetMSB[_AUTO_RED_CHANNEL]);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_OFFSET_RED);
#endif
...
{
#if(_VGA_SUPPORT == _ON)
    if(g_usBackupValue != g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL])
    {
        UserCommonNVRamSaveADCSetting(_COLOR_SPACE_RGB);
    }
...
{
#if(_VGA_SUPPORT == _ON)
    RTDFactoryOsdDispNumber(_MENU_FACTORY_OFFSET_GREEN_ADJ, g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL]);
#endif
}
...
void RTDFactoryAdcOffsetGAdjustExit(void)
{
    ...
    if(g_usBackupValue != g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL])
    {
        g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL] = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_OFFSET_GREEN_ADJ, g_stAdcData.ucAdcOffsetMSB[_AUTO_GREEN_CHANNEL]);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_OFFSET_GREEN);
#endif
...
{
#if(_VGA_SUPPORT == _ON)
    if(g_usBackupValue != g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL])
    {
        UserCommonNVRamSaveADCSetting(_COLOR_SPACE_RGB);
    }
...
{
#if(_VGA_SUPPORT == _ON)
    RTDFactoryOsdDispNumber(_MENU_FACTORY_OFFSET_BLUE_ADJ, g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL]);
#endif
}
...
void RTDFactoryAdcOffsetBAdjustExit(void)
{
    ...
    if(g_usBackupValue != g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL])
    {
        g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL] = g_usBackupValue;
        RTDFactoryOsdDispNumber(_MENU_FACTORY_OFFSET_BLUE_ADJ, g_stAdcData.ucAdcOffsetMSB[_AUTO_BLUE_CHANNEL]);
    }
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_OFFSET_BLUE);
#endif
