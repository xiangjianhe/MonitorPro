...
#if(_PROJECT == _FOX_LI2241W_DSBJ_FQ21M31)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_DSBJ_FQ21M31//_TPV_CMI_M220ZGE// 
