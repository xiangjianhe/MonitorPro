...
#if(_PANEL_TYPE == _AUO_M170ETN01_1)
//----------------------------------------------------------------------------------------------------
// ID Code      : Panel.h No.0000
// Update Note  :
//
//----------------------------------------------------------------------------------------------------
#define _PANEL_ADC_OFFSET_BIAS                  3
//--------------------------------------------------
// 2D / 3D panel type
//--------------------------------------------------
...
#define _D_DITHER_VALUE_SIGN                    _ENABLE//_DISABLE
...
#define _PANEL_PIXEL_CLOCK_MIN                  75                 // Mininum Pixel Clock in MHz
...
#endif // End of #if(_PANEL_TYPE == _AUO_M170ETN01_1)
