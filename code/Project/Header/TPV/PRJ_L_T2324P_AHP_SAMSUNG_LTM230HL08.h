...
#if(_PROJECT == _PRJ_L_T2324P_AHP_SAMSUNG_LTM230HL08)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_SAMSUNG_LTM230HL08
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(T2324p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(T2324p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(T2324p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(T2324p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
#define _MODEL_NAME												'T','2','3','2','4','p'
#define _MICROCODE												'L','S','0','.','5'
#define _RELEASE_DATE                                        	'2','0','1','4','1','2','1','6'
#define _IC_SERIES                                      		'R','T','D','2','4','8','6','V','R','D'
#define _PANNEL_NAME 											'L','T','M','2','3','0','H','L','0','8'
...
#define MAX_CONTRAST_RATIO                                      114 // 1.75(unit 1/100)
...
//==================================================================
//jason.cheng 20141202_1 modify
#define _PWM_B00                                                70//70//0x58 //|00
#define _PWM_B10                                                87//78//0x58 //|10
#define _PWM_B20                                                104//85//0x5B //|20
#define _PWM_B30                                                120//0x63 //|30
#define _PWM_B40                                                137//130//0x6D //|40
#define _PWM_B50                                                154//145//0x7B //|50
#define _PWM_B60                                                171//160//0x8D //|60
#define _PWM_B70                                                188//175//0x9A //|70
...
#define _CT7200_LenovoPrj_GREEN                                 120
#define _CT7200_LenovoPrj_BLUE                                  127

#define _CTSRGB_LenovoPrj_RED                                   122
#define _CTSRGB_LenovoPrj_GREEN                                 120
#define _CTSRGB_LenovoPrj_BLUE                                  122

#define _CT6500_LenovoPrj_RED                                   122
#define _CT6500_LenovoPrj_GREEN                                 120
#define _CT6500_LenovoPrj_BLUE                                  122

#define _CT9300_LenovoPrj_RED                                   100
#define _CT9300_LenovoPrj_GREEN                                 108
#define _CT9300_LenovoPrj_BLUE                                  127
...
#endif // End of #if(_PROJECT == _PRJ_L_T2324P_AHP_SAMSUNG_LTM230HL08)
