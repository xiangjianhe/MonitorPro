...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Series_SyncProc.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6001_SERIES_SYNCPROC__
...
WORD ScalerSyncProcGetClampEndPosition(void)
{
    ...
    ScalerGetDataPortByte(CM_5C_SYNC_PROC_ACCESS_PORT, _CM_5D_PT_01_SYNC_G_CLAMP_END, 1, &pData[0], _NON_AUTOINC);    
    

    // Get BR/PbPr clamp end position
    ScalerGetDataPortByte(CM_5C_SYNC_PROC_ACCESS_PORT, _CM_5D_PT_03_SYNC_BR_CLAMP_END, 1, &pData[1], _NON_AUTOINC);        
...
void ScalerSyncProcSetDebounce(BYTE ucDebounce)
{
    ...
    ScalerSetDataPortBit(CM_5C_SYNC_PROC_ACCESS_PORT, _CM_5D_PT_19_HS_DETECT_SETTING, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), ucDebounce & 0x1F);
}
...
void ScalerSyncProcSetPorchVoltage(void)
{
    ...
    {    
        ...
        // Set SOG detect debounce to 0x1F; Enable SOG detect
        ScalerSetDataPortBit(CM_5C_SYNC_PROC_ACCESS_PORT, _CM_5D_PT_19_HS_DETECT_SETTING, ~(_BIT6 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT6 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
