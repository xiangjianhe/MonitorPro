...
#if(_PANEL_TYPE == _FOX_DSBJ_FQ18M31A_N)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MAX                     1570                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     815                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  96                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  63                 // Mininum Pixel Clock in MHz
