...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PRJ_L_LI2223wA_OD_AD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LI2223wA_OD_AD)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_RDG6643_6229_AD//_PCB_TPV_715G4482_6229_AD


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LT_LM215WF3_S2DB
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LI2223wA_OD_AD.h"
...
//==================================================================
#define _MODEL_NAME												_bL_, _bI_, _2_, _2_, _2_, _3_, _bw_, _bA_
#define _MICROCODE												_bL_,_bT_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _L,_I,_2,_2,_2,_3,_w,_A
#define _FW_RELEASE_DATE                                        _2,_0,_1,_3,_1,_1,_2,_8
#define _FW_VERSION                                             _L,_T,_0,_DOT,_1
#define _DDCCI_FIRMWARE_VERSION							        0x0002  //Ver 0.01	

#define _PANNEL_NAME 											'L','M','2','1','5','W','F','3'
...
#define _CTLOWBLUELIGHT_RED								  		0x80
#define _CTLOWBLUELIGHT_GREEN							   		0x6D
#define _CTLOWBLUELIGHT_BLUE							   		0x54
...
#endif // End of #if(_PROJECT == _PRJ_L_LI2223wA_OD_AD)
