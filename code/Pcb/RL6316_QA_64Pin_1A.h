...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6316_Demo_64Pin_1A.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6316_QA_64PIN_1A)
...
// AVS0
#define _64PIN_PIN_4                                 (0 & 0x03) // Page 10-0xBF[1:0]
// 0 ~ 1 (0: AVS0<I>, 1: P5D1i<I>)

// AHS0
#define _64PIN_PIN_5                                 (0 & 0x03) // Page 10-0xC0[1:0]
// 0 ~ 1 (0: AHS0<I>, 1: P5D2i<I>)

// B0-
#define _64PIN_PIN_6                                 (0 & 0x03) // Page 10-0xC1[1:0]
// 0 ~ 1 (0: B0-<I>, 1: P5D7i<I>)

// B0+
#define _64PIN_PIN_7                                 (0 & 0x03) // Page 10-0xC2[1:0]
// 0 ~ 3 (0: B0+<I>, 1: P6D4i<I>, 2: P6D4o<OD>, 3: P6D4o<PP>)

// G0-
#define _64PIN_PIN_8                                 (0 & 0x03) // Page 10-0xC3[1:0]
// 0 ~ 1 (0: G0-<I>, 1: P6D5i<I>)

// G0+
#define _64PIN_PIN_9                                 (0 & 0x03) // Page 10-0xC4[1:0]
// 0 ~ 3 (0: G0+<I>, 1: P6D6i<I>, 2: P6D6o<OD>, 3: P6D6o<PP>)

// SOG0
#define _64PIN_PIN_10                                 (0 & 0x03) // Page 10-0xC5[1:0]
// 0 ~ 1 (0: SOG0<I>, 1: P6D7i<I>)

// Ro-
#define _64PIN_PIN_11                                 (0 & 0x03) // Page 10-0xC6[1:0]
// 0 ~ 1 (0: R0-<I>, 1: P7D0i<I>)

// Ro+
#define _64PIN_PIN_12                                 (0 & 0x03) // Page 10-0xC7[1:0]
// 0 ~ 3 (0: R0+<I>, 1: P7D1i<I>, 2: P7D1o<OD>, 3: P7D1o<PP>)

// TXE3+
#define _64PIN_PIN_39                                 (0 & 0x07) // Page 10-0xC8[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P3D1i<I>, 2: P3D1o<OD>, 3: P3D1o<PP>, 4: PWM4<OD>, 5: PWM4<PP>)

// TXE3-
#define _64PIN_PIN_40                                 (0 & 0x07) // Page 10-0xC9[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P1D2i<I>, 2: P1D2o<OD>, 3: P1D2o<PP>, 4: PWM4<OD>, 5: PWM4<PP>)

// TXEC+
#define _64PIN_PIN_41                                 (0 & 0x07) // Page 10-0xCA[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P1D4i<I>, 2: P1D4o<OD>, 3: P1D4o<PP>, 4: PWM3<OD>, 5: PWM3<PP>)

// TXEC-
#define _64PIN_PIN_42                                 (0 & 0x07) // Page 10-0xCB[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P1D0i<I>, 2: P1D0o<OD>, 3: P1D0o<PP>, 4: PWM3<OD>, 5: PWM3<PP>)

// TXE2+
#define _64PIN_PIN_43                                 (0 & 0x07) // Page 10-0xCC[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P1D5i<I>, 2: P1D5o<OD>, 3: P1D5o<PP>, 4: PWM2<OD>, 5: PWM2<PP>)

// TXE2-
#define _64PIN_PIN_44                                 (0 & 0x07) // Page 10-0xCD[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P1D6i<I>, 2: P1D6o<OD>, 3: P1D6o<PP>, 4: PWM2<OD>, 5: PWM2<PP>)

// TXE1+
#define _64PIN_PIN_45                                 (0 & 0x07) // Page 10-0xCE[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P1D7i<I>, 2: P1D7o<OD>, 3: P1D7o<PP>, 4: PWM1<OD>, 5: PWM1<PP>)

// TXE1-
#define _64PIN_PIN_46                                 (0 & 0x07) // Page 10-0xCF[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P3D4i<I>, 2: P3D4o<OD>, 3: P3D4o<PP>, 4: PWM1<OD>, 5: PWM1<PP>)

// TXE0+
#define _64PIN_PIN_47                                 (0 & 0x07) // Page 10-0xD0[2:0]
// 0 ~ 5 (0: Hi-Z, 1: P3D5i<I>, 2: P3D5o<OD>, 3: P3D5o<PP>, 4: PWM0<OD>, 5: PWM0<PP>)

// TXE0-
#define _64PIN_PIN_48                                 (0 & 0x07) // Page 10-0xD1[2:0]
...
// Macro of IIC
//--------------------------------------------------
sbit bSWIIC_SYS_EEPROM_SCL                      = P1 ^ 1; // Pin29 P1.1
sbit bSWIIC_SYS_EEPROM_SDA                      = P3 ^ 3; // Pin30 P3.3
...
//-----------------------------------------------
#define bFLASH_WRITE_PROTECT                    (MCU_PORT74_PIN_REG_FFD3) //none
...
//----------------------------------------------- 
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT74_PIN_REG_FFD3) // none
...
//-----------------------------------------------
sbit bA0_CONNECT                                = P3 ^ 0;   // TQFP Pin 13, P3.0
...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1                                      = P3 ^ 2;  // TQFP Pin28, P3.2
sbit bLED2                                      = P3 ^ 6;  // TQFP pin16, P3.6
...
#define AD_KEY2                                 (MCU_ADC0_RESULT_FF09)
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_PORT56_PIN_REG_FFC5)   // TQFP Pin15, P5.0
...
#endif // End of #if(_PCB_TYPE == _RL6316_QA_1A)
