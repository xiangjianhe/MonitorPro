...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_Pinshare.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6229_SERIES_PINSHARE__
...
void ScalerPinshareInitial(void)
{
    ...
    ScalerSetBit(P10_B9_PIN_SHARE_CTRL16, ~(_BIT6 | _BIT5 | _BIT4), ((BYTE)_P31_39_SEL << 6) | ((BYTE)_P41_48_SEL << 4)); // Page 10-B9 Pin 40
    ...
    //check if pin 66-67 are assigned to  DDC2P
#if(_PIN_66 == 11) && (_PIN_67 == 10)
    ScalerSetBit(P10_DB_PIN_SHARE_CTRL1E, ~_BIT7, _BIT7); // Enable DDC2P
    ScalerSetBit(P10_BD_IICAUX_DDC2P_CTRL0, ~_BIT0, _BIT0);
#else
    ...
    ScalerSetBit(P10_DB_PIN_SHARE_CTRL1E, ~_BIT7, 0x00); // Disable DDC2P
#endif

    ScalerSetByte(P10_DD_PIN_SHARE_CTRL20, (BYTE)_PIN_68); // Page 10-D8 Pin 68

    //check if pin 69-70 are assigned to  DDC2P or IIC
#if(_PIN_69 == 12) && (_PIN_70 == 12)
    ScalerSetBit(P10_DE_PIN_SHARE_CTRL21, ~(_BIT7 | _BIT6), _BIT7); // Enable DDC2P
    ScalerSetBit(P10_BD_IICAUX_DDC2P_CTRL0, ~_BIT0, _BIT0);
#elif(_PIN_69 == 13) && (_PIN_70 == 13)
    ScalerSetBit(P10_DE_PIN_SHARE_CTRL21, ~(_BIT7 | _BIT6), _BIT6); // Enable IIC
#else
    ...
    ScalerSetBit(P10_DE_PIN_SHARE_CTRL21, ~(_BIT7 |_BIT6) , 0x00); // Disable DDC2P and IIC
#endif
...
void ScalerPinshareHwIICPin(BYTE ucHwIICPinNum)
{
    ...
    switch(ucHwIICPinNum)
    {
        ...
        ScalerSetBit(P10_DE_PIN_SHARE_CTRL21, ~(_BIT7 | _BIT6), _BIT6);
...
void ScalerPinshareAdjustConfig(EnumConfigPin enumConfigPin, EnumPinConfigTyte enumConfigTyte)
{
    switch(enumConfigPin)
    {
        ...
        case _CONFIG_76PIN_PIN21:
            ...
            {
                case _GPI:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;

                case _PWM0_PP:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
                    break;

                case _PWM0_OD:
                    ScalerSetBit(P10_A7_PIN_SHARE_CTRL07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
                    break;
        ...
        case _CONFIG_128PIN_PIN_108:
            ...
            {
                case _GPI:
                    ScalerSetBit(P10_EE_PIN_SHARE_CTRL31, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_EE_PIN_SHARE_CTRL31, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_EE_PIN_SHARE_CTRL31, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;
        ...
        case _CONFIG_128PIN_PIN_109:
            ...
            {
                case _GPI:
                    ScalerSetBit(P10_EF_PIN_SHARE_CTRL32, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_EF_PIN_SHARE_CTRL32, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_EF_PIN_SHARE_CTRL32, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;

                case _PWM2_PP:
                    ScalerSetBit(P10_EF_PIN_SHARE_CTRL32, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));
                    break;

                case _PWM2_OD:
                    ScalerSetBit(P10_EF_PIN_SHARE_CTRL32, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT3);
                    break;
        ...
        case _CONFIG_128PIN_PIN_126:
	            ...
	            case _GPI:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);

                    case _GPO_PP:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                        break;

                    case _GPO_OD:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                        break;

                    case _PWM0_PP:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
                        break;

                    case _PWM0_OD:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
                        break;

    	            case _PWM1_PP:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
                        break;

                    case _PWM1_OD:
                        ScalerSetBit(P10_FA_PIN_SHARE_CTRL3D, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));
                        break;
