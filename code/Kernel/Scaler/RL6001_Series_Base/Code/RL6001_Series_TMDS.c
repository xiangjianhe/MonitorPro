...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Series_TMDS.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6001_SERIES_TMDS__
...
{       
    ...
    // [6] eqcpop_en
    ScalerSetBit_EXINT0(PB_AD_DP_FLD_09, ~_BIT6, 0x00);
    ...
    ScalerSetBit_EXINT0(PB_B8_DP_AUX_01, ~(_BIT7 | _BIT6 | _BIT5), _BIT6);
    ...
    {
        // CDR Para.       
        ScalerSetByte_EXINT0(PB_A1_DP_CDR_01, 0x82);    
        ScalerSetByte_EXINT0(PB_A2_DP_CDR_02, 0xA9);  

        // Enable CDR 1pf cp 1pF, CDR1pf cp 0.5pF
        ScalerSetBit_EXINT0(PB_B8_DP_AUX_01, ~(_BIT7 | _BIT5), (_BIT7 | _BIT5));

        // [0] cpsc --> Disable Loop Capacitor
        ScalerSetBit_EXINT0(PB_A3_DP_CDR_03, ~_BIT0, _BIT0);
        
        // reg_xtal_sel = 1
        ScalerSetBit_EXINT0(PB_A9_DP_FLD_05, ~_BIT0, _BIT0);

        // [4:3] more_hpf
        ScalerSetBit_EXINT0(PB_B2_DP_ADP_EQ, ~(_BIT4 | _BIT3), 0x00);
    }
    else if((GET_INPUT_PIXEL_CLK() >= 500) && (GET_INPUT_PIXEL_CLK() < 1000)) // 50~100MHz
    {
        // CDR Para. 
        ScalerSetByte_EXINT0(PB_A1_DP_CDR_01, 0x42);    
        ScalerSetByte_EXINT0(PB_A2_DP_CDR_02, 0xA9);  

        // [4:3] more_hpf
        ScalerSetBit_EXINT0(PB_B2_DP_ADP_EQ, ~(_BIT4 | _BIT3), _BIT4);        
    }
    ...
    ScalerSetBit_EXINT0(PB_A4_DP_FLD_00, ~_BIT6, _BIT6);
    ...
    // [5] offset_autok
    ScalerSetBit_EXINT0(PB_B2_DP_ADP_EQ, ~_BIT5, _BIT5);
