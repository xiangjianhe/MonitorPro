...
#if(_PCB_TYPE == _RL6229_FOXCONN_LEN_T2224pwD_PCB)
...
// Macro of IIC
//--------------------------------------------------
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin 56, P6.6
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin 57, P6.7
...
//-----------------------------------------------
#define bAUDIO_DETECT                             (MCU_PORT_PD4_PIN_REG_FF7A)//_PIN_34
#define PCB_AUDIO_DETECT()                        (bAUDIO_DETECT)
...
//-----------------------------------------------
#define bAMPMUTE                      			(MCU_PORT_PD3_PIN_REG_FF7B) // _PIN_35
