...
//----------------------------------------------------------------------------------------------------
// ID Code      : UserEepromOsd.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _EEPROM_SN_ADDRESS                     	    (_EEPROM_EDID_CHKSUM_ADDRESS + _EDID_CHKSUM_SIZE)     // 0x155 22 Byte        
...
//--------------------------------------------------------
    ...
    BYTE b33DModeStatus : 3;            //Eli Add
//--------------------------------------------------------
    BYTE b3NovoVisionStatus : 3;        //Eli Add
    BYTE b2OsdButtonRepeatStatus : 2;   //Eli Add
    BYTE b1KeypadBuzzerStatus : 1;      //Eli Add        
//--------------------------------------------------------
    BYTE ucVolume;
//--------------------------------------------------------
    BYTE b33DConvergenceMode : 3;
	BYTE b1OSDLockFlag : 1;             //lorimiao 20130729 for OSD lock issue
	BYTE b1FactoryReset : 1;
    BYTE b1DPType : 1;                  //DP1.1 or 1.2
    BYTE b1LowBlueLightStatus : 1;	
    BYTE b4PresetColorTempBackUp : 4;	//jason.cheng 20141203_1 add
...
//----------------------------------------------------------------------------------------
// Extern functions from UserEepromOsd.c
//----------------------------------------------------------------------------------------
...
extern void RTDFlashLoadPanelUsedTimeData(void);
extern void RTDFlashSavePanelUsedTimeData(void);
extern void RTDFlashRestorePanelUsedTimeData(void);
extern void RTDFlashLoadPanelIndex(void);
extern void RTDFlashSavePanelIndex(void);
...
#define RTDNVRamLoadPanelUsedTimeData()                RTDFlashLoadPanelUsedTimeData()
...
#define RTDNVRamLoadPanelIndex()                       RTDFlashLoadPanelIndex()
#define RTDNVRamSavePanelIndex()                       RTDFlashSavePanelIndex()
