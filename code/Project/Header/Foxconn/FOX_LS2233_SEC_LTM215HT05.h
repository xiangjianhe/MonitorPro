...
#if(_PROJECT == _FOX_LS2233_SEC_LTM215HT05)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                            _FOX_SEC_LTM215HT05 //_FOX_DSBJ_FQ21M31_D
...
//--------------------------------------------------
#define _CHECKSUM                                       0x2B
#define _VERSION_CODE                                   0xaf

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _L,_S,_2,_2,_3,_3,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_S,_E,_C,_SPACE,_L,_T,_M,_2,_1,_5,_H,_0,_5
...
#define _MICROCODE                                      _bL_,_bS_, _b2_, _DOT, _b0_
//Facory Command
