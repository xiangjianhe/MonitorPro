...
#if(_PANEL_TYPE == _AUO_LED_LVDS_18_5_WUXGA)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         1606                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2047                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1416                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         808                 // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1023                 // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     776                 // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  90                  // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  55                  // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                      5                   // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      25                  // Panel Power On T2 (ms)
...
//--------------------------------------------------
// Definitions for ELED Panel Parameter
//--------------------------------------------------
#define _PANEL_ELED_STRING_NUMBER               4                   // Eled Panel String Number
#define _PANEL_ELED_STRING_CURRENT              60                  // Every Led String Current
#define _PANEL_ELED_VOUT_TYPICAL                24                  // Eled Panel Vout Typical Voltage
#define _PANEL_ELED_VOUT_MAX                    25                  // Eled Panel Vout Max Value
#define _PANEL_ELED_ALL_SHORT_VOLTAGE           5                   //by panel has differential voltage
...
#endif // End of #if(_PANEL_TYPE == _AUO_LED_LVDS_18_5_WUXGA)
