...
#if(_PANEL_TYPE == _TPV_LG_LM230WF9_SSA1)
//----------------------------------------------------------------------------------------------------
...
// Panel Name Define
//--------------------------------------------------
#define _PANEL_NAME                              _L,_M,_2,_3,_0,_W,_F,_9,_MINUS,_S,_S,_A,_1
//--------------------------------------------------
// 2D / 3D panel type
//--------------------------------------------------
...
#define _PANEL_DV_TOTAL_MAX                     1220                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_POWER_OFF_T5                     10 //20                  // Panel Power Off T5 (ms)
