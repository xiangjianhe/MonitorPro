...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6230_Series_ADC.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6230_SERIES_ADC__
...
#warning "Not Apply the Solution in RL6230 Series!!"
#endif
...
{    
    ...
    if(ulAdcClock < 38)
    {
        ScalerSetBit(P0_CE_ADC_CTL_RGB, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);                    // 75MHz
    }
    else if(ulAdcClock < 68)
    {
        ScalerSetBit(P0_CE_ADC_CTL_RGB, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));          // 150MHz
    }
    else if(ulAdcClock < 160)
    {
        ScalerSetBit(P0_CE_ADC_CTL_RGB, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));          // 300MHz
    }
    else
    {
        ScalerSetBit(P0_CE_ADC_CTL_RGB, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));  // 500MHz
    }
...
void ScalerADCPGAbyPassSetting(void)
{
    // 6230 have no PGA by pass option
}
