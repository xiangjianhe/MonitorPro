...
void ScalerFRCDisplayCtrl(WORD usHorSize, WORD usVerSize)
{
    ...
    // Set Block step
	ScalerSetByte(P5_CB_SDRF_MN_BLOCK_STEP_H, HIBYTE((WORD)(stStep.ulBlockStep >> 11) & 0xFFFF));
    ScalerSetByte(P5_CC_SDRF_MN_BLOCK_STEP_L, LOBYTE((WORD)(stStep.ulBlockStep >> 11) & 0xFFFF));
