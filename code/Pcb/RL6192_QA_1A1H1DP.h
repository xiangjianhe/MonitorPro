...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_QA_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6192_QA_1A1H1DP)
...
//-----------------------------------------------
#define bDP_PIN15_CONNECT                       (MCU_PORT63_PIN_REG_FFCA) // Pin53, P6.3
#define bDP_PIN16_CONNECT                       (MCU_PORT76_PIN_REG_FFD5) // Pin102, P7.6
sbit bDP_PIN17_CONNECT                          = P1 ^ 7; // Pin 71, P1.7

sbit bA0_CONNECT								= P1 ^ 3; // Pin 67, P1.3
#define bD0_CONNECT								(MCU_PORT76_PIN_REG_FFD5) // Pin 102, P7.6
...
#endif // End of #if(_PCB_TYPE == _RL6192_QA_1A1H1DP)
