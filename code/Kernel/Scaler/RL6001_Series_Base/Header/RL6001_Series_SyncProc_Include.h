...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6001_Series_SyncProc_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _SYNC_PROC_CLK                              _SYS_CLK_KHZ
...
//--------------------------------------------------
#define _CAP_WINDOW_WIDTH_DEFAULT                   0 // Unit: syncprocessor clock
#define _CAP_WINDOW_WIDTH_TOR                       2 // Unit: syncprocessor clock

//--------------------------------------------------
// Definitions Of Analog Measure Tolerance
//--------------------------------------------------
#define _ANALOG_MEASURE_HS_TOR                      2 // Unit: syncprocessor clock
...
// Phase delay
//--------------------------------------------------
#define _PHASE_DELAY_TIME_VALUE                     377 // 363         
#define _PHASE_DELAY_HALF_PERIOD_SHIFT              ((ScalerGetBit(P0_BB_ADC_2X_SAMPLE, _BIT5) == _BIT5) ? 0 : 32)
...
#ifndef __RL6001_SERIES_SYNCPROC__
//****************************************************************************
// VARIABLE EXTERN
//****************************************************************************
...
#endif // End of #ifndef __RL6001_SERIES_SYNCPROC__
