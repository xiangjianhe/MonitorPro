...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _PRJ_L_LT2013P_AHP)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G5919_6192_AHP//_RL6192_DEMO_1A1H1DP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_CMI_M195FGE_L20
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT2013P_AHP.h"
...
//Eli 20121127 H9CMT178GTG1HN-23 Modify DDCCI input source switch command bug.
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 04 0f) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 04 0f) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 04 0f) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(LT2013pDemo)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 04 0f) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"  
...
#define _DIGITAL_VOLUME_MAX                                     0x0068 // _AUDIO_VOLUME_8BIT MAX:0x00FF
...
//-------------------------------------------------
#define _SOURCE_AUTO_SEARCH_STYLE                               _SOURCE_POLLING_AFTER_NOSIGNAL_STATE//Eli 20121127 H9CMT178GTG1HN-24 can't switch source issue.                            

//-------------------------------------------------
// Definitions of Required Default Search Time when Using _SOURCE_POLLING_AFTER_NOSIGNAL_STATE
//-------------------------------------------------
#define _SOURCE_DEFAULT_SEARCH_TIME_VGA                         SEC(1.5)//Eli 20130102 Add Shenzhen Lenovo PC change timing show OOR solution.
...
#define _CALIBRATION_R_GAIN_BIAS                                (2) // Needs modification for EVERY single source
#define _CALIBRATION_G_GAIN_BIAS                                (2) // Needs modification for EVERY single source
#define _CALIBRATION_B_GAIN_BIAS                                (2) // Needs modification for EVERY single source
...
#define _AUTO_PB_GAIN_BIAS                                      (6)
#define _AUTO_PR_GAIN_BIAS                                      (6)
#define _AUTO_Y_GAIN_BIAS                                       (1)
#define _AUTO_PB_OFFSET_BIAS                                    (-5)
#define _AUTO_PR_OFFSET_BIAS                                    (-5)
...
//--------------------------------------------------
#define _DIG_FILTER_PHASE_THD                                   2 //effective:0~7//Eli 20121215 Add Beijing smear & phase issue solution.
...
#define _DIG_FILTER_MISMATCH_THD                                0 //effective:0~1
#define _DIG_FILTER_MISMATCH_DIV_VALUE                          0 //effective:0~3
*/
...
//#define _DIG_FILTER_MISMATCH_ENABLE                             _ENABLE//Eli 20121216 update STD code.  
#define _DIG_FILTER_EXTENSION_ENABLE                            _ENABLE 
/*//Eli 20121216 update STD code. 
#define _DIG_FILTER_RING_SMEAR_CON                              0 //0~4 00:disable 01:reduce ringing 10:reduce smear 11:no adjust
#define _DIG_FILTER_MISMATCH_NR_CON                             0 //0:mismatch 1:NR
*/
...
// Maximum Value: 30ms in Active Mode
//                210ms in PS
//-------------------------------------------------
...
//==================================================================
#define _MODEL_NAME												_bL_, _bT_, _2_, _0_, _1_, _3_, _bP_
#define _MICROCODE												_bL_,_bM_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _L,_T,_2,_0,_1,_3,_p
#define _FW_RELEASE_DATE                                        _2,_0,_1,_2,_1,_2,_1,_8
#define _FW_VERSION                                             _L,_M,_0,_DOT,_1
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.01	

#define _PANNEL_NAME 											'M','1','9','5','F','G','E'
...
#define _INPUT_PORT_MAX                                         3//Eli 20121127 H9CMT178GTG1HN-23 Modify DDCCI input source switch command bug.
#define _DIGITAL1_TYPE                                          _HDMI_PORT//_DP_PORT
#define _DIGITAL2_TYPE                                          _DP_PORT//_DVI_PORT
...
#define _PWM_B80                                                0xB9 //|80 20120922 Abel Color temp modify
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   128
#define _CT7200_LenovoPrj_GREEN                                 126
...
#define _CT9300_LenovoPrj_RED                                   118
#define _CT9300_LenovoPrj_GREEN                                 115
...
#endif // End of #if(_PROJECT == _PRJ_LNV_LT2013P_DEMO_6192)
