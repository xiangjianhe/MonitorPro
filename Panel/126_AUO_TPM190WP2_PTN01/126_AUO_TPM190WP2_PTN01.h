...
/********************************************************************************/
#if(_PANEL_TYPE == _TPV_AUO_TPM190WP2_PTN01)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         1928               // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2996                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1520                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         916                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1801                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     914                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      106                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  134                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  69                  // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      20//5                           // Panel Power On T1 (ms) CMI_spec:0<T2<50ms
#define _PANEL_POWER_ON_T2                      20                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      550                 // Panel Power On T3 (ms) CMI_spec:T5>200ms

#define _PANEL_POWER_OFF_T4                     250                 // Panel Power Off T4 (ms) CMI_spec:T6>100ms
#define _PANEL_POWER_OFF_T5                     5//30                         // Panel Power Off T5 (ms) CMI_spec:0<T3<50ms
#define _PANEL_POWER_OFF_T6                     1150                // Panel Power Off T6 (ms) CMI_spec:T4>500ms
