...
//--------------------------------------------------
#define _DEFAULT_BRIGHTNESS                         0x80
#define _DEFAULT_CONTRAST                           _OSD_CONTRAST_DEF_VALUE
...
//--------------------------------------------------------
    ...
    _OFF,                   // b1Osd3DOSD : 1;
    _OFF,                   // b1VolumeMute : 1;
    _OFF,                   // b1AudioStandalongStatus : 1;
...
//--------------------------------------------------------
    ...
    0,						// bOsdPosStatus : 1
    0,						// bColorTempStatus : 1
    _OSD_BUTTON_REPEAT_DEFAULT, // bOsdButtonRepeatStatus : 2;	// jimmy 20121011_3
//--------------------------------------------------------
    _OFF,                   // b1OsdLockStatus : 1;   
...
void RTDEepromStartup(void)
{
    ...
    {
        RTDEepromLoadColorSetting(_CT_USER);
    }
    else
    {
...
{
#if(_FACTORY_MODE_OWNER == _OWNER_WISTRON) 
    UserInterfaceCheckNVRamData(_CHECK_OSD_DATA_SAVE);
#endif
...
void RTDEepromLoadBriCon(void)
{
    UserCommonEepromRead(_BRICON_DATA_ADDRESS , sizeof(StructBriConDataType), (BYTE *)(&g_stBriConData));
#if((_FACTORY_MODE_OWNER == _OWNER_WISTRON) || (_FACTORY_MODE_OWNER == _OWNER_TPV))
...
{
#if(_FACTORY_MODE_OWNER == _OWNER_WISTRON) 
    UserInterfaceCheckNVRamData(_CHECK_BRICON_DATA_SAVE);
#endif
    UserCommonEepromWrite(_BRICON_DATA_ADDRESS , sizeof(StructBriConDataType), (BYTE *)(&g_stBriConData));
}
...
void RTDEepromSaveColorSetting(BYTE ucColorTempType)
{
    ...
    {
#if(_FACTORY_MODE_OWNER == _OWNER_WISTRON)     
        UserInterfaceCheckNVRamData(_CHECK_COLORTEMP_DATA_SAVE|(ucColorTempType<<4));    
#endif
