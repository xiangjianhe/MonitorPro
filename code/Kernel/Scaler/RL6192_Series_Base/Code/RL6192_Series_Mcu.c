...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6192_Series_Mcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6192_SERIES_MCU__
...
#elif((_D1_DDC_CHANNEL_SEL == _DDC3) || (_D1_DDC_CHANNEL_SEL == _DPDDC3_TMDSDDC2))
...
#elif((_D1_DDC_CHANNEL_SEL == _DDC2) || (_D1_DDC_CHANNEL_SEL == _DPDDC2_TMDSDDC3))
...
#if((_D1_DDC_CHANNEL_SEL == _DDC2) || (_D1_DDC_CHANNEL_SEL == _DPDDC2_TMDSDDC3))
...
#if(_D1_DDC_CHANNEL_SEL == _DPDDC3_TMDSDDC2)
    // DDC2 Force Nack
    MCU_DVI_EDID_IRQ_FFE4 |= _BIT5;
#elif(_D1_DDC_CHANNEL_SEL == _DPDDC2_TMDSDDC3)
    // DDC3 Force Nack
    MCU_HDMI_EDID_IRQ_FFE5 |= _BIT5;
#endif
