...
#if(_PANEL_TYPE == _BOE_HM236WU1_300)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         2116                // Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1136                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1115                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MIN                  118                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      10                 // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      40                 // Panel Power On T2 (ms)29
#define _PANEL_POWER_ON_T3                      300                // Panel Power On T3 (ms)240

#define _PANEL_POWER_OFF_T4                     300                 // Panel Power Off T4 (ms)254
#define _PANEL_POWER_OFF_T5                     30                  // Panel Power Off T5 (ms)236
#define _PANEL_POWER_OFF_T6                     1000                 // Panel Power Off T6 (ms)


#define _PANEL_ADC_OFFSET_BIAS                  (2) // 0~5
#define _PANEL_REDUECE_ADC_GAIN                 (0) 
...
#endif // End of #if(_PANEL_TYPE == _BOE_HM236WU1_300)
