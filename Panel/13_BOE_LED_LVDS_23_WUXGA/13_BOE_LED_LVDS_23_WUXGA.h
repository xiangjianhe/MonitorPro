...
#if(_PANEL_TYPE == _BOE_LED_LVDS_23_WUXGA)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_PIXEL_CLOCK_MAX                  210                 // Maxinum Pixel Clock in MHz
...
//--------------------------------------------------
#define _PANEL_ELED_STRING_NUMBER               2                   // Eled Panel String Number
#define _PANEL_ELED_STRING_CURRENT              120                 // Every Led String Current
#define _PANEL_ELED_VOUT_TYPICAL                54                  // Eled Panel Vout Typical Voltage
#define _PANEL_ELED_VOUT_MAX                    57                  // Eled Panel Vout Max Value
...
#endif // End of #if(_PANEL_TYPE == _BOE_LED_LVDS_23_WUXGA)
