...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Demo_1A1H1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6229_FOXCONN_LEN_T2224zwD_PCB)
...
#define _EMBEDDED_DDCRAM_D0_LOCATION            _EDID_TABLE_LOCATION_USER

#define _D1_INPUT_PORT_TYPE                     _D1_DP_PORT
#define _D1_DDC_CHANNEL_SEL                     _DDC3
#define _EMBEDDED_DDCRAM_D1_SIZE                _EDID_SIZE_256
#define _EMBEDDED_DDCRAM_D1_LOCATION            _EDID_TABLE_LOCATION_SYSTEM_EEPROM
...
// NC Pin
#define _PIN_34                                 (0 & 0x07) // Page 10-0xB7[1:0]
...
// NC Pin
#define _PIN_41                                 (1 & 0x07) // Page 10-0xA0[7:6]
...
// Panel On
#define _PIN_64                                 (1 & 0x1F) // Page 10-0xA3[3:0]
...
// BL_ADJ
#define _PIN_103                                (2 & 0x0F) // Page 10-0xAC[6:4]
...
// BL_EN
#define _PIN_104                                (2 & 0x0F) // Page 10-0xAC[3:1]
...
// HDMI_HOT_PLUG
#define _PIN_112                                (2 & 0x0F) // Page 10-0xAE[2:0]
...
// NC Pin
#define _PIN_113                                (1 & 0x0F) // Page 10-0xB0[7:5]
...
// Pin65~72,100~103 Normal Operation //
//////////////////////////////////////
#define PCB_GPIO_SETTING_POWER_NORMAL()         {\    
                                                    ...
                                                    ScalerSetBit(P10_BB_PIN_PULLUP_CTRL4, ~(_BIT7 | _BIT6 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);    \    
													PCB_CAMERA_ENABLE(_CAMERA_ENABLE);\
													PCB_USB_POWER(_USB_POWER_ON);\
												}

////////////////////////////////////////////////////////
// Pin39~40 pull up control --> GPIO Function Disable //
// Pin65~72,100~103 pull up Control                    //    
////////////////////////////////////////////////////////
#define PCB_GPIO_SETTING_POWER_SAVING()         {\
                                                    ScalerSetBit(P10_B5_PIN_DRIVING_CTRL3, ~_BIT0, _BIT0);    \                                
                                                    ScalerSetBit(P10_BB_PIN_PULLUP_CTRL4, ~(_BIT7 | _BIT6 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | _BIT6 | _BIT3 | _BIT2 | _BIT1 | _BIT0));    \
													PCB_CAMERA_ENABLE(_CAMERA_DISABLE);\
												}
...
//HDMI
#define bSWIIC_D0_EDID_EEPROM_SCL               (MCU_PORT70_PIN_REG_FFCF) // Pin 124, P7.0
#define bSWIIC_D0_EDID_EEPROM_SDA               (MCU_PORT71_PIN_REG_FFD0) // Pin 123, P7.1

#define bSWIIC_SYS_CODEC_SCL					(MCU_PORT75_PIN_REG_FFD4) // Pin 103, 
#define bSWIIC_SYS_CODEC_SDA					(MCU_PORT74_PIN_REG_FFD3) // Pin 104, 
...
#define PCB_SW_IIC_SDA_SET()                    {\
                                                    ...
                                                    else if(GET_SW_IIC_STATUS() == _IIC_D0_EDID_EEPROM) \
                                                    {                                          \
                                                        bSWIIC_D0_EDID_EEPROM_SDA = _TRUE;         \
                                                    }                                          \
												}
#define PCB_SW_IIC_SDA_CLR()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_D0_EDID_EEPROM_SDA = _FALSE;         \
                                                    }                                          \
                                                }
...
#define PCB_SW_IIC_SCL_SET()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_D0_EDID_EEPROM_SCL = _TRUE;         \
                                                    }                                          \
                                                }
#define PCB_SW_IIC_SCL_CLR()                    {\
                                                    ...
                                                    {                                          \
                                                        bSWIIC_D0_EDID_EEPROM_SCL = _FALSE;         \
                                                    }                                          \
                                                }
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) //  Pin 55, P6.5
...
#define bEDID_WRITE_PROTECT                    	(MCU_PORT_PD2_PIN_REG_FF7C)    // Pin 36
...
#define PCB_WIRTE_HDMI_EDID_READY()  {\
                                            SET_SW_IIC_STATUS(_IIC_D0_EDID_EEPROM);\
                                            ScalerPinshareGpioDdcPinSwitch(_DDC2_SWITCH_GPIO);	\
                                            PCB_D0_EDID_EEPROM_WRITE_PROTECT(_EDID_EEPROM_WP_DISABLE)\
                                       }

#define PCB_WIRTE_HDMI_EDID_FINISH()  {\
                                            PCB_D0_EDID_EEPROM_WRITE_PROTECT(_EDID_EEPROM_WP_ENABLE)\
                                            ScalerPinshareGpioDdcPinSwitch(_DDC2_SWITCH_DDC);	\
                                            SET_SW_IIC_STATUS(_IIC_SYS_EEPROM);\
                                       }

#define PCB_READ_HDMI_EDID_READY()  {\
                                            SET_SW_IIC_STATUS(_IIC_D0_EDID_EEPROM);\
                                            ScalerPinshareGpioDdcPinSwitch(_DDC2_SWITCH_GPIO);	\
                                      }

#define PCB_READ_HDMI_EDID_FINISH()  {\
                                            ScalerPinshareGpioDdcPinSwitch(_DDC2_SWITCH_DDC);	\
                                            SET_SW_IIC_STATUS(_IIC_SYS_EEPROM);\
                                      }

#define PCB_WIRTE_DVI_EDID_READY()  {\
                                      }

#define PCB_WIRTE_DVI_EDID_FINISH()  {\
                                     }

#define PCB_READ_DVI_EDID_READY()  {\
                                     }

#define PCB_READ_DVI_EDID_FINISH()  {\
                                     }

//-----------------------------------------------
// Macro of Input Connect Detect
//-----------------------------------------------
#define bDP_PIN15_CONNECT                       (MCU_PORTC0_PIN_REG_FFA3)//PIN 126 Pc.0 
#define bDP_PIN16_CONNECT                       (MCU_PORT_PD6_PIN_REG_FF78) // Pin 32, PD.6
#define bDP_PIN17_CONNECT                       (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_PORT63_PIN_REG_FFCA) // Pin 53, P6.3

#define bA0_CONNECT                             (MCU_PORT_PD7_PIN_REG_FF77) // Pin 31, PD.7
#define bD0_CONNECT                             (MCU_PORT_PD5_PIN_REG_FF79) // Pin 33, PD.5
...
//-----------------------------------------------
sbit bD0_HPD                                    = P3 ^ 5; // Pin 112, P3.5 for HDMI
...
sbit bD1_HPD                                    = P3 ^ 4; // Pin 111, P3.4 for DP
...
#define PCB_LED_OFF()                           {\
                                                    bLED1 = _LED_OFF;               \
                                                    bLED2 = _LED_OFF;               \
	                                                PCB_CALL_HOOK_LED(_CALL_HOOK_OFF);\
	                                                PCB_SPK_MUTE_LED(_SPK_MUTE_OFF);\
	                                                PCB_MIC_MUTE_LED(_MIC_MUTE_OFF);\
                                                }
...
#define bPOWER_KEY								(MCU_PORTC3_PIN_REG_FFA0)
#define bUP_KEY									(MCU_PORT67_PIN_REG_FFCE) // Pin 57, P6.7
#define bDOWN_KEY								(MCU_PORT66_PIN_REG_FFCD) // Pin 56, P6.6
...
//--------------------------------------------------
sbit bPANELPOWER                                = P1 ^ 0; // Pin 64, P1.0
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
                                                        ...
                                                        ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, (WORD)10000); \
                                                    }\
                                                    else\
                                                    {\
...
//-----------------------------------------------
#define bAmpPower                               (MCU_PORT_PD1_PIN_REG_FF7D)//PIN37
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_PORT_PD3_PIN_REG_FF7B) // _PIN_35
...
//-----------------------------------------------
#define bUSB_DETECT                             (MCU_PORT60_PIN_REG_FFC7)//_PIN_50
#define PCB_USB_DETECT()                        (bUSB_DETECT)

//-----------------------------------------------
#define bUSB_POWER                             (MCU_PORT_PD0_PIN_REG_FF7E)//_PIN_39
...
#define bMIC_MUTE_LED                          (MCU_PORT63_PIN_REG_FFCA)//_PIN_53

#define _MIC_MUTE_ON                           0      
#define _MIC_MUTE_OFF                          1     
#define PCB_MIC_MUTE_LED(x)                    {\
                                                    bMIC_MUTE_LED = x;\
                                               }

#define bSPK_MUTE_LED                          (MCU_PORT64_PIN_REG_FFCB)//_PIN_54
...
#define bCALL_HOOK_LED							(MCU_PORT65_PIN_REG_FFCC)//_PIN_55

#define _CALL_HOOK_ON                          0      
#define _CALL_HOOK_OFF                         1     
#define PCB_CALL_HOOK_LED(x)                   {\
                                                    bCALL_HOOK_LED = x;\
                                               }
...
// Macro of CodeC
//-----------------------------------------------
#define bCAMERA_ENABLE                           (MCU_PORTC4_PIN_REG_FFA4)//_PIN_40

#define _CAMERA_ENABLE                           1      
#define _CAMERA_DISABLE                          0     
#define PCB_CAMERA_ENABLE(x)                     {\
                                                    bCAMERA_ENABLE = x;\
                                                }
...
#endif // End of #if(_PCB_TYPE == _RL6229_DEMO_1A1H1DP)
