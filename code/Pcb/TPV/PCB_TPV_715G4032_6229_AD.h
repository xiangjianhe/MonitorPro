...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PCB_TPV_715G4032_6229_AD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _PCB_TPV_715G4032_6229_AD)
...
// NC Pin
#define _PIN_122                                (1 & 0x07) // Page 10-0xB0[1:0]
...
#if 0//Robert Wang 20131021 test
//(KEY:715G5434)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x65 <= ucV2) && (ucV2 < 0x75))    \
                                                                    ucKeyState |= _MENU_KEY_MASK;      \
                                                                                                       \
                                                                if((0x65 <= ucV1) && (ucV1 < 0x78))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK;      \
                                                                                                       \
                                                                if(0x00 == IO_PowerKey)                \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x29 <= ucV1) && (ucV1 < 0x3A))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x29 <= ucV2) && (ucV2 < 0x3A))    \
...
#endif // End of #if(_PCB_TYPE == _PCB_TPV_715G4032_6229_AD)
