...
#if(_PROJECT == _PRJ_L_T2364t_AHP_LG_LM230WF7_SSB1)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM230WF7_SSB1
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(T2364t)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(T2364t)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(T2364t)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME												'T','2','3','6','4','t'
#define _MICROCODE												'L','G','0','.','3'
#define _RELEASE_DATE                                        	'2','0','1','6','0','3','1','4'
#define _IC_SERIES                                      		'R','T','D','2','4','8','6','V','R','D'
#define _PANNEL_NAME 											'L','M','2','3','0','W','F','7'
...
#define MAX_CONTRAST_RATIO                                      126 // 1.75(unit 1/100)
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   98
#define _CT7200_LenovoPrj_GREEN                                 96
#define _CT7200_LenovoPrj_BLUE                                  106

#define _CTSRGB_LenovoPrj_RED                                   100
#define _CTSRGB_LenovoPrj_GREEN                                 96
#define _CTSRGB_LenovoPrj_BLUE                                  101

#define _CT6500_LenovoPrj_RED                                   100
#define _CT6500_LenovoPrj_GREEN                                 96
#define _CT6500_LenovoPrj_BLUE                                  101
