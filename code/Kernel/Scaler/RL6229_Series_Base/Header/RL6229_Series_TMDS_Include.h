...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Series_TMDS_Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define GET_HDMI_3D_INFO_RECEIVED()                 (bit)(g_ucTmdsCtrl & _BIT6)
#define SET_HDMI_3D_INFO_RECEIVED()                 (g_ucTmdsCtrl |= _BIT6)
#define CLR_HDMI_3D_INFO_RECEIVED()                 (g_ucTmdsCtrl &= ~_BIT6)
...
#if(_3D_SUPPORT == _ON)
extern BYTE ScalerTmdsHdmiGet3DFormat(void);
#endif
...
#endif // End of #ifndef __RL6229_SERIES_TMDS__
