...
#if(_PCB_TYPE == _PCB_TPV_715G8241_6336_AD)
...
#define _LVDS_VCM_CONTROL                       _LVDS_VCM_1_45//_LVDS_VCM_HIGH                             
...
#if((_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ22K)||(_BACKLIGHT_PWM_FREQ_SELECT == _PWMFREQ20K)) 
...
// LED ORANGE
#define _PIN_22                                 (2 & 0x07) // Page 10-0xA1[2:0]
...
// Pin65~72,96~103 pull up Control                    //
////////////////////////////////////////////////////////
//Ada.chen  20140606 Set SPL clock/data driving to 2mA
...
//--------------------------------------------------
//NC(«O¯d)
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_PORT_PB6_PIN_REG_FF89) // Pin 24, PBD6
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_PORT_PB5_PIN_REG_FF8A) // Pin 25, PBD5

//Panel IIC
#define bSWIIC_SYS_PANEL_SCL                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) 
#define bSWIIC_SYS_PANEL_SDA                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS)

#define bDDC2IICSCL                             (MCU_PORT73_PIN_REG_FFD2) // Pin 70
#define bDDC2IICSDA                             (MCU_PORT72_PIN_REG_FFD1) // Pin 71
...
//-----------------------------------------------
// 
sbit bEEPROM_WRITE_PROTECT                   	=P3 ^ 3; // Pin 60, P3.3
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORT67_PIN_REG_FFCE)    // Pin 32, P6.7
...
#define bD1_CONNECT                             (MCU_PORT_PB0_PIN_REG_FF8F)//// Pin 21, PB.0
...
//-----------------------------------------------
sbit bD1_HPD                                    = P3 ^ 5; // Pin 61, P3.5 for DVI hot plug
...
// Macro of LED On/Off
//--------------------------------------------------
#if((_PROJECT == _PRJ_L_LS2224_1A1D_BOE_HT215F01_100)||(_PROJECT == _PRJ_L_LS2224_1A1D_LG_LM215WF4_TLG1)||(_PROJECT == _PRJ_L_LS2224_1A1D_AUO_M215HTN01_DOT_1))
#define bLED1                                   (MCU_PORT_PB7_PIN_REG_FF7F) // Pin 23, PB.7
#define bLED2                                   (MCU_PORTC4_PIN_REG_FFA4) // Pin 22, PC.4
#elif((_PROJECT == _PRJ_L_LI2224_1A1D_LG_LM215WF4_TLG1)||(_PROJECT == _PRJ_L_LI2224_1A1D_AUO_M215HTN01_DOT_1)||(_PROJECT == _PRJ_L_LI2224_1A1D_CMI_M215HGE_L21)||(_PROJECT == _PRJ_L_LI2224_1A1D_BOE_HT215F01_100))
		
#define bLED1                                   (MCU_PORTC4_PIN_REG_FFA4) // Pin 22, PC.4
#define bLED2                                   (MCU_PORT_PB7_PIN_REG_FF7F) // Pin 23, PB.7
#else
#define bLED1                                   (MCU_PORTC4_PIN_REG_FFA4) // Pin 22, PC.4
#define bLED2                                   (MCU_PORT_PB7_PIN_REG_FF7F) // Pin 23, PB.7
#warning "Please check LED setting!!";
#endif
...
#define AD_KEY2                                 (MCU_ADC1_RESULT_FF0A)//Pin 28
#define AD_KEY1                                 (MCU_ADC0_RESULT_FF09)//Pin27

sbit IO_PowerKey                                =P3 ^ 2;                        // Pin 59
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
																if((0x26 <= ucV1) && (ucV1 < 0x40))    \
																	ucKeyState |= _EXIT_KEY_MASK;	   \
																									   \
																if((0x48 <= ucV1) && (ucV1 < 0x60))    \
																	ucKeyState |= _LEFT_KEY_MASK;		\
																									   \
																if(0x00 == IO_PowerKey) 			   \
																	ucKeyState |= _POWER_KEY_MASK;	   \
																									   \
																if((0x26 <= ucV2) && (ucV2 < 0x40))    \
																	ucKeyState |= _RIGHT_KEY_MASK;	   \
																									   \
																if((0x48 <= ucV2) && (ucV2 < 0x60))    \
...
//-----------------------------------------------
// Macro of Aduio Function
//-----------------------------------------------

#define bAMP_MUTE                               (MCU_PORT66_PIN_REG_FFCD) // Pin 31, P6.6
...
#if(_AUDIO_VOLUME_PWM_INVERSE == _ON)
#define PCB_AUDIO_VOLUME_PWM(x)                 {\
													MCU_PWM2H_DUT_FF4D = ((_VOLUME_MAX - x) + _VOLUME_MIN);\
                                                }

#define PCB_GET_AUDIO_VOLUME_PWM()              ((_VOLUME_MAX - MCU_PWM2H_DUT_FF4D) + _VOLUME_MIN)
...
#define PCB_GET_AUDIO_VOLUME_PWM()              (MCU_PWM2H_DUT_FF4D)
