...
#if(_PANEL_TYPE == _TPV_CMI_M215HGE_L21)
//----------------------------------------------------------------------------------------------------
...
// Panel Name Define
//--------------------------------------------------
#define _PANEL_NAME                              _M,_2,_1,_5,_H,_G,_E_,_MINUS,_L,_2,_1
...
#define _PANEL_PIXEL_CLOCK_MAX                  195                 // Maxinum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T4                     200                 // Panel Power Off T4 (ms)//Eli 20120522 modify T3-T4
#define _PANEL_POWER_OFF_T5                     10                  // Panel Power Off T5 (ms)
#define _PANEL_POWER_OFF_T6                     650                // Panel Power Off T6 (ms)
