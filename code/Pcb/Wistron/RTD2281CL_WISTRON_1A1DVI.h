...
#if(_PCB_TYPE == _RTD2281CL_WISTRON_1A1DVI)
...
#if(_SYSTEM_EEPROM_EMULATION_SUPPORT == _OFF)
//DDC_WPn
#define _PIN_27                                 (1 & 0x07) // Page 10-0xA6[2:0]
...
// EEPROM_WP
#define _PIN_30                                 (2 & 0x0F) // Page 10-0xA9[3:0]
...
// AUDIO_PWM
#define _PIN_61                                 (5 & 0x0F) // Page 10-0xBC[3:0]
...
sbit bSWIIC_EDID_EEPROM_SCL_VGA                 = P3^0;//_PIN_33
sbit bSWIIC_EDID_EEPROM_SDA_VGA                 = P3^1;//_PIN_34

#define bSWIIC_EDID_EEPROM_SCL_DVI              (MCU_PORT73_PIN_REG_FFD2)//_PIN_70
#define bSWIIC_EDID_EEPROM_SDA_DVI              (MCU_PORT72_PIN_REG_FFD1)//_PIN_71

#define bSWIIC_EDID_EEPROM_SCL_HDMI             (MCU_PORT70_PIN_REG_FFCF)
#define bSWIIC_EDID_EEPROM_SDA_HDMI             (MCU_PORT71_PIN_REG_FFD0)
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORT61_PIN_REG_FFC8)    //_PIN_27, P6.1
...
//-----------------------------------------------
#define PCB_POWER_5V_LEVEL()                    (MCU_ADC0_RESULT_FF09)
