...
#if(_PCB_TYPE == _PCB_TPV_715G7799_6229_AD)
...
#define bD1_CONNECT                             (MCU_PORT_PD0_PIN_REG_FF7E) // Pin 21, PD.0
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x52 <= ucV1) && (ucV1 < 0x5B))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x69 <= ucV1) && (ucV1 < 0x75))    \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;      \
                                                                                                       \
                                                                if(0x00 == IO_PowerKey)                \
                                                                    ucKeyState |= _POWER_KEY_MASK;     \
                                                                                                       \
                                                                if((0x52 <= ucV2) && (ucV2 < 0x5B))    \
                                                                    ucKeyState |= _MENU_KEY_MASK;      \
                                                                                                       \
                                                                if((0x69 <= ucV2) && (ucV2 < 0x75))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK;      \
                                                                                                       \
																if((0x2F <= ucV2) && (ucV2 < 0x40))    \
