...
#if(_PCB_TYPE == _PCB_TPV_715G8182_6229_AD)
...
//--------------------------------------------------
#define _LVDS_DATA_DRIV_CONTROL                 _LVDS_DRIV_CONTROL_3_5 //_LVDS_DRIV_CONTROL_3_0                 
#define _LVDS_CLK_DRIV_CONTROL                  _LVDS_DRIV_CONTROL_3_5 //_LVDS_DRIV_CONTROL_3_0                  
...
//LED2
#define _76PIN_PIN_22                                 (2 & 0x07) // Page 10-0xA8[2:0]
...
// CABLE_DET
#define _76PIN_PIN_29                                 (3 & 0x07) // Page 10-0xD0[2:0]
// 0 ~ 6 (0: P6D2i<I>, 1: P6D2o<PP>, 2: P6D2o<OD>, 3: ADCA2<I>, 4: TEST_PIN0<O>, 5: TEST_PIN1<O>, 6: DUMMY<O>)

// Volume
#define _76PIN_PIN_30                                 (1 & 0x0F) // Page 10-0xD3[3:0]
...
// Macro of IIC
//--------------------------------------------------
sbit bSWIIC_SYS_EEPROM_SCL						= P3^4;//PIN 60,P3.4
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_PORT_PB5_PIN_REG_FF8A) // Pin 25, PB.5
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT					(MCU_PORT_PB6_PIN_REG_FF89)  //PIN24 PB.6
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORTC3_PIN_REG_FFA0)    // Pin 37, Pc.3
...
//-----------------------------------------------
#define AD_CABLE_DETECT                         (MCU_ADC2_RESULT_FF0B)          //A-ADC3
//VGA_ON     VALUE = 0x81;
//DVI_ON     VALUE = 0xA3;
//VGA&DVI_ON VALUE = 0x64;
// 0.01294
#define _VGA_CONNECT_UP_BOUND                   0x40  
#define _VGA_CONNECT_LOW_BOUND                  0x2B
#define _DVI_CONNECT_UP_BOUND                   0x7E
#define _DVI_CONNECT_LOW_BOUND                  0x41
#define _VGA_DVI_CONNECT_UP_BOUND               0x2A
#define _VGA_DVI_CONNECT_LOW_BOUND              0x05

#define PCB_ADC_CABLE_DETECT()					{\
...
#define PCB_A0_PIN()							PCB_ADC_CABLE_DETECT();
#define PCB_D1_PIN()                            PCB_ADC_CABLE_DETECT();
...
//Right key =0x50 0xFF0A
//Left key = 0x00 0xFF09
//Menu key = 0x50 0xFF09
//Exit key = 0x30 0xFF0A
//E-Color  = 0x00 0xFF0A
...
#define PCB_GET_AUDIO_VOLUME_PWM()              (MCU_PWM1H_DUT_FF4B)
...
#endif // End of #if(_PCB_TYPE == _RL6297_DEMO_76PIN_1A1DVI)
