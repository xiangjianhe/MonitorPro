...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6373_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RL6373_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6373_DEMO_1A 


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _AUO_LED_LVDS_24_WUXGA //_AU_LVDS_21_5_WUXGA
#define _PANEL_POW_SEQ_FAST_MODE                                _ON
#define _PANEL_EMBEDDED_LED_DRIVER_SUPPORT                      _ON

//--------------------------------------------------
//  Panel Define Eled Function Option
//--------------------------------------------------
#define _PANEL_EMBEDDED_LED_DRIVER_OPEN_SUPPORT                 _ON
#define _PANEL_EMBEDDED_LED_DRIVER_DIMMING_SEL                  _ANALOG_DIMMING
...
// Timing Support
//--------------------------------------------------
#define _OOR_H_FREQ_UPPER_BOUND                                 (1100 + 33)       // Unit in 0.1 kHZ
#define _OOR_H_FREQ_LOWER_BOUND                                 (100 - 3)        // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 (845 + 25)        // Unit in 0.1 HZ
#define _OOR_V_FREQ_LOWER_BOUND                                 (450 - 14)        // Unit in 0.1 HZ
#define _OOR_H_WIDTH_UPPER_BOUND                                2048       // Unit in pixel
#define _OOR_V_HEIGHT_LOWER_BOUND                               240        // Unit in line

#define _FAIL_SAVE_H_FREQ_UPPER_BOUND                           (1000 + 30)       // Unit in 0.1 kHZ
#define _FAIL_SAVE_H_FREQ_LOWER_BOUND                           (110 - 4)        // Unit in 0.1 kHZ
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           (760 + 23)        // Unit in 0.1 HZ
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           (495 - 15)        // Unit in 0.1 HZ
...
//-------------------------------------------------
// Super Low Power Options
//-------------------------------------------------
#define _SUPER_LOW_POWER_SUPPORT                                _ON

#endif // End of #if(_PROJECT == _RL6001_PROJECT)
