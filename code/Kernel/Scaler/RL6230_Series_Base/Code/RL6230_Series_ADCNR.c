...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6230_Series_ADCNR.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6230_SERIES_NOISE_REDUCTION__
...
void ScalerNrOffsetAdjustInitial(void)
{
    if(GET_NR_PATTERN_IS_MONO() == _TRUE)
    {
        ...
        // Set shift times to 1
        ScalerSetBit(P1E_C1_FUNC2_CTRL1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x01);
