...
//----------------------------------------------------------------------------------------------------
// ID Code      : _PRJ_L_F2014_A_AUO_M195RTN01_OLF.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT ==_PRJ_L_F2014_A_AUO_M195RTN01_OLF)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G6948_6336_A


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_AUO_M195RTN01_0
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_F2014_A.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(F2014)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(F2014)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(F2014)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      8//Robert Wang 20140522 // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
//-------------------------------------------------
#define _SYSTEM_EEPROM_EMULATION_SUPPORT                        _OFF//Robert Wang 20140428 _ON
#define _FLASH_ACCESS_FUNCTION_SUPPORT							_OFF//_ON
#define _EEPROM_ACCESS_FUNCTION_SUPPORT                         _OFF//Robert Wang 20140428 _ON
...
//==================================================================
#define _CHECKSUM                                               0x50
#define _VERSION_CODE                                           0x60
...
//
//==================================================================
#define _MODEL_NAME												_bF_, _2_, _0_, _1_, _4_
#define _MICROCODE												_bL_,_bA_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _F,_2,_0,_1,_4
#define _FW_RELEASE_DATE                                        _2,_0,_1,_6,_0,_2,_2,_6
#define _FW_VERSION                                             _L,_A, _0, _DOT, _1
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.02	
#define _IC_SERIES                                      		_R,_T,_D,_2,_2,_8,_0

#define _PANNEL_NAME 											'M','1','9','5','R','T','N','0','1'
...
//==================================================================
#define _LANGUAGE_DEFAULT                                       _CHINESE_S  //_ENGLISH
...
#define MAX_CONTRAST_RATIO                                      122 // 1.75(unit 1/100)
#define DEF_CONTRAST_RATIO                                      101 // 1.00(unit 1/100)
#define MIN_CONTRAST_RATIO                                      15  // 0.5(unit 1/100)
#define _OSD_CONTRAST_DEF_VALUE                                 50  //_CONTRAST_VGA
...
#define _PWM_B10                                                0x64//0x58 //|10
#define _PWM_B20                                                0x71//0x5B //|20
#define _PWM_B30                                                0x7E//0x63 //|30
#define _PWM_B40                                                0x8B//0x6D //|40
#define _PWM_B50                                                0x97//0x7B //|50
#define _PWM_B60                                                0xA4//0x8D //|60
#define _PWM_B70                                                0xB1//0x9A //|70
#define _PWM_B80                                                0xD1//0xBE//0xCB //0xBF //|80
#define _PWM_B90                                                0xE8//0xDE//0xE5 //0xDE //|90
...
#define _CTSRGB_LenovoPrj_GREEN                                 122
#define _CTSRGB_LenovoPrj_BLUE                                  126

#define _CT6500_LenovoPrj_RED                                   126
#define _CT6500_LenovoPrj_GREEN                                 122
...
#endif // End of #if(_PROJECT == _PRJ_L_F2014_A_AUO_M195RTN01_OLF)
