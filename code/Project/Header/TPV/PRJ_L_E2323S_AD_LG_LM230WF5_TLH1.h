...
#if(_PROJECT == _PRJ_L_E2323S_AD_LG_LM230WF5_TLH1)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LG_LM230WF5_TLH1
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_E2323S_AD.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(E2323S)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(E2323S)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(E2323S)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 0F 11) 87 AC AE B2 B6 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _SYSTEM_EEPROM_EMULATION_SUPPORT                        _ON//Robert Wang 20130625 _OFF
#define _FLASH_ACCESS_FUNCTION_SUPPORT							_ON //20121008 HDCP key write modify
#define _EEPROM_ACCESS_FUNCTION_SUPPORT                         _ON//Robert Wang 20130625 _OFF
...
//--------------------------------------------------
#define _DIG_FILTER_PHASE_THD                                   3//Robert Wang 20130306 for Phase Issue 6 //effective:0~7
...
//==================================================================
#define _MODEL_NAME												_bE_, _2_, _3_, _2_, _3_,_bs_, ___,_bW_,_bi_,_bd_,_be_
#define _MICROCODE												_bL_,_bG_, _0_, _DOT, _1_

#define _FACTORY_PROJECT_NAME                                   _E,_2,_3,_2,_3,_s
#define _FW_RELEASE_DATE                                        _2,_0,_1,_3,_0,_7,_2,_2
#define _FW_VERSION                                             _L,_G,_0,_DOT,_2
#define _DDCCI_FIRMWARE_VERSION							        0x0002  //Ver 0.02	

#define _PANNEL_NAME 											'L','M','2','3','0','W','F','5'
...
#define _PWM_B70                                                175//0xAC//0x9A //|70
#define _PWM_B80                                                205//0xCB//0xBF //|80
#define _PWM_B90                                                229//0xE5//0xDE //|90
...
#endif // End of #if(_PROJECT == _PRJ_L_E2323S_AD_LG_LM230WF5_TLH1)
