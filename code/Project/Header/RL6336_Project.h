...
#if(_PROJECT == _RL6336_PROJECT)


//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6336_DEMO_76PIN_1A1H
...
#define _HDCP_KEY_LOCATION                                      _TABLE_LOCATION_CODE
#if(_SYSTEM_EEPROM_EMULATION_SUPPORT == _OFF)
...
#endif // End of #if(_PROJECT == _RL6336_PROJECT)
