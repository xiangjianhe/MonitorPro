...
#if(_PANEL_TYPE == _TPV_AUO_M215HTN01_DOT_1)
//----------------------------------------------------------------------------------------------------
...
// Panel Name Define
//--------------------------------------------------
#define _PANEL_NAME                              _M,_2,_1,_5,_H,_T,_N_,_0_,_1,_MINUS,_1
...
#define _PANEL_DH_TOTAL_MIN                     2064                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      142                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  186                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  109                 // Mininum Pixel Clock in MHz
