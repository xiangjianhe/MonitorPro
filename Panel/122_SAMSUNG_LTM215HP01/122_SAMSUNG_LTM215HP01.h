...
/********************************************************************************/
#if(_PANEL_TYPE == _TPV_SAMSUNG_LTM215HP01)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_MIN_FRAME_RATE                   490//540
...
#define _PANEL_DH_TOTAL                         2020                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2080                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1980                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1221                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      134                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  180                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  113                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      5                   // Panel Power On T1 (ms) CMI_spec:0<T2<50ms
#define _PANEL_POWER_ON_T2                      30                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      550//650                 // Panel Power On T3 (ms) CMI_spec:T5>200ms

#define _PANEL_POWER_OFF_T4                     150//250                 // Panel Power Off T4 (ms) CMI_spec:T6>100ms
#define _PANEL_POWER_OFF_T5                     200//300                 // Panel Power Off T5 (ms) CMI_spec:0<T3<50ms
