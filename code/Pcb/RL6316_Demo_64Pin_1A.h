...
#if(_PCB_TYPE == _RL6316_DEMO_64PIN_1A)
...
//-----------------------------------------------
sbit bFLASH_WRITE_PROTECT                       = P3 ^ 6; // TQFP pin16, P3.6
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_PORT56_PIN_REG_FFC5) // TQGP64 Pin15, P5.0
...
//-----------------------------------------------
sbit bA0_CONNECT                                = P3 ^ 0;   // TQFP64 Pin 13, P3.0
...
sbit bLED2                                      = P1 ^ 1;   // TQFP Pin29, P3.2
...
//--------------------------------------------------
sbit bPANELPOWER                                = P3 ^ 3;  // TQFP Pin30, P3.3
