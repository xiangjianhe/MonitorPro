...
#define _PANEL_PIXEL_CLOCK_MAX                  131                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  97                 // Mininum Pixel Clock in MHz

//20120922 Abel T1&T2 modify
#define _PANEL_POWER_ON_T1                      20//30              // Panel Power On T1 (ms) SEC_spec:0<T2<50ms
#define _PANEL_POWER_ON_T2                      30//40              // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      550                 // Panel Power On T3 (ms) SEC_spec:T5>500ms

#define _PANEL_POWER_OFF_T4                     150                 // Panel Power Off T4 (ms) SEC_spec:T6>100ms
#define _PANEL_POWER_OFF_T5                     30//40                  // Panel Power Off T5 (ms) SEC_spec:0<T3<50ms
#define _PANEL_POWER_OFF_T6                     1100                // Panel Power Off T6 (ms) SEC_spec:T4>1000ms
...
#endif // End of #if(_PANEL_TYPE == _TPV_SEC_LTM190BT07)
