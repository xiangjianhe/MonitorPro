...
#if(_PROJECT == _FOX_E1922W_BOE_MT185WHM_N20)
...
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _FOX_BOE_MT185WHM_N20
...
#define _CAPABILITIES_STRING_VGA 								"(port(monitor)type(LCD)model(LEN E1922W)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 AC AE B2 B6 C6 C8 C9 CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF FF)mswhql(1)asset_eep(40)mccs_ver(2.1))"
...
//--------------------------------------------------
#define _CHECKSUM                                       0x26
#define _VERSION_CODE                                   0x31

//Facory OSD
#define _FACTORY_PROJECT_NAME                           _E,_1,_9,_2,_2,_SPACE,_W,_i,_d,_e
#define _FACTORY_PANNEL_NAME							_B,_O,_E,_SPACE,_M,_T,_1,_8,_5,_W,_H,_M,_MINUS,_N,_2,_0
#define _IC_SERIES                                      _R,_T,_D,_2,_2,_7,_0,_C,_L,_W
#define _FW_RELEASE_DATE                                _2,_0,_1,_5,_0,_3,_1,_7
#define _FW_VERSION                                     _L,_B, _2, _DOT, _0
#define _DDCCI_FIRMWARE_VERSION							0x0200 

//User OSD
#define _MODEL_NAME                                     _bE_, _1_, _9_, _2_, _2_, ___,_bW_,_bi_,_bd_,_be_
#define _MICROCODE                                      _bL_,_bB_, _2_, _DOT, _0_
//Facory Command
...
#define _CONTRAST_MAX_ANALOG							118
...
//----------------------------------------------------
#define _PWM_B00                                        99//|00
#define _PWM_B10                                        100//|10
#define _PWM_B20                                        103//|20
#define _PWM_B30                                        109 //|30
#define _PWM_B40                                        118//|40
#define _PWM_B50                                        132 //|50
#define _PWM_B60                                        150 //|60
#define _PWM_B70                                        171 //|70
#define _PWM_B80                                        201 //|80
#define _PWM_B90                                        230 //|90
