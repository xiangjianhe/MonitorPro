...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6229_Demo_1A1DVI1H.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6229_DEMO_1A1DVI1H)
...
#define bD1_CONNECT                             (MCU_PORT_PD6_PIN_REG_FF78) // Pin 32, PD.6
...
#endif // End of #if(_PCB_TYPE == _RL6229_DEMO_1A1DVI1H)
