...
#if(_PROJECT == _PRJ_L_T1714P_1A1D1DP_AUO_M170ETN01)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G7645_6297_1A1D1DP


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_AUO_M170ETN01
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LT1714P_1A1D1DP.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(T1714p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(T1714p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(T1714p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(T1714p)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//--------------------------------------------------
#define _ASPECT_RATIO_SUPPORT                                   _OFF//_ON  
...
#define _DIGITAL_VOLUME_MAX                                     0x005B // _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      8    // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
#define _OOR_V_FREQ_UPPER_BOUND                                 860//845   // Unit in 0.1 HZ
...
#define _HDCP_KEY_LOCATION                                     _TABLE_LOCATION_USER//_TABLE_LOCATION_CODE
#if(_SYSTEM_EEPROM_EMULATION_SUPPORT == _OFF)
...
//==================================================================
#define _MODEL_NAME												'T','1','7','1','4','p'
#define _MICROCODE												'L','A','0','.','5'
#define _RELEASE_DATE                                        	'2','0','1','5','0','6','1','0'
#define _IC_SERIES                                      		'R','T','D','2','4','8','6','A','D'
#define _PANNEL_NAME 											'M','1','7','0','E','T','N','0','1'
...
#define MAX_CONTRAST_RATIO                                      130 // 1.75(unit 1/100)
#define DEF_CONTRAST_RATIO                                      101 // 1.00(unit 1/100)
#define MIN_CONTRAST_RATIO                                      15  // 0.5(unit 1/100)
#define _OSD_CONTRAST_DEF_VALUE                                 80  //_CONTRAST_VGA
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   104
#define _CT7200_LenovoPrj_GREEN                                 110
#define _CT7200_LenovoPrj_BLUE                                  113

#define _CTSRGB_LenovoPrj_RED                                   107
#define _CTSRGB_LenovoPrj_GREEN                                 110
#define _CTSRGB_LenovoPrj_BLUE                                  109

#define _CT6500_LenovoPrj_RED                                   107
#define _CT6500_LenovoPrj_GREEN                                 110
#define _CT6500_LenovoPrj_BLUE                                  109

#define _CT9300_LenovoPrj_RED                                   100
#define _CT9300_LenovoPrj_GREEN                                 108
...
#define _ICON_BLANK1_PIXEL                                      17
#define _ICON_BLANK2_PIXEL                                      9
#define _ICON_BLANK3_PIXEL                                      17
#define _ICON_BLANK4_PIXEL                                      4
#define _ICON_BLANK5_PIXEL                                      21

#define _NAVIGATE_ICON_EXIT_COL_POSITION						6
#define _NAVIGATE_ICON_LEFT_COL_POSITION						13
#define _NAVIGATE_ICON_RIGHT_COL_POSITION						19
...
#define _TEXT_BLANK1_PIXEL                                      20
#define _TEXT_BLANK2_PIXEL                                      6
#define _NAVIGATE_TEXT_EXIT_COL_POSITION						3
#define _NAVIGATE_TEXT_ENTER_COL_POSITION						25
...
#endif // End of #if(_PROJECT == _PRJ_L_T2324P_AHP_LG_LM230WF3_SLN1)
