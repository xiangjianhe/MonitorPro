...
//----------------------------------------------------------------------------------------------------
// ID Code      : UserDdcciDefine.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _DDCCI_DISP_CALIB_OGC_SUPPORT               2
#define _DDCCI_DISP_CALIB_OCC_SUPPORT               3
#define _DDCCI_DISP_CALIB_DICOM_SUPPORT             4
#define _DDCCI_DISP_CALIB_OGC_TOTAL_GAMMA           5
...
//--------------------------------------------------
#define _DDCCI_DISP_CALIB_OGC_MEASURE_WHITE         0
#define _DDCCI_DISP_CALIB_OGC_MEASURE_RED           1
#define _DDCCI_DISP_CALIB_OGC_MEASURE_GREEN         2
#define _DDCCI_DISP_CALIB_OGC_MEASURE_BLUE          3
#define _DDCCI_DISP_CALIB_OGC_MEASURE_BLACK         4
...
#define _DDCCI_DISP_CALIB_OGC_MEASURE_GRAY20        25
#define _DDCCI_DISP_CALIB_OGC_MEASURE_END           0xAA  

#define _DDCCI_DISP_CALIB_OCC_MEASURE_SRGB1         26
#define _DDCCI_DISP_CALIB_OCC_MEASURE_SRGB7         32

#define _DDCCI_DISP_CALIB_OGC_VERIFY_END            66
#define _DDCCI_DISP_CALIB_OCC_VERIFY_END            74
