...
#if(_PROJECT == _FOX_T2224zwD)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6229_FOXCONN_LEN_T2224zwD_PCB//_RL6229_DEMO_1A1H1DP
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LEN T2224zD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 11 0F) AC AE B2 B6 C6 C8 C9 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI								"(prot(monitor)type(LCD)model(LEN T2224zD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 11 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(LEN T2224zD)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 11 0F) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 02 03 04 05) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"  
...
#define _CODEC_CX2070X_SUPPORT                                  _ON
...
#define _ANALOG_VOLUME_CENTER                                   _ANALOG_VOLUME_MAX//((_ANALOG_VOLUME_MAX + _ANALOG_VOLUME_MIN) / 2)

#define _DIGITAL_AUDIO_VOLUME_RESOLUTION                        _AUDIO_VOLUME_14BIT
#define _DIGITAL_VOLUME_MAX                                     0x3FFF//0x1ab0//0x1C00//0x3FFF // _AUDIO_VOLUME_8BIT MAX:0x00FF, _AUDIO_VOLUME_14BIT MAX:0x3FFF
...
#endif
//==================================================================
#define _SLIDER_TYPE1									0
#define _SLIDER_TYPE2									1

#define _AUDIO_SLIDER_TYPE								_SLIDER_TYPE2
//==================================================================
//==================================================================
//==================================================================
//==================================================================
...
//Facory OSD
#define _FACTORY_PROJECT_NAME                           _T,_2,_2,_2,_4,_z,_D
#define _IC_SERIES                                      _R,_T,_D,_2,_4,_8,_6,_V,_R,_D
//User OSD
#define _MODEL_NAME                                     _T_, _2_, _2_, _2_, _4_, _z_,_D_
