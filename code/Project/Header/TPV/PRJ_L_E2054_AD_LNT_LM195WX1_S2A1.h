...
#if(_PROJECT == _PRJ_L_E2054_AD_LNT_LM195WX1_S2A1)

//--------------------------------------------------
//  Pcb Define
//--------------------------------------------------
#define _PCB_TYPE                                               _PCB_TPV_715G7396_6229_AD


//--------------------------------------------------
//  Panel Define
//--------------------------------------------------
#define _PANEL_TYPE                                             _TPV_LNT_LM195WX1_S2A1
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_E2054_AD_6229.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(E2054)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(E2054)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
//#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(E2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
//#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(E2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
//#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(E2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 0F 11) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//==================================================================
#define _MODEL_NAME												'E','2','0','5','4'
#define _MICROCODE												'L','G','0','.','1'
#define _RELEASE_DATE                                        	'2','0','1','6','0','8','0','1'
#define _IC_SERIES                                      		'R','T','D','2','1','8','1','L','R'
#define _PANNEL_NAME 											'L','M','1','9','5','W','X','1','_','S','2','A','1'
...
#define MAX_CONTRAST_RATIO                                      115 // 1.75(unit 1/100)
...
#define _LOW_BLUE_LIGHT_CONTRAST                        		85
//==================================================================
...
#define _PWM_B10                                                83//78//0x58 //|10
#define _PWM_B20                                                96//85//0x5B //|20
#define _PWM_B30                                                109//120//0x63 //|30
#define _PWM_B40                                                122//130//0x6D //|40
#define _PWM_B50                                                135//145//0x7B //|50
#define _PWM_B60                                                148//160//0x8D //|60
#define _PWM_B70                                                161//175//0x9A //|70
#define _PWM_B80                                                175//205//0xBF //|80
#define _PWM_B90                                                215//229//0xDE //|90
...
//==================================================================
#define _CT7200_LenovoPrj_RED                                   120
...
#define _CT9300_LenovoPrj_RED                                   105
...
#define _CTLOWBLUELIGHT_BLUE                                    100         
...
#define _ICON_BLANK1_PIXEL                                      22
#define _ICON_BLANK2_PIXEL                                      12
#define _ICON_BLANK3_PIXEL                                      5
#define _ICON_BLANK4_PIXEL                                      9
#define _ICON_BLANK5_PIXEL                                      14

#define _NAVIGATE_ICON_EXIT_COL_POSITION						7
...
#endif // End of #if(_PROJECT == _PRJ_L_E2054_AD_LNT_LM195WX1_S2A1)
