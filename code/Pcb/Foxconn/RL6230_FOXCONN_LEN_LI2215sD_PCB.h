...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6230_FOXCONN_LEN_LT1931EW_PCB.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6230_FOXCONN_LEN_LI2215sD_PCB)
...
// VGA_CABLE_DET
#define _PIN_26                                 (1 & 0x03)  // 0 ~ 3 (0: P3D7i, 1: P3D7o<open-drain>, 2: P3D7o<push-pull>, 3: I2C_MDA_1<open-drain>)
...
// BRIGHTNESS
#define _PIN_56                                 (4 & 0x07)  // 0 ~ 5 (0: P5D3i, 1: P5D3o<open-drain>, 2: P5D3o<push-pull>, 3: PWM3<open-drain>, 4: PWM3<push-pull>, 5: CLKO1<O>)
...
// PC99_DET
#define _PIN_59                                 (2 & 0x07)  // 0 ~ 4 (0: P6D2i, 1: P6D2o<open-drain>, 2: P6D2o<push-pull>, 3: ADC2, 4:I2C_MDL_2A<open-drain>, )
...
//----------------------------------------------- 
sbit bEEPROM_WRITE_PROTECT                   	= P1 ^ 1; // Pin64 P1.1
...
//-----------------------------------------------
sbit bA0_CONNECT                                = P1 ^ 3; // Pin 4, P1.3
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1									(MCU_PORT54_PIN_REG_FFC3)//pin 61
#define bLED2									(MCU_PORT62_PIN_REG_FFC9)//pin 59

#define _LED1_ON                                 0       // Power on  state for LED
#define _LED1_OFF                                1       // Power off state for LED

#define _LED2_ON                                 1       // Power on  state for LED
#define _LED2_OFF                                0       // Power off state for LED
...
#define bPOWER_KEY								(MCU_PORT63_PIN_REG_FFCA)//PIN 63
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((0x60<= ucV1) && (ucV1 < 0x80))     \
                                                                    ucKeyState |= _LEFT_KEY_MASK;      \
                                                                                                       \
                                                                if((0x20 <= ucV1) && (ucV1 < 0x60))    \
                                                                    ucKeyState |= _EXIT_KEY_MASK;     \
                                                                                                       \
                                                                if((0x60 <= ucV0) && (ucV0 < 0x80))    \
                                                                    ucKeyState |= _MENU_KEY_MASK;      \
                                                                                                       \
                                                                if((0x20 <= ucV0) && (ucV0 < 0x60))    \
...
//--------------------------------------------------
#define  bPANELPOWER                            (MCU_PORT52_PIN_REG_FFC1) //  Pin 28, P5.2
...
#endif // End of #if(_PCB_TYPE == _RL6230_FOXCONN_LEN_LT1931EW_PCB)
