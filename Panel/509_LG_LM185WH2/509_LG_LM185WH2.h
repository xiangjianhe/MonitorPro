...
#if(_PANEL_TYPE == _FOX_LG_LM185WH2)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_MANUFACTURER                     _PANEL_LGD      // _PANEL_CMO or _PANEL_AUO or _PANEL_SAMSUNG or _PANEL_INNOLUX or _PANEL_CPT
...
#define _PANEL_DH_TOTAL                         1608                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     2044                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1430                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         798                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     1108                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      77                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  90                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  62                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      35                  // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      30                  // Panel Power On T2 (ms)29
#define _PANEL_POWER_ON_T3                      550                 // Panel Power On T3 (ms)240
