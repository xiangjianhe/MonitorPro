...
//----------------------------------------------------------------------------------------------------
// ID Code      : CVT_RL6336_PROJECT.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _CVT_RL6336_PROJECT)
...
#define _FACTORY_COMMAND_INCLUDE                                "FacOption_LS2224_AD.h"
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(LS2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0E 10 12 14(01 05 06 08 0B) 16 18 1A 1E 20 30 3E 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(LS2224)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 08 10 12 14(01 05 06 08 0B) 16 18 1A 52 60(01 03) AC AE B2 B6 C6 C8 CA CC(02 03 04 05 06 09 0A 0D) D6(01 04 05) DF FD)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _DCLK_SPREAD_RANGE                                      6//Robert Wang 20140522 // 0~15, 0 ~ disable, 15 ~ 7.50%             
...
//-------------------------------------------------
#define _SYSTEM_EEPROM_EMULATION_SUPPORT                        _ON//Robert Wang 20140428 _ON
#define _FLASH_ACCESS_FUNCTION_SUPPORT							_ON
#define _EEPROM_ACCESS_FUNCTION_SUPPORT                         _ON//Robert Wang 20140428 _ON
...
//--------------------------------------------------
#define _ADC_RGB_DEFAULT_PGA_VALUE                              4   // 0 ~ 7 //Robert Wang 20140603 
...
#define _ADC_YPBPR_DEFAULT_PGA_VALUE                            4   // 0 ~ 7 //Robert Wang 20140603 
...
//--------------------------------------------------
#define _DIG_FILTER_PHASE_THD                                   192 //effective:0~255 //Robert Wang 20140603
...
#define _DIG_FILTER_ENHANCE_PHASE_ENABLE                        _ENABLE//Robert Wang 20140603
...
//==================================================================
#define _MODEL_NAME                                             _bL_, _bS_, _b2_, _b2_, _b2_, _b4_
#define _MICROCODE                                              _bL_,_bB_, _b0_, _DOT, _b3_

#define _FACTORY_PROJECT_NAME                                   _L,_S,_2,_2,_2,_4
#define _FW_RELEASE_DATE                                        _2,_0,_1,_7,_1,_0,_1,_7
#define _FW_VERSION                                             _L,_B,_0,_DOT,_3
#define _DDCCI_FIRMWARE_VERSION							        0x0001  //Ver 0.07	
#define _IC_SERIES                                      		_R,_T,_D,_2,_2,_8,_1,_E,_L
...
#define _LOGO_TYPE                                              _LENOVO_2015_EPA//_LENOVO
#define CVT_DEF_LOGO_TYPE                                       "_LENOVO_2015_EPA" //xml logo name
...
#define MIN_CONTRAST_RATIO                                      40//15  // 0.5(unit 1/100)
...
#define _LBL_CONTRAST_DEF                               		_OSD_CONTRAST_DEF_VALUE    
#define _LBL_BRIGHTNESS_DEF                             		30

#define _OSD_LBL_H_POS                                  		902
...
#define _CT7200_LenovoPrj_GREEN                                 107
#define _CT7200_LenovoPrj_BLUE                                  110

#define _CTSRGB_LenovoPrj_RED                                   109
#define _CTSRGB_LenovoPrj_GREEN                                 107
#define _CTSRGB_LenovoPrj_BLUE                                  106

#define _CT6500_LenovoPrj_RED                                   109
#define _CT6500_LenovoPrj_GREEN                                 107
#define _CT6500_LenovoPrj_BLUE                                  106

#define _CT9300_LenovoPrj_RED                                   99
#define _CT9300_LenovoPrj_GREEN                                 108
#define _CT9300_LenovoPrj_BLUE                                  118
...
#endif
#elif(CVT_DEF_PANEL_TYPE == _FOX_CMI_M195FGE_L20)
#define _CT7200_LenovoPrj_RED                                   102
#define _CT7200_LenovoPrj_GREEN                                 101
#define _CT7200_LenovoPrj_BLUE                                  113

#define _CTSRGB_LenovoPrj_RED                                   106
#define _CTSRGB_LenovoPrj_GREEN                                 101
#define _CTSRGB_LenovoPrj_BLUE                                  109

#define _CT6500_LenovoPrj_RED                                   106
#define _CT6500_LenovoPrj_GREEN                                 101
#define _CT6500_LenovoPrj_BLUE                                  109

#define _CT9300_LenovoPrj_RED                                   97
#define _CT9300_LenovoPrj_GREEN                                 101
...
#define _AUDIO_EXTERNAL_AMP_SUPPORT								_ON//_OFF
...
#endif // End of #if(_PROJECT == _CVT_RL6336_PROJECT)
