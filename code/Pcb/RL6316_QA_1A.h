...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6316_QA_1A.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6316_QA_1A)
...
// Panel_ON
#define _PIN_36                                 (2 & 0x0F) // Page 10-0xAD[3:0]
...
// Macro of IIC
//--------------------------------------------------
sbit bSWIIC_SYS_EEPROM_SCL                      = P1 ^ 1; // Pin33 P1.1
sbit bSWIIC_SYS_EEPROM_SDA                      = P3 ^ 3; // Pin34 P3.3
...
//----------------------------------------------- 
#define bEEPROM_WRITE_PROTECT                   (MCU_PORT56_PIN_REG_FFC5) // Pin18, P5.0
...
// Macro of LED On/Off
//--------------------------------------------------
sbit bLED1                                      = P3 ^ 2;   // Pin33, P3.2
#define bLED2                                   (MCU_PORT63_PIN_REG_FFCA) // Pin29, P6.3
