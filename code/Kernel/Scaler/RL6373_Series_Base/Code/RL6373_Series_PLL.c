...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6373_Series_PLL.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6373_SERIES_PLL__
...
//--------------------------------------------------
#define _LVDS_PLL_BOUNDRY_0                         (560000 * (1 << _DISP_OUTPUT_PORT) / 7)
...
void ScalerPllSetDpllFreq(DWORD ulFreq)
{
    ...
    switch(ucDPLLSettingState)
    {
        ...
        case _DPLL_SET_VCO_BAND:
            ...
            ScalerSetDataPortBit(CM_8B_TCON_ADDR_PORT, _CM_8C_PT_B2_TCON_LVDS_CTRL18, ~(_BIT7 | _BIT6 | _BIT5), ((pData[15] & 0xC0) | _BIT5));
